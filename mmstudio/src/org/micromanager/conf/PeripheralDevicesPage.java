...
public class PeripheralDevicesPage extends PagePanel {
   ...
   class DeviceTable_TableModel extends AbstractTableModel {
      ...
      Vector<Device> getPeripheralDevices() { return peripheralDevices_;} ;
      Vector<Boolean> getSelected() { return selected_;};
      Vector<String> getMasterDevices() { return masterDevices_;};
