...
public class ReportProblemDialog extends javax.swing.JDialog {
   ...
   private void initComponents() {
      ...
      stepInstructions_.setFont(new java.awt.Font("Lucida Sans Unicode", 0, 12)); // NOI18N
      ...
      layout.setHorizontalGroup(
         ...
         .add(layout.createSequentialGroup()
            .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
               .add(layout.createSequentialGroup()
                  ...
                  .add(57, 57, 57)
                  .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                     .add(emailText_, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 510, Short.MAX_VALUE)
                     .add(organization_, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 510, Short.MAX_VALUE)))
               .add(layout.createSequentialGroup()
                  .addContainerGap()
                  .add(jLabel1)
                  .add(14, 14, 14)
         ...
         .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
            ...
            .add(jLabel2)
            .add(102, 102, 102)
            .add(name_, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 510, Short.MAX_VALUE)
            .addContainerGap())
      );
    ...
    private void BuildAndSendReport() {
        ...
        reportPreamble_ += ("#User e-mail: " + emailText_.getSelectedText());
