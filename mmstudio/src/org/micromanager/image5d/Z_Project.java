...
public class Z_Project implements PlugIn {
    ...
    ImagePlus doProjection() {
        ...
        ImagePlus resultImp = IJ.createImage(imp.getTitle()+" Projection", "rgb black", i5d.getWidth(), i5d.getHeight(), nFrames);
    ...
    Image5D doI5DProjection() {
        ...
        Image5D resultI5D = new Image5D(imp.getTitle()+" Projection", i5d.getType(), i5d.getWidth(), i5d.getHeight(), nProjectedChannels, 1, nFrames, false);
        ...
        for (int frame=startFrame; frame<startFrame+nFrames; frame++) {
            for (int destChannel=1; destChannel<=nProjectedChannels; destChannel++) {
                ...
                resultI5D.setPixels(proj.getProcessor().getPixels(), destChannel, 1, frame);
                if (frame==startFrame) {
