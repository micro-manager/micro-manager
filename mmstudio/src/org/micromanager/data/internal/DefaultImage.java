...
public class DefaultImage implements Image {
   ...
   public DefaultImage(TaggedImage tagged, Coords coords, Metadata metadata)
      ...
      if (metadata == null) {
         ...
         ReportingUtils.logError("Assuming metadata was generated by this scope...");
         // HACK: assume that this Image was generated by the current hardware,
         // and attempt to recover the scopeData property (which depends on
         // the current device adapters).
         ...
         PropertyMap userData = MDUtils.extractUserData(tags,
               scopeData.getKeys());
         metadata = metadata.copy().scopeData(scopeData).userData(userData).build();
      }
