...
public final class ControlCell {
  ...
  public ControlCell(
    ...
    widget_ = panel;
    icon_ = new DraggableIcon(studio, frame, control, null, plugin, true, this, rect_.getSize());
  }
  ...
  public String toString() {
    return String.format("<ControlCell for %s at %s>", plugin_.getName(), rect_);
  }

  public static ControlCell fromJSON(JSONObject json, Studio studio, QuickAccessFrame frame) {
    String pluginName = "";
    try {
      ...
      studio.logs().logError(e, "Unable to deserialize ControlCell from " + json);
