...
/**
 * Implements the "Preset" button logic, allowing the user to quickly set a configuration group to
 * be at a desired preset.
 */
...
public final class PresetButton extends WidgetPlugin implements SciJavaPlugin {
  ...
  public ImageIcon getIcon() {
    return new ImageIcon(
        IconLoader.loadFromResource("/org/micromanager/icons/color_filter@2x.png"));
  }
  ...
  public JComponent createControl(final PropertyMap config) {
    ...
    Icon icon =
        studio_
            .quickAccess()
            .getCustomIcon(config, IconLoader.getIcon("/org/micromanager/icons/color_filter.png"));
    JButton result =
        new JButton(preset, icon) {
          @Override
    ...
    result.setBackground(new Color(config.getInteger("backgroundColor", Color.GREEN.getRGB())));
        ...
        new ActionListener() {
          ...
          public void actionPerformed(ActionEvent event) {
            try {
              ...
              studio_
                  .logs()
                  .showError(e, "Error setting config group " + group + " to mode " + preset);
            }
          }
        });
    return result;
  ...
  public PropertyMap configureControl(final Frame parent) {
    ...
    groupSelector.addActionListener(
        new ActionListener() {
          ...
          public void actionPerformed(ActionEvent event) {
            ...
            String[] presets = studio_.core().getAvailableConfigs(group).toArray();
    ...
    presetSelector.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent event) {
            // Try to get a new color for the color picker. This won't do
    ...
    JOptionPane.showMessageDialog(
        parent, contents, "Configure presets button", JOptionPane.PLAIN_MESSAGE);
