...
public final class ShutterControl extends WidgetPlugin implements SciJavaPlugin {
  ...
  public ImageIcon getIcon() {
    return new ImageIcon(IconLoader.loadFromResource("/org/micromanager/icons/shutter_open.png"));
  }
  ...
  /** Update the JLabel's icon based on the current state of the shutter and autoshutter. */
