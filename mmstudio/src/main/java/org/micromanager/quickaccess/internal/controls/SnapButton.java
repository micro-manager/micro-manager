...
public final class SnapButton extends WidgetPlugin implements SciJavaPlugin {
  ...
  public ImageIcon getIcon() {
    return new ImageIcon(IconLoader.loadFromResource("/org/micromanager/icons/camera@2x.png"));
  }
  ...
  public JComponent createControl(final PropertyMap config) {
    ...
    final JButton result =
        new JButton("Snap", IconLoader.getIcon("/org/micromanager/icons/camera.png")) {
          @Override
