 ...
 * (multi-dimensional acquisition). It contains fields corresponding to each of the columns in the
 * Channels section of the MDA dialog. ChannelSpecs are used by the SequenceSettings object to set
 * up channels for acquisitions.
 *
...
public final class ChannelSpec {
  public static final class Builder {
     ...
     */
    @Deprecated private Color color_ = Color.gray;
   ...
   * @deprecated Use Builder and getters instead *
   */
  @Deprecated public String config = "";
  /**
   * Exposure time, in milliseconds
   *
   * @deprecated Use Builder and getters instead *
   */
  @Deprecated public double exposure = 10.0;
  /**
   * Z-offset, in microns
   *
   * @deprecated Use Builder and getters instead *
   */
  @Deprecated public double zOffset = 0.0;
  /**
   * Whether this channel should be imaged in each Z slice of the stack
   *
   * @deprecated Use Builder and getters instead *
   */
  @Deprecated public Boolean doZStack = true;
  /**
   * Color to use when displaying this channel
   *
   * @deprecated Use Builder and getters instead *
   */
  @Deprecated public Color color = Color.gray;
  /**
   * Number of frames to skip between each time this channel is imaged.
   *
   * @deprecated Use Builder and getters instead *
   */
  @Deprecated public int skipFactorFrame = 0;
  /**
   * Whether the channel is enabled for imaging at all.
   *
   * @deprecated Use Builder and getters instead *
   */
  @Deprecated public boolean useChannel = true;
  /**
   * Name of the camera to use.
   *
   * @deprecated Use Builder and getters instead *
   */
  @Deprecated public String camera = "";
  ...
  private ChannelSpec(
      String mChannelGroup,
      String mConfig,
      double mExposure,
      double mZOffset,
      Boolean mDoZStack,
      Color mColor,
      int mSkipFactorFrame,
      boolean mUseChannel,
      String mCamera) {
