        ...
        return (AcquisitionEvent event) -> {
            ...
            if (positionList == null) {
                ...
                for (int index = 0; index < positionList.getNumberOfPositions(); index++) {
                    ...
                    // Not implemented for now because this is the magellan/pycromanager grid concept which is not identical
//                    posEvent.setGridRow(positionList.get(index).getGridRow());
//                    posEvent.setGridCol(positionList.get(index).getGridCol());
//                    posEvent.setAxisPosition(AcqEngMetadata.AXES_GRID_ROW, positionList.get(index).getGridRow());
//                    posEvent.setAxisPosition(AcqEngMetadata.AXES_GRID_COL, positionList.get(index).getGridCol());
