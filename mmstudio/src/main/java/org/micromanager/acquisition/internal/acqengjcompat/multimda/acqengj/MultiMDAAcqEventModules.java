...
public class MultiMDAAcqEventModules {
      ...
      return (AcquisitionEvent event) -> {
         return new Iterator<AcquisitionEvent>() {
            ...
            public AcquisitionEvent next() {
               ...
               sliceEvent.setAxisPosition(ACQ_IDENTIFIER, acqNr);
               zIndex_++;
               return sliceEvent;
            }
         };
   ...
   public static Function<AcquisitionEvent, Iterator<AcquisitionEvent>> channels(
         List<ChannelSpec> channelList, int acqNr) {
      return (AcquisitionEvent event) -> {
         return new Iterator<AcquisitionEvent>() {
            int index = 0;
            ...
            public AcquisitionEvent next() {
               ...
               channelEvent.setAxisPosition(ACQ_IDENTIFIER, acqNr);
               index++;
               return channelEvent;
            }
         };
      ...
      return (AcquisitionEvent event) -> {
         ...
         if (positionList == null || positionList.getNumberOfPositions() == 0) {
            ...
            for (int index = 0; index < positionList.getNumberOfPositions(); index++) {
               ...
               posEvent.setAxisPosition(ACQ_IDENTIFIER, acqNr);
