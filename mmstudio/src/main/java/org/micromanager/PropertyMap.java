 ...
 *
 * <p>A property map can store string-keyed values of various primitive types,
 ...
 * worrying about  thread safety. Null values cannot be stored</p>
 *
 * <p>To create a PropertyMap, use {@link PropertyMaps#builder()}.</p>
 *
 * <p>Property maps can be converted to a specific JSON format and back in a
 * type-preserving manner.</p>
 *
 * <p>Property maps are similar in concept to {@link java.util.Properties} but
 ...
 * storing multiple-choice settings.</p>
 *
 * <p>For how to insert values of the various types, see {@link PropertyMap.Builder}.</p>
 */
public interface PropertyMap {
    ...
    *
    * <p>See {@link PropertyMaps#builder()} for a usage example.</p>
    */
    ...
    *
    * <p>This method is intended for special code that handles serialization or
    ...
    * type for each key.</p>
    *
    * <p>For object (non-primitive) types, the class is returned (e.g. {@code
    * String.class}, {@code PropertyMap.class}).</p>
    *
    * <p>For primitive types, the primitive type class is returned (e.g. {@code
    * int.class}, {@code float.class}). Note that {@code int.class !=
    * Integer.class}.</p>
    *
    * <p>For collection (plural) types, the corresponding array type is returned
    * (e.g. {@code int[].class}, {@code String[].class}).</p>
    *
    * <p>Keys stored as "EnumAsString" return {@code String.class}.</p>
    *
    ...
    *
    * <p>This method may be useful for providing backward compatibility (for
    ...
    *
    * <p>Code that calls this method should be prepared to handle any of the
    ...
    *
    * <p>The property map does not record the specific class of enum values. It is
    * the caller's responsibility to specify the correct enum class.</p>
    *
   ...
   @Deprecated
   String[] getStringArray(String key, String[] aDefault);

   @Deprecated
   Integer getInt(String key);

   @Deprecated
   Integer getInt(String key, Integer aDefault);
