...
class LogCaptureControlPanel extends ControlPanel {
  ...
  LogCaptureControlPanel(ProblemReportController controller) {
    ...
    startOverButton_.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    cannotReproButton_.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    remarkButton.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    setLayout(
        new net.miginfocom.swing.MigLayout("fillx, insets 0", "[fill]", "unrel[]unrel[]unrel[][]"));
