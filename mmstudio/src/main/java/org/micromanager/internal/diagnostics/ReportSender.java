 ...
 *
 * <p>This class handles the simple task of uploading, given the report text. It does not and should
 * not depend on the contents of the report or its text.
 */
public final class ReportSender {
  ...
  private void saveReportToUUEncodedGZIPFile(String report, java.io.File file)
    ...
    try {
      ...
      new org.micromanager.internal.utils.MMUUEncoder()
          .encodeBuffer(gzipInputFromPipe, uuencodedOutputToFile);
    } finally {
      try {
