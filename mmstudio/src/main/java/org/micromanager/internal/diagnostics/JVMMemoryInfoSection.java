...
class JVMMemoryInfoSection implements SystemInfo.SystemInfoSection {
  ...
  public String getReport() {
    ...
    java.lang.management.MemoryMXBean memMXB =
        java.lang.management.ManagementFactory.getMemoryMXBean();
    sb.append("JVM heap memory usage: ")
        .append(formatMemUsage(memMXB.getHeapMemoryUsage()))
        .append('\n');
  ...
  private String formatMemUsage(java.lang.management.MemoryUsage usage) {
    StringBuilder sb = new StringBuilder();
    sb.append("used = ")
        .append(formatMemSize(usage.getUsed()))
        .append("; committed = ")
        .append(formatMemSize(usage.getCommitted()))
        .append("; max = ")
        .append(formatMemSize(usage.getMax()));
    return sb.toString();
  }
