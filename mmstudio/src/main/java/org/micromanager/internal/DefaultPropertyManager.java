...
/**
 * Default implementation of the PropertyManager API.
 */
public class DefaultPropertyManager implements PropertyManager {
    ...
    * JSON format is described in
    * {@link org.micromanager.internal.propertymap.PropertyMapJSONSerializer}
    *
    ...
    *
    * <p>JSON format is described in
    * {@link org.micromanager.internal.propertymap.PropertyMapJSONSerializer}.</p>
    *
