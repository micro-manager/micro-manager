 ...
 *
 * <p>aka the "Device/Property Browser"
 */
public final class PropertyEditor extends JFrame {
  ...
  private void createComponents() {
    ...
    add(
        new ShowFlagsPanel(data_, flags_, core_, core_.getSystemStateCache()),
  ...
  /**
   * Manually save now; if we wait until the program actually exits, then the profile will be done
   * finalizing and our settings won't get saved.
   *
  ...
  public final class PropertyEditorTableData extends PropertyTableData {
    public PropertyEditorTableData(
        Studio studio,
        String groupName,
        String presetName,
