...
class LegacyPropertyMap1Deserializer {
  ...
  static void constructPropertyMap1Property(
      PropertyMap.Builder builder, String key, String typeName, JsonElement valueElement) {
    if ("String".equals(typeName)) {
      ...
      byte[] serializedObject = BaseEncoding.base64().decode(base64EncodedSerializedObject);
      ((DefaultPropertyMap.Builder) builder).putLegacySerializedObject(key, serializedObject);
    } else {
