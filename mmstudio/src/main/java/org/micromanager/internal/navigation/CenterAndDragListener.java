...
public final class CenterAndDragListener {
   ...
   *
   * @param dme DisplayMouseEvent containing information about the mouse movement TODO: this does
   *     not take into account multiple cameras in different displays
   */
  @Subscribe
