...
public final class ConfigPadButtonPanel extends JPanel {
  ...
  public void removeGroup() {
    ...
    if (groupName.length() > 0) {
      ...
      JOptionPane.showMessageDialog(
          this, "To remove a group, select it on the Configurations panel first.");
    }
  }
  ...
  public void editGroup() {
    ...
    if (groupName.length() == 0) {
      JOptionPane.showMessageDialog(
          this, "To edit a group, please select it first, then press the edit button.");
    } else {
  ...
  public String choosePreset(String groupName, String msg) {
    ...
    return (String)
        JOptionPane.showInputDialog(
            null,
            "Please choose a preset from the " + groupName + " group " + msg,
            "Preset not selected.",
  ...
  public void editPreset() {
    ...
    if (groupName.length() == 0) {
      JOptionPane.showMessageDialog(
          this, "To edit a preset, please select the preset first, then press the edit button.");
