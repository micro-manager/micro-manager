...
public final class CalibrationEditor extends JDialog {
  ...
  public CalibrationEditor(Studio studio, String label, String pixelSize) {
    ...
    springLayout.putConstraint(
        SpringLayout.NORTH, scrollPane_, 160, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
    ...
    showCamerasCheckBox_.addActionListener(
        new ActionListener() {
          @Override
    ...
    springLayout.putConstraint(
        SpringLayout.SOUTH, showCamerasCheckBox_, 28, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.WEST, showCamerasCheckBox_, 10, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.EAST, showCamerasCheckBox_, 111, SpringLayout.WEST, getContentPane());

    showShuttersCheckBox_ = new JCheckBox();
    showShuttersCheckBox_.setFont(new Font("", Font.PLAIN, 10));
    showShuttersCheckBox_.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent arg0) {
    ...
    springLayout.putConstraint(
        SpringLayout.EAST, showShuttersCheckBox_, 111, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.WEST, showShuttersCheckBox_, 10, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.SOUTH, showShuttersCheckBox_, 50, SpringLayout.NORTH, getContentPane());

    showStagesCheckBox_ = new JCheckBox();
    showStagesCheckBox_.setFont(new Font("", Font.PLAIN, 10));
    showStagesCheckBox_.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent arg0) {
    ...
    springLayout.putConstraint(
        SpringLayout.EAST, showStagesCheckBox_, 111, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.WEST, showStagesCheckBox_, 10, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.SOUTH, showStagesCheckBox_, 73, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.NORTH, showStagesCheckBox_, 50, SpringLayout.NORTH, getContentPane());

    showStateDevicesCheckBox_ = new JCheckBox();
    showStateDevicesCheckBox_.setFont(new Font("", Font.PLAIN, 10));
    showStateDevicesCheckBox_.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent arg0) {
    ...
    springLayout.putConstraint(
        SpringLayout.EAST, showStateDevicesCheckBox_, 165, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.WEST, showStateDevicesCheckBox_, 10, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.SOUTH, showStateDevicesCheckBox_, 95, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.NORTH, showStateDevicesCheckBox_, 72, SpringLayout.NORTH, getContentPane());

    showOtherCheckBox_ = new JCheckBox();
    showOtherCheckBox_.setFont(new Font("", Font.PLAIN, 10));
    showOtherCheckBox_.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent arg0) {
    ...
    springLayout.putConstraint(
        SpringLayout.EAST, showOtherCheckBox_, 155, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.WEST, showOtherCheckBox_, 10, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.NORTH, showOtherCheckBox_, 95, SpringLayout.NORTH, getContentPane());
    ...
    if (showShowReadonlyCheckBox_) {
      ...
      springLayout.putConstraint(
          SpringLayout.WEST, showReadonlyCheckBox_, 190, SpringLayout.WEST, getContentPane());
      springLayout.putConstraint(
          SpringLayout.NORTH, showReadonlyCheckBox_, 0, SpringLayout.NORTH, showOtherCheckBox_);
      // springLayout_.putConstraint(SpringLayout.SOUTH, showReadonlyCheckBox_, 70,
    ...
    springLayout.putConstraint(
        SpringLayout.EAST, presetLabel, 340, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.WEST, presetLabel, 190, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.SOUTH, presetLabel, 26, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.NORTH, presetLabel, 15, SpringLayout.NORTH, getContentPane());

    presetLabelField_ = new JTextField(label_);
    getContentPane().add(presetLabelField_);
    springLayout.putConstraint(
        SpringLayout.EAST, presetLabelField_, 340, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.WEST, presetLabelField_, 190, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.SOUTH, presetLabelField_, 46, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.NORTH, presetLabelField_, 27, SpringLayout.NORTH, getContentPane());
    ...
    springLayout.putConstraint(
        SpringLayout.SOUTH, presetSizeLabel, 70, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.NORTH, presetSizeLabel, 56, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.EAST, presetSizeLabel, 340, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.WEST, presetSizeLabel, 190, SpringLayout.WEST, getContentPane());

    presetSizeField_ = new JTextField(pixelSize_);
    getContentPane().add(presetSizeField_);
    springLayout.putConstraint(
        SpringLayout.EAST, presetSizeField_, 340, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.WEST, presetSizeField_, 190, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.SOUTH, presetSizeField_, 90, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.NORTH, presetSizeField_, 71, SpringLayout.NORTH, getContentPane());
    ...
    springLayout.putConstraint(
        SpringLayout.SOUTH, okButton, 49, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.NORTH, okButton, 26, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.EAST, okButton, 475, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.WEST, okButton, 385, SpringLayout.WEST, getContentPane());
    ...
    springLayout.putConstraint(
        SpringLayout.EAST, cancelButton, 475, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.WEST, cancelButton, 385, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.SOUTH, cancelButton, 75, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.NORTH, cancelButton, 52, SpringLayout.NORTH, getContentPane());

    textArea_ = new JTextArea();
    textArea_.setFont(new Font("Arial", Font.PLAIN, 10));
    textArea_.setWrapStyleWord(true);
    textArea_.setText(
        "Select all settings you want use in this calibration and press OK to save changes.\n"
    ...
    springLayout.putConstraint(
        SpringLayout.EAST, textArea_, -5, SpringLayout.EAST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.WEST, textArea_, 10, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.SOUTH, textArea_, 155, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.NORTH, textArea_, 122, SpringLayout.NORTH, getContentPane());
  }
  ...
  protected boolean applySettings() {
    ...
    if (!data_.isEditingGroup()) data_.updateStatus(); // to set the "use" flags properly

    String duplicate = data_.findMatchingPreset();
    if (duplicate != null && duplicate.compareTo(label_) != 0) {
      JOptionPane.showMessageDialog(
          this,
          "This calibration is the same as: "
              + duplicate
  ...
  public void editNameOnly() {
    ...
    if (data_.isEditingGroup())
      textArea_.setText(
          "Please choose the properties to use when defining a pixel size configuration,\nand choose a name for the current pixel size settings.");
    else textArea_.setText("Please choose a name for this pixel size configuration.");
  }
  ...
  public void setCore(CMMCore core) {
    ...
    if (!data_.isEditingGroup()) {
      ...
      textArea_.setText(
          "Choose values for the properties contained in this calibration.\n"
  ...
  class PropertyTableData extends AbstractTableModel {
    ...
    public final String columnNames_[] = {"Property", "Value", "Use"};
    ...
    public String findMatchingPreset() {
      ...
      for (PropertyItem item : propList_) {
        if (item.confInclude) selected.add(item);
      }
      ...
      for (int i = 0; i < groupData_.length; i++) {
        ...
        if (matchCount == selected.size()) return presetNames_[i];
      }
    ...
    public boolean applySettings(String oldLabel, String newLabel, String pixelSize) {
      ...
      if (!oldLabel.equals(newLabel)) {
        try {
          if (core_.isPixelSizeConfigDefined(oldLabel)) core_.deletePixelSizeConfig(oldLabel);
        } catch (Exception e) {
          ReportingUtils.showError(e);
          return false;
        }
      ...
      if (selected.isEmpty()) {
        JOptionPane.showMessageDialog(
            null, "Please select \"Use\" column for at least one Property that affects pixel size");
        return false;
      }
      ...
      if (!isEditingGroup()) {
        ...
        for (PropertySetting groupSignature_1 : groupSignature_) {
          ...
          for (j = 0; j < selected.size(); j++) {
            ...
            if (item.device.compareTo(groupSignature_1.getDeviceLabel()) == 0
                && item.name.compareTo(groupSignature_1.getPropertyName()) == 0) {
              break;
            }
          }
          if (selected.size() == j) {
      ...
      if (mismatched.size() > 0 || missing.size() > 0) {
        ...
        String msgText =
            "All presets within a group should operate on the same set of device properties.\n"
                + "Based on the previously defined presets in this group, the following inconsistencises were detected:\n\n"
                + (mismatched.size() > 0
                    ? "Properties not previously defined:\n" + mismatchedList
                    : "\n")
                + (missing.size() > 0
                    ? "Properties prviously defined but missing from this preset:\n" + missingList
                    : "\n")
      ...
      try {
        ...
        if (core_.isPixelSizeConfigDefined(newLabel)) core_.deletePixelSizeConfig(newLabel);
    ...
    public int getColumnCount() {
      if (isEditingGroup()) return columnNames_.length;
      else return columnNames_.length - 1;
    }
    ...
    public Object getValueAt(int row, int col) {
      ...
      if (col == 0) return item.device + "-" + item.name;
      else if (col == 1) return item.value;
      else if (col == 2) {
        ...
        try {
          if (item.isInteger()) {
            core_.setProperty(
                item.device,
                item.name,
                Integer.toString(NumberUtils.displayStringToInt((String) value)));
          } else if (item.isFloat()) {
            core_.setProperty(
                item.device,
                item.name,
                Double.toString(NumberUtils.displayStringToDouble((String) value)));
          } else {
    ...
    public boolean isCellEditable(int nRow, int nCol) {
      if (nCol == 1) return tableEditable_ && !propList_.get(nRow).readOnly;
      else if (nCol == 2) {
    ...
    public void showOriginalSelection() {
      ...
      for (PropertyItem item : propList_) {
        if (initialCfg_.size() == 0) item.confInclude = false;
        else {
          item.confInclude = initialCfg_.isPropertyIncluded(item.device, item.name);
        }
      }
  ...
  /**
   * Cell editing using either JTextField or JComboBox depending on whether the property enforces a
  ...
  public final class PropertyCellEditor extends AbstractCellEditor implements TableCellEditor {
    ...
    public PropertyCellEditor() {
      ...
      slider_.addSliderMouseListener(
          new MouseAdapter() {
            @Override
    ...
    public Object getCellEditorValue() {
      if (editingCol_ == 1) {
        if (item_.allowed.length == 0) {
          if (item_.hasRange) return slider_.getText();
          else return text_.getText();
        } else {
          return combo_.getSelectedItem();
        }
      } else if (editingCol_ == 2) return check_.isSelected();
    ...
    public Component getTableCellRendererComponent(
      ...
      if (colIndex == 0) {
        ...
        if (item_.hasRange) {
          ...
          if (item_.isInteger()) slider.setLimits((int) item_.lowerLimit, (int) item_.upperLimit);
          else slider.setLimits(item_.lowerLimit, item_.upperLimit);
          try {
            if (item_.isFloat())
              value = NumberUtils.doubleToDisplayString(Double.parseDouble((String) value));
        ...
        if (item_.readOnly) cb.setEnabled(false);
        comp = cb;
      } else {
