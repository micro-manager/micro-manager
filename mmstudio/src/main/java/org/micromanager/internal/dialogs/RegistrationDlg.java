...
public final class RegistrationDlg extends JDialog {
   ...
   private final JTextField email_;
   private final JTextField inst_;
   private final JTextField name_;
   ...
   public RegistrationDlg(Studio studio) {
      ...
      final JPanel contents = new JPanel(new MigLayout("flowx"));
      JTextArea welcomeTextArea = new JTextArea();
      welcomeTextArea.setColumns(40);
      ...
      welcomeTextArea.setForeground(studio_.app().skin().getDisabledTextColor());
      welcomeTextArea.setWrapStyleWord(true);
      welcomeTextArea.setText("Welcome to Micro-Manager.\n\n"
      ...
      contents.add(welcomeTextArea, "alignx center, span, wrap");
         ...
         neverButton.addActionListener((ActionEvent arg0) -> {
            JOptionPane.showMessageDialog(RegistrationDlg.this,
                  "You have chosen never to register. \n"
                        ...
                        + "the \"Register\" option in the Help menu.");
      ...
      super.setLocation(screenSize.width / 2 - (winSize.width / 2),
