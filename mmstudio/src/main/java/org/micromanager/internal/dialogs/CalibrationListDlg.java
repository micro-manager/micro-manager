...
public final class CalibrationListDlg extends JDialog {
  ...
  public CalibrationListDlg(CMMCore core) {
    ...
    springLayout.putConstraint(
        SpringLayout.SOUTH, scrollPane, -16, SpringLayout.SOUTH, super.getContentPane());
    springLayout.putConstraint(
        SpringLayout.NORTH, scrollPane, 15, SpringLayout.NORTH, super.getContentPane());
    ...
    springLayout.putConstraint(
        SpringLayout.SOUTH, newButton, 40, SpringLayout.NORTH, super.getContentPane());
    springLayout.putConstraint(
        SpringLayout.NORTH, newButton, 17, SpringLayout.NORTH, super.getContentPane());
    springLayout.putConstraint(
        SpringLayout.EAST, newButton, -9, SpringLayout.EAST, super.getContentPane());
    ...
    springLayout.putConstraint(
        SpringLayout.SOUTH, editButton, 65, SpringLayout.NORTH, super.getContentPane());
    springLayout.putConstraint(
        SpringLayout.NORTH, editButton, 42, SpringLayout.NORTH, super.getContentPane());
    springLayout.putConstraint(
        SpringLayout.EAST, editButton, -9, SpringLayout.EAST, super.getContentPane());
    springLayout.putConstraint(
        SpringLayout.WEST, editButton, -109, SpringLayout.EAST, super.getContentPane());
    ...
    springLayout.putConstraint(
        SpringLayout.SOUTH, removeButton, 88, SpringLayout.NORTH, super.getContentPane());
    springLayout.putConstraint(
        SpringLayout.NORTH, removeButton, 65, SpringLayout.NORTH, super.getContentPane());
    springLayout.putConstraint(
        SpringLayout.EAST, removeButton, -9, SpringLayout.EAST, super.getContentPane());
    springLayout.putConstraint(
        SpringLayout.WEST, removeButton, -109, SpringLayout.EAST, super.getContentPane());
    ...
    springLayout.putConstraint(
        SpringLayout.SOUTH, removeAllButton, 111, SpringLayout.NORTH, super.getContentPane());
    springLayout.putConstraint(
        SpringLayout.NORTH, removeAllButton, 88, SpringLayout.NORTH, super.getContentPane());
    springLayout.putConstraint(
        SpringLayout.EAST, removeAllButton, 100, SpringLayout.WEST, removeButton);
    springLayout.putConstraint(
        SpringLayout.WEST, removeAllButton, 0, SpringLayout.WEST, removeButton);
    ...
    springLayout.putConstraint(
        SpringLayout.NORTH, closeButton, -23, SpringLayout.SOUTH, scrollPane);
    springLayout.putConstraint(SpringLayout.EAST, scrollPane, -5, SpringLayout.WEST, closeButton);
    springLayout.putConstraint(
        SpringLayout.WEST, scrollPane, 10, SpringLayout.WEST, super.getContentPane());
    springLayout.putConstraint(
        SpringLayout.EAST, closeButton, -5, SpringLayout.EAST, super.getContentPane());
        ...
        if (mmStudio.hasConfigChanged()) {
          ...
          int userFeedback =
              JOptionPane.showOptionDialog(
                  null,
                  "Save Changed Pixel Configuration?",
                  "Micro-Manager",
  ...
  public boolean editPreset(String calibrationName, String pixelSize, boolean newConfig) {
    ...
    if (result == JOptionPane.OK_OPTION) {
      if (calibrationList_.size() == 0) {
        configDialog_ = new PixelConfigEditor(calibrationName, this, pixelSize, true);
      } else {
        configDialog_ = new PixelPresetEditor(calibrationName, this, pixelSize, newConfig);
      }
      configDialog_.setVisible(true);
    }
    return false;
