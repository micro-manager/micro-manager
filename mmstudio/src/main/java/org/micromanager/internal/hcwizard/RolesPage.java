...
public final class RolesPage extends PagePanel {
  ...
  public RolesPage() {
    ...
    cameraComboBox_.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent arg0) {
            try {
              model_.setDeviceSetupProperty(
                  MMCoreJ.getG_Keyword_CoreDevice(),
                  MMCoreJ.getG_Keyword_CoreCamera(),
                  (String) cameraComboBox_.getSelectedItem());
          ...
          public void actionPerformed(ActionEvent arg0) {
            try {
              model_.setDeviceSetupProperty(
                  ...
                  (String) shutterComboBox_.getSelectedItem());
            } catch (MMConfigFileException e) {
    ...
    focusComboBox_.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent arg0) {
            try {
              model_.setDeviceSetupProperty(
                  ...
                  (String) focusComboBox_.getSelectedItem());
            } catch (MMConfigFileException e) {
              handleError(e.getMessage());
              ;
            }
    ...
    autoshutterCheckBox_.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent arg0) {
            try {
              String as = new String();
              if (autoshutterCheckBox_.isSelected()) as = "1";
              else as = "0";
              model_.setDeviceSetupProperty(
                  MMCoreJ.getG_Keyword_CoreDevice(), MMCoreJ.getG_Keyword_CoreAutoShutter(), as);
            } catch (MMConfigFileException e) {
              ReportingUtils.showError(e);
            }
          }
  ...
  public boolean enterPage(boolean next) {
    ...
    if (cameras != null) {
      ...
      items[0] = "";
      for (int i = 0; i < cameras.size(); i++) items[i + 1] = cameras.get(i);

      if (1 == cameras.size())
        try {
          model_.setDeviceSetupProperty(
              MMCoreJ.getG_Keyword_CoreDevice(), MMCoreJ.getG_Keyword_CoreCamera(), cameras.get(0));
        } catch (Exception e) {
        }
    ...
    if (shutters != null) {
      ...
      items[0] = "";
      for (int i = 0; i < shutters.size(); i++) items[i + 1] = shutters.get(i);
      if (1 == shutters.size())
        try {
          model_.setDeviceSetupProperty(
              MMCoreJ.getG_Keyword_CoreDevice(),
    ...
    if (stages != null) {
      ...
      items[0] = "";
      for (int i = 0; i < stages.size(); i++) items[i + 1] = stages.get(i);

      if (1 == stages.size())
        try {
          model_.setDeviceSetupProperty(
              MMCoreJ.getG_Keyword_CoreDevice(), MMCoreJ.getG_Keyword_CoreFocus(), stages.get(0));
        } catch (Exception e) {
    ...
    try {
      String camera =
          model_.getDeviceSetupProperty(
              MMCoreJ.getG_Keyword_CoreDevice(), MMCoreJ.getG_Keyword_CoreCamera());
      if (model_.findDevice(camera) != null) cameraComboBox_.setSelectedItem(camera);
      else cameraComboBox_.setSelectedItem("");

      String shutter =
          model_.getDeviceSetupProperty(
              MMCoreJ.getG_Keyword_CoreDevice(), MMCoreJ.getG_Keyword_CoreShutter());
      if (model_.findDevice(shutter) != null) shutterComboBox_.setSelectedItem(shutter);
      else shutterComboBox_.setSelectedItem("");

      String focus =
          model_.getDeviceSetupProperty(
              MMCoreJ.getG_Keyword_CoreDevice(), MMCoreJ.getG_Keyword_CoreFocus());
      if (model_.findDevice(focus) != null) focusComboBox_.setSelectedItem(focus);
      else focusComboBox_.setSelectedItem("");

      String as =
          model_.getDeviceSetupProperty(
              MMCoreJ.getG_Keyword_CoreDevice(), MMCoreJ.getG_Keyword_CoreAutoShutter());
      if (as.compareTo("1") == 0) autoshutterCheckBox_.setSelected(true);
      else autoshutterCheckBox_.setSelected(false);
    } catch (MMConfigFileException e) {
      ReportingUtils.showError(e);
    }
    ...
    if (stages != null && stages.size() > 0) {
      ...
      for (final String stageLabel : Arrays.asList(stages.toArray())) {
        ...
        final JComboBox comboBox =
            new JComboBox(
                new String[] {
                  "Unknown", "Positive Toward Sample", "Positive Away From Sample",
                });
        ...
        focusDirectionPanel_.add(new JLabel(stageLabel + ":"), "split, span");
