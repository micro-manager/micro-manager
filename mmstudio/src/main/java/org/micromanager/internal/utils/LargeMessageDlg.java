...
public final class LargeMessageDlg extends JDialog {
  ...
  public LargeMessageDlg(String title, String message) {
    ...
    springLayout.putConstraint(
        SpringLayout.SOUTH, okButton, 288, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.NORTH, okButton, -30, SpringLayout.SOUTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.EAST, okButton, 291, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.WEST, okButton, 208, SpringLayout.WEST, getContentPane());

    scrollPane_ = new JScrollPane();
    getContentPane().add(scrollPane_);
    springLayout.putConstraint(
        SpringLayout.SOUTH, scrollPane_, -35, SpringLayout.SOUTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.NORTH, scrollPane_, 5, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
