...
public final class AcqOrderMode {
  ...
  /**
   * Generates a string describing the ordering, e.g. "T1,P1,Z1,C1; T1,P1,Z1,C2; ...; T1,P1,Z2,C1;
   * T1,P1,Z2,C2; ...; T1,P2,Z1,C1; T1,P2,Z1,C2; ...; T2,P1,Z1,C1; T2,P1,Z1,C2; ...;" Formatting is
   * geared towards the acquisition control dialog.
   */
