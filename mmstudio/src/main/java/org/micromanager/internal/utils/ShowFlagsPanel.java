...
public final class ShowFlagsPanel extends JPanel {
  ...
  private static final long serialVersionUID =
      2414705031299832388L; // need to change? added new field
  ...
  public ShowFlagsPanel(
      PropertyTableData data, ShowFlags flags, CMMCore core, Configuration initialCfg) {
    data_ = data;
    flags_ = flags;
    core_ = core;
  ...
  public void createComponents() {
    ...
    showAllTypesButton.addActionListener(
        (ActionEvent arg0) -> {
          selectAllTypes(true);
        });
    ...
    showNoTypesButton.addActionListener(
        (ActionEvent arg0) -> {
