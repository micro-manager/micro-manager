...
public final class FileDialogs {
  ...
  public static final FileType MM_CONFIG_FILE =
      new FileType("MM_CONFIG_FILE", "Micro-Manager Config File", "./MyScope.cfg", true, "cfg");
  ...
  public static final FileType SCIFIO_DATA =
      new FileType(
          "SciFIO_Data_Set",
          "Image Location",
          System.getProperty("user.home") + "/Untitled.tif",
          false,
          "tif",
          "jpg",
          "avi",
  ...
  public static final FileType ACQ_SETTINGS_FILE =
      new FileType(
          "ACQ_SETTINGS_FILE",
  ...
  private static class GeneralFileFilter extends javax.swing.filechooser.FileFilter
  ...
  public static void storePath(FileType type, File path) {
    ...
    profile.getSettings(FileDialogs.class).putString(type.name, type.defaultFileName);
  }
  ...
  public static String getSuggestedFile(FileType type) {
    return MMStudio.getInstance()
        .profile()
        .getSettings(FileDialogs.class)
        .getString(type.name, type.defaultFileName);
  }
}
