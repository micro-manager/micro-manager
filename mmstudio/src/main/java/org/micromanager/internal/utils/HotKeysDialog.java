...
public final class HotKeysDialog extends JDialog {
  ...
  public void updateComboBox() {
    ...
    System.arraycopy(
        HotKeyAction.GUIITEMS, 0, possibleActionsAsString_, 0, HotKeyAction.GUIITEMS.length);
  ...
  public final class KeyEvtHandler implements KeyListener {
    ...
    public void keyPressed(KeyEvent ke) {
      ...
      if (!keys_.contains(value) || value.intValue() == keys_.get(hotKeyTable_.getSelectedRow())) {
        lastTypedKey_ = value;
        if (label_ != null) {
  ...
  public final class HotKeyCol1Editor extends AbstractCellEditor implements TableCellEditor {
    ...
    public Component getTableCellEditorComponent(
        javax.swing.JTable table, Object value, boolean isSelected, int rowIndex, int colIndex) {
  ...
  private void initComponents() {
    ...
    layout.setHorizontalGroup(
        layout
            ...
            .addComponent(
                jScrollPane1_, javax.swing.GroupLayout.DEFAULT_SIZE, 377, Short.MAX_VALUE));
  ...
  private void addButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_addButton_ActionPerformed
    keys_.add(32);
  ...
  private void removeButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_removeButton_ActionPerformed
    hotKeyTable_.getColumnModel().getColumn(0).getCellEditor().stopCellEditing();
    hotKeyTable_.getColumnModel().getColumn(1).getCellEditor().stopCellEditing();
