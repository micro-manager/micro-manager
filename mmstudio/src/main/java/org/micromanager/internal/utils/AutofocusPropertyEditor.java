...
/** @author Nenad Amodaj PropertyEditor provides UI for manipulating sets of autofocus properties */
 ...
 * system state as a list of triplets: device - property - value
 */
public final class AutofocusPropertyEditor extends JDialog {
  ...
  public AutofocusPropertyEditor(Studio studio, DefaultAutofocusManager afmgr) {
        ...
        new WindowAdapter() {
          ...
          public void windowOpened(WindowEvent e) {
            ...
            showReadonlyCheckBox_.setSelected(
                profile
                    .getSettings(AutofocusPropertyEditor.class)
    ...
    springLayout.putConstraint(
        SpringLayout.NORTH, scrollPane_, 70, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
    ...
    springLayout.putConstraint(
        SpringLayout.NORTH, refreshButton, 10, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.WEST, refreshButton, 10, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.SOUTH, refreshButton, 33, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.EAST, refreshButton, 110, SpringLayout.WEST, getContentPane());
    refreshButton.setIcon(
        new ImageIcon(getClass().getResource("/org/micromanager/icons/arrow_refresh.png")));
    ...
    springLayout.putConstraint(
        SpringLayout.NORTH, showReadonlyCheckBox_, 41, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.WEST, showReadonlyCheckBox_, 10, SpringLayout.WEST, getContentPane());
    springLayout.putConstraint(
        SpringLayout.SOUTH, showReadonlyCheckBox_, 64, SpringLayout.NORTH, getContentPane());
    springLayout.putConstraint(
        SpringLayout.EAST, showReadonlyCheckBox_, 183, SpringLayout.WEST, getContentPane());
    ...
    // restore values from the previous session
    showReadonlyCheckBox_.setSelected(
        profile.getSettings(AutofocusPropertyEditor.class).getBoolean(PREF_SHOW_READONLY, true));
    {
      ...
      springLayout.putConstraint(
          SpringLayout.SOUTH, btnClose, 0, SpringLayout.SOUTH, refreshButton);
      springLayout.putConstraint(
          SpringLayout.EAST, btnClose, -10, SpringLayout.EAST, getContentPane());
    ...
    if (afMgr_ != null) {
      ...
      springLayout.putConstraint(
          SpringLayout.WEST, methodCombo_, 80, SpringLayout.EAST, refreshButton);
      springLayout.putConstraint(
          SpringLayout.SOUTH, methodCombo_, 0, SpringLayout.SOUTH, refreshButton);
  ...
  public void rebuild() {
    ...
    try {
      if (l != null) methodCombo_.removeActionListener(l);
    } catch (Exception e) {
    ...
    if (afMgr_ != null) {
      ...
      if (afDevice != null) methodCombo_.setSelectedItem(afDevice);
      else if (afMgr_.getAutofocusMethod() != null) {
        methodCombo_.setSelectedItem(afMgr_.getAutofocusMethod().getName());
      }
    }
  }
  ...
  public void updateStatus() {
    if (data_ != null) data_.updateStatus();
  }
  ...
  final class PropertyTableData extends AbstractTableModel {
    ...
    public boolean isCellEditable(int nRow, int nCol) {
      if (nCol == 1) return !propList_.get(nRow).readOnly;
      else return false;
    }

    public void refresh() {
      if (afMgr_.getAutofocusMethod() == null) return;
  ...
  public final class PropertyCellEditor extends AbstractCellEditor implements TableCellEditor {
    ...
    public Object getCellEditorValue() {
      ...
      } else if (editingCol_ == 2) return check_;
