...
public class PopupButton extends JToggleButton
    implements PopupMenuListener, HierarchyListener, WindowFocusListener, ComponentListener {
  public interface Listener {
    /**
     * Provides the listener an opportunity to configure or swap the popup before it is displayed.
     *
     * @param button
     */
