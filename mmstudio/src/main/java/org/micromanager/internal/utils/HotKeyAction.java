...
public final class HotKeyAction {
   ...
   public static final String[] GUIITEMS = {"Snap", "Toggle Live", "Toggle Shutter",
         "->Album", "Mark Position", "Autostretch histograms"};
   ...
   private final MMStudio studio_ = MMStudio.getInstance();
