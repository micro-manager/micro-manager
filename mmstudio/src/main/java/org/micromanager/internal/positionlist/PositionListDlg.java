...
/**
 * The PositionListDlg class provides a convenient UI to generate, edit, load,
 * and save PositionList objects.
 */
public class PositionListDlg extends JFrame implements MouseListener, ChangeListener {
   ...
   public PositionListDlg(Studio studio, PositionList posList) {
      ...
      CellEditor cellEditor = new CellEditor(arialSmallFont_);
      cellEditor.addListener();
      posTable_.setDefaultEditor(Object.class, cellEditor);
      ...
      final JPanel arrowPanel = new JPanel(new MigLayout("insets 0, fillx"));
