...
public final class DefaultPositionListManager implements PositionListManager {
  ...
  /**
   * Makes this the 'current' PositionList, i.e., the one used by the Acquisition Protocol. Replaces
   * the list in the PositionList Window It will open a position list dialog if it was not already
   * open.
   *
  ...
  public void setPositionList(
      PositionList pl) { // use serialization to clone the PositionList object
    posList_ = pl;
