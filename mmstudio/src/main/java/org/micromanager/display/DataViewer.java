 ...
 *
 * <p>Implementers: Normally, you should subclass {@link AbstractDataViewer}
...
public interface DataViewer extends EventPublisher {
    ...
    *
    * <p>Implementers: This method should be implemented so that it can be called
    * from any thread. Typically, the data provider will be a {@code private
    * final} field in your implementation.</p>
    *
    ...
    * Display the images at the specified coordinates in the data provider.
    *
    * <p>See {@link #setDisplayPosition(Coords, boolean)} for details. This method
    ...
    *
    * <p>This method can be called from any thread. The return value will be
    * consistent with the most recent call to {@link #setDisplayPosition(Coords)} or
    * {@code compareAndSetDisplayPosition}.</p>
    *
    ...
    * Set the display position only if the current position is the expected one.
    *
    * <p>See {@link #compareAndSetDisplayPosition(Coords, Coords, boolean)} for
    * details.
    *
    * <p>This method will not force a redisplay if {@code newPosition} is the same
    ...
    * @throws java.io.IOException can happen with disk based data providers.
    */
    ...
    *
    * <p>Typically this will include the display number and the name of the
    * dataset.</p>
    *
    * <p>Implementers: An effort should be made to return a unique name (e.g. by
    ...
    * attached to the same dataset).</p>
    *
