...
public class DisplayWindowDidAddOverlayEvent {
  ...
  public static DisplayWindowDidAddOverlayEvent create(DisplayWindow display, Overlay overlay) {
    return new DisplayWindowDidAddOverlayEvent(display, overlay);
  }

  private DisplayWindowDidAddOverlayEvent(DisplayWindow display, Overlay overlay) {
    display_ = display;
    overlay_ = overlay;
  }
