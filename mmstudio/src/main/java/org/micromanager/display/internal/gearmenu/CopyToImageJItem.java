      ...
      if (dp.getNumImages() == 1) {
         ...
         try {
            ...
            for (int t = 0; t < dp.getAxisLength(Coords.T); t++) {
               for (int z = 0; z < dp.getAxisLength(Coords.Z); z++) {
                  for (int c = 0; c < dp.getAxisLength(Coords.C); c++) {
            ...
            iPlus.setStack(imgStack, dp.getAxisLength(Coords.C),
                    dp.getAxisLength(Coords.Z), dp.getAxisLength(Coords.T));
