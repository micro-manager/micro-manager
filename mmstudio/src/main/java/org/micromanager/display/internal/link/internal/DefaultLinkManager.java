...
public class DefaultLinkManager implements LinkManager {
  ...
  private final LinkageFactory linkageFactory_ = LinkageFactory.create();
  ...
  public void registerAnchor(LinkAnchor<?> anchor) {
    Preconditions.checkArgument(
        anchor instanceof AbstractLinkAnchor, "anchor must be a subclass of AbstractLinkAnchor");
