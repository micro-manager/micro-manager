 ...
 *
 * <p>Manages all data viewers in the application, and keeps track of the front-most viewer. Also
 * publishes all viewer events.
 *
 * <p>This class handles generic {@code DataViewer}s and does not perform tasks that are specific to
 * {@code DisplayWindow}s.
 *
