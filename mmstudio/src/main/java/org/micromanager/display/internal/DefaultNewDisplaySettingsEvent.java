 ...
 */
public final class DefaultNewDisplaySettingsEvent implements NewDisplaySettingsEvent {
   private final DisplaySettings newSettings_;
   private final DisplaySettings oldSettings_;
   private final DataViewer viewer_;

   public static DefaultNewDisplaySettingsEvent create(DataViewer viewer,
         DisplaySettings oldSettings, DisplaySettings newSettings)
   {
      return new DefaultNewDisplaySettingsEvent(viewer,
            oldSettings, newSettings);
   }

   private DefaultNewDisplaySettingsEvent(DataViewer viewer,
         DisplaySettings oldSettings, DisplaySettings newSettings)
   {
      viewer_ = viewer;
