...
final class DefaultLinkEndpoint implements LinkEndpoint {
  ...
  public synchronized void linkToPeer(LinkEndpoint peer) {
    ...
    Preconditions.checkArgument(peer.getLinkageGroup().equals(getLinkageGroup()));
  ...
  @Override
  public synchronized void linkageDidTransferEndpoint(Linkage oldLinkage, Linkage newLinkage) {
