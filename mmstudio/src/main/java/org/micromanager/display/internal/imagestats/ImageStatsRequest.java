...
public final class ImageStatsRequest {
  ...
  public static ImageStatsRequest create(
      Coords nominalCoords, List<Image> images, BoundsRectAndMask roi) {
    return new ImageStatsRequest(nominalCoords, images, roi);
  }

  private ImageStatsRequest(Coords nominalCoords, List<Image> images, BoundsRectAndMask roi) {
