...
public final class IntegerComponentStats {
  ...
  private IntegerComponentStats(Builder b) {
    histogram_ = b.histogram_ != null ? Arrays.copyOf(b.histogram_, b.histogram_.length) : null;
  ...
  public double getQuantile(double q) {
    ...
    binIndex =
        binarySearch(cumDistrib, 1, cumDistrib.length - 1, (long) Math.floor(countBelowQuantile));
  ...
  private int binarySearch(long[] sorted, int startIndex, int endIndex, long value) {
