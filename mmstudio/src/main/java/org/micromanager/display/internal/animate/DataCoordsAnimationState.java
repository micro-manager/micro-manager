 ...
 *
 * <p>Keeps track of the current position of the animation, and computes the position that should be
 * displayed next.
 *
...
public class DataCoordsAnimationState implements AnimationStateDelegate<Coords> {
  /**
   * Interface for the delegate supplying presence/absence of data. All methods must be thread safe.
   */
  ...
  private Coords advanceAnimationPositionImpl(double frames, boolean skipNonExistent) {
