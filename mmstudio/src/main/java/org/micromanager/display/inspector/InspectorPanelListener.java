...
public interface InspectorPanelListener {
   ...
   *
   * <p>This method should be called when the panel height is changed due to the panel content
   * changing, but not when the user resizes the panel manually.
   *
   * @param controller the controller of the inspector panel whose height is about to change
   */
   ...
   * changing, but not when the user resizes the panel manually.
   *
   * @param controller the controller of the inspector panel whose height has changed
   */
