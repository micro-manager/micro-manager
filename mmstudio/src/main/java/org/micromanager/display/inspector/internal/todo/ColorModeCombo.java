...
public final class ColorModeCombo extends JButton {
   ...
   public ColorModeCombo(DataViewer display) {
      ...
      setText(ColorMaps.ICONS.get(index).text_);
      setIcon(ColorMaps.ICONS.get(index).icon_);
   ...
   private void showMenu() {
      ...
      for (int i = 0; i < ColorMaps.ICONS.size(); ++i) {
         final int index = i;
         ColorMaps.IconWithStats icon = ColorMaps.ICONS.get(i);
         ...
         item.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
               ...
               settings = settings.copyBuilder().channelColorMode(
