...
package org.micromanager.display.inspector.internal.todo;
...
// go-between.
public final class HistogramsPanel extends AbstractInspectorPanelController {
      ...
      shouldAutostretch_.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
            ...
            DisplaySettings newSettings = viewer_.getDisplaySettings()
                  .copyBuilder().shouldAutostretch(newVal).build();
   ...
   private void setExtremaPercentage(JSpinner extrema) {
      ...
      settings = settings.copyBuilder().extremaPercentage(percentage).build();
   ...
   public JPopupMenu getGearMenu() {
      ...
      logDisplay.addActionListener(new ActionListener() {
         @Override
         public void actionPerformed(ActionEvent e) {
            DisplaySettings newSettings = settings.copyBuilder()
      ...
      rgb.addActionListener(new ActionListener() {
         @Override
         public void actionPerformed(ActionEvent e) {
            DisplaySettings newSettings = settings.copyBuilder().channelColors(RGB_COLORS).build();
            viewer_.setDisplaySettings(newSettings);
         }
      });
      ...
      colorblind.addActionListener(new ActionListener() {
         @Override
         public void actionPerformed(ActionEvent e) {
            DisplaySettings newSettings = settings.copyBuilder().channelColors(COLORBLIND_COLORS).build();
            viewer_.setDisplaySettings(newSettings);
         }
      });
      ...
      never.addActionListener(new ActionListener() {
         @Override
         public void actionPerformed(ActionEvent e) {
            DisplaySettings newSettings = settings.copyBuilder().histogramUpdateRate(-1.0).build();
            viewer_.setDisplaySettings(newSettings);
         }
      });
      ...
      always.addActionListener(new ActionListener() {
         @Override
         public void actionPerformed(ActionEvent e) {
            DisplaySettings newSettings = settings.copyBuilder().histogramUpdateRate(0.0).build();
            viewer_.setDisplaySettings(newSettings);
         }
      });
      ...
      shouldScaleWithROI.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
            ...
            DisplaySettings newSettings = viewer_.getDisplaySettings()
                  .copyBuilder().shouldScaleWithROI(newVal).build();
            viewer_.setDisplaySettings(newSettings);
         }
      });
