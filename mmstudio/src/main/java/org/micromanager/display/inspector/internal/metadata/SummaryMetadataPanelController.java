 ...
 */
public class SummaryMetadataPanelController extends AbstractInspectorPanelController {
   ...
   public static AbstractInspectorPanelController create() {
      return new SummaryMetadataPanelController();
   }

   private SummaryMetadataPanelController() {
