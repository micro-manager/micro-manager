...
/**
 * Stores the display settings for individual channels Maintains the state of things like channel
 * color, visibility, min, max, gamma, and histogram range
 *
 * @author mark
 */
public interface ChannelDisplaySettings {
  ...
  /**
   * Color used to represent this channel, i.e., brightest color of the LUT used to display this
   * channel
   *
  ...
  /**
   * Range of this histogram displayed for this channel For now, histogram always starts at zero, so
   * this represents the maximum value on the x-axis of the histogram.
   *
