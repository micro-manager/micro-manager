 ...
 *
 * <p>In MMStudio and its plugins, <em>all</em> user preferences should be stored
 * in the current user profile, <em>not in the standard Java preferences</em>.</p>
 *
 * <p>
 ...
 * users is a widespread practice on computers attached to scientific equipment.</p>
 *
 * <p>The user profile stores the same kinds of values as {@link PropertyMap},
...
public interface UserProfile {
    ...
    *
    * <p>This is the main interface for accessing values in the user profile.</p>
    *
    ...
    *
    * <p>Do not confuse with {@code getSettings(owner).clear()}!</p>
    */
