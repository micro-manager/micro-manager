...
public final class ProfilePropertyMapView implements MutablePropertyMapView {
   ...
   @Override
   public MutablePropertyMapView putAffineTransformList(final String key,
                                                        final AffineTransform... values) {
      write(new DefaultUserProfile.Editor() {
         @Override
         public PropertyMap edit(PropertyMap input) {
   ...
   @Override
   public MutablePropertyMapView putAffineTransformList(final String key,
                                                        final Iterable<AffineTransform> values) {
      write(new DefaultUserProfile.Editor() {
         @Override
         public PropertyMap edit(PropertyMap input) {
            return input.copyBuilder().putAffineTransformList(key, values).build();
   ...
   @Override
   public MutablePropertyMapView putPropertyMapList(final String key,
                                                    final Iterable<PropertyMap> values) {
      write(new DefaultUserProfile.Editor() {
         @Override
         public PropertyMap edit(PropertyMap input) {
            return input.copyBuilder().putPropertyMapList(key, values).build();
   ...
   @Override
   public MutablePropertyMapView putRectangleList(final String key,
                                                  final Iterable<Rectangle> values) {
      write(new DefaultUserProfile.Editor() {
         @Override
         public PropertyMap edit(PropertyMap input) {
            return input.copyBuilder().putRectangleList(key, values).build();
   ...
   @Override
   public MutablePropertyMapView putDimensionList(final String key,
                                                  final Iterable<Dimension> values) {
      write(new DefaultUserProfile.Editor() {
         @Override
         public PropertyMap edit(PropertyMap input) {
            return input.copyBuilder().putDimensionList(key, values).build();
   ...
   @Override
   public <E extends Enum<E>> MutablePropertyMapView putEnumAsString(final String key,
                                                                     final E value) {
      write(new DefaultUserProfile.Editor() {
         @Override
         public PropertyMap edit(PropertyMap input) {
