...
final class ProfileSaver {
  ...
  public static ProfileSaver create(
      DefaultUserProfile profile, Runnable save, ScheduledExecutorService saverExecutor) {
  ...
  private synchronized void scheduleSave() {
    ...
    try {
      scheduledSave_ = saver_.schedule(save_, saveIntervalSeconds_, TimeUnit.SECONDS);
