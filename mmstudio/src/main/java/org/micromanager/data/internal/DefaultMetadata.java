 ...
 * Metadatas using a MetadataBuilder, or by using the copy() method (which provides a
 * MetadataBuilder). Any fields that are not explicitly set will default to null.
 */
public final class DefaultMetadata implements Metadata {
  ...
  public Integer getBitDepth() {
    return pmap_.containsKey(BIT_DEPTH.key()) ? pmap_.getInteger(BIT_DEPTH.key(), 0) : null;
  }

  @Override
  public Double getExposureMs() {
    return pmap_.containsKey(EXPOSURE_MS.key())
        ? pmap_.getDouble(EXPOSURE_MS.key(), Double.NaN)
        : null;
  }
  ...
  public Double getElapsedTimeMs() {
    return pmap_.containsKey(ELAPSED_TIME_MS.key())
        ? pmap_.getDouble(ELAPSED_TIME_MS.key(), Double.NaN)
        : null;
  }
  ...
  public Integer getBinning() {
    return pmap_.containsKey(BINNING.key()) ? pmap_.getInteger(BINNING.key(), 0) : null;
  }

  @Override
  public Long getImageNumber() {
    return pmap_.containsKey(IMAGE_NUMBER.key()) ? pmap_.getLong(IMAGE_NUMBER.key(), 0L) : null;
  }
  ...
  public Double getXPositionUm() {
    return pmap_.containsKey(X_POSITION_UM.key())
        ? pmap_.getDouble(X_POSITION_UM.key(), Double.NaN)
        : null;
  }
  ...
  public Double getYPositionUm() {
    return pmap_.containsKey(Y_POSITION_UM.key())
        ? pmap_.getDouble(Y_POSITION_UM.key(), Double.NaN)
        : null;
  }
  ...
  public Double getZPositionUm() {
    return pmap_.containsKey(Z_POSITION_UM.key())
        ? pmap_.getDouble(Z_POSITION_UM.key(), Double.NaN)
        : null;
  }
  ...
  public Double getPixelSizeUm() {
    return pmap_.containsKey(PIXEL_SIZE_UM.key())
        ? pmap_.getDouble(PIXEL_SIZE_UM.key(), Double.NaN)
        : null;
  }
  ...
  public Double getPixelAspect() {
    return pmap_.containsKey(PIXEL_ASPECT.key())
        ? pmap_.getDouble(PIXEL_ASPECT.key(), Double.NaN)
        : null;
  }
