...
public final class DefaultCoords implements Coords {
    ...
    public Builder offset(String axis, int offset)
      ...
      if (newIndex < 0) {
        throw new IndexOutOfBoundsException(
            "Offset would make Coords have negative index for axis \"" + axis + "\"");
      }
      index(axis, newIndex);
      return this;
    }
  ...
  /**
   * Generate a normalized string representation of this Coords, that we can later parse out using
   * {@link #fromNormalizedString}.
   *
  ...
  private static Pattern AXIS_NAME_PATTERN = Pattern.compile("[A-Za-z]+[A-Za-z0-9_]*");
