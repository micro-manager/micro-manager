...
public final class CommentsHelper {
  ...
  /**
   * Returns the summary comment for the specified Datastore, or "" if it does not exist.
   *
  ...
  /**
   * Returns the comment for the specified Image in the specified Datastore, or empty string if it
   * does not exist.
   *
   ...
   * @throws java.io.IOException
   */
  public static void setImageComment(Datastore store, Coords coords, String comment)
      throws IOException {
    Annotation annotation = store.getAnnotation(COMMENTS_FILE);
  ...
  public static void createAnnotation(Datastore store) throws IOException {
    // store.createNewAnnotation(COMMENTS_FILE       // throw new
    // UnsupportedOperationException("TODO");
    ReportingUtils.logError(
        "TODO: Implement org.micromanager.data.internal.CommentsHelper.createAnnotation");
  }
}
