 ...
 *
 * <p>Annotations are used for attributes like image comments and display settings that may be
 * changed after the Datastore has been frozen.
 */
public interface Annotation {
  /**
   * Return a PropertyMap of information stored by this Annotation related to the image at the
  ...
  /**
   * Return a PropertyMap of information stored by the Annotation that is not specific to any one
   * image.
   *
   * @return PropertyMap of data related to the entire dataset, or null if none exists.
   */
   ...
   * @param newData Updated PropertyMap of data to be stored in the Annotation that pertains to the
   *     image
   */
  void setImageAnnotation(Coords coords, PropertyMap newData);

  /**
   * Replace the data this Annotation has for the Datastore as a whole with the provided
   * PropertyMap.
   *
   * @param newData Updated PropertyMap of data to be stored in the Annotation that is not specific
   *     to any one Image.
   */
