 ...
 * and metadata.
 *
 * <p>Image objects are immutable (cannot be modified once created). This makes it
 ...
 *
 * <p>In order to "modify" an Image, you will need to create a "copy", but
...
public interface Image {
    ...
    *
    * <p>This method is intended for getting a single pixel value (e.g. to see the
    * value at the mouse cursor).
    *
    * <p>Equivalent to calling {@code getComponentIntensityAt(x, y, 0)}. Use this
    ...
    * @throws IndexOutOfBoundsException when the pixel location does not exist.
    * @see #getComponentIntensityAt
    */
    ...
    *
    * <p>The constants are defined in {@link ij.ImagePlus}: {@code GRAY8},
    * {@code GRAY16}, {@code COLOR_RGB}.</p>
    *
    ...
    * location.
    *
    * <p>The string will be a plain number for single-component images, and an
    ...
    *
    * <p>Note that this does not necessarily match 8 times the bit depth of the
    * image, since images may have lower bit depth than the samples used.
    *
    * <p>For multi-component images, the bytes per pixel may be greater than the
    ...
    *
    * <p>The returned value may or may not be a copy of the internal pixel data.</p>
    *
    * <p><strong>Warning</strong>: Do not depend on the type of the object
    * returned. It may change in the future. Also, <strong>never modify the
    * returned object!</strong></p>
    *
    ...
    *
    * <p>Use if you need to modify the pixel data.</p>
    *
    * <p><strong>Warning</strong>: Do not depend on the type of the object
    ...
    *
    * <p>As {@code getRawPixelsCopy}, but will split out the specified component
