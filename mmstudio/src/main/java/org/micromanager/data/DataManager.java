...
public interface DataManager {
    ...
    *
    * <p>Please note that the multipage TIFF storage system currently only
    ...
    *
    * <p>Please note that the single-plane TIFF series storage system currently
    ...
    *
    * <p>PixelData of the tagged image may be used directly (i.e. without copying),
    ...
    * application pipeline interface. If `includeDisabled` is false this only
    * returns those configurators that are currently enabled.
    *
    * @param includeDisabled determines whether or not to include configurators that
   ...
   /**
    * Return a list of the ProcessorConfigurators currently being used by the
    * live pipeline interface. If `includeDisabled` is false this only returns
    * those configurators that are currently enabled.
    *
    * @param includeDisabled determines whether or not to include configurators that
    *                        are not currently enabled.
    * @return An ordered list of ProcessorConfigurators.
