...
/**
 * Interface to execute commands in the main panel. Implemented by MMStudio and available as the
 * "mm" object in the Beanshell scripting panel.
 */
public interface Studio {
  /**
   * Provides access to and control of the contents of the Album, the implicit, temporary image
   * storage datastore.
   *
  ...
  /**
   * Provides access to and control of the contents of the Album, the implicit, temporary image
   * storage datastore. Identical to album() except in name.
   *
   * @return An implementation of the Album API.
   */
  Album getAlbum();
  ...
  /**
   * Provides access to the compatibility layer that exposes some old 1.4 API methods. Identical to
   * compat() in all but name.
   *
   * @return An implementation of the compatibility API.
   */
  ...
  /**
   * Provides access to Micro-Manager's logging functions, like logError(), showMessage(), etc.
   * Identical to logs() except in name.
   *
   * @return Access to Micro-Manager's logging interface.
   */
  ...
  /**
   * Provide access to the AcquisitionManager, for running data acquisition using the Micro-Manager
   * acquisition engine.
   *
  ...
  /**
   * Provide access to the AcquisitionManager, for running data acquisition using the Micro-Manager
   * acquisition engine. Identical to acquisitions() except in name.
   *
   * @return AcquisitionManager
   */
  ...
  /**
   * Provide access to the AlertManager, for creating low-profile, non- interrupting alerts in the
   * user interface.
   *
   * @return AlertManager
   */
  ...
  /**
   * Provide access to the AlertManager, for creating low-profile, non- interrupting alerts in the
   * user interface. Identical to alerts() except in name.
   *
   * @return AlertManager
   */
  ...
  /**
   * Provides access to the Core and its functionality. Identical to core() except in name.
   *
   * @return Micro-Manager core object.
   */
  CMMCore getCMMCore();
  ...
  /**
   * Provide access to the DataManager instance for accessing Micro-Manager data constructs.
   * Identical to data() except in name.
   *
   * @return DataManager instance
   */
  ...
  /**
   * Provides access to the DisplayManager instance for accessing Micro-Manager display constructs.
   * Identical to displays() except in name.
   *
   * @return DisplayManager instance
   */
  ...
  /**
   * Provides access to the EventManager instance for subscribing to and posting events on the
  ...
  /**
   * Provides access to the EventManager instance for subscribing to and posting events on the
   * application-wide EventBus. Identical to events() except in name.
   *
   * @return EventManager instance
   */
  ...
  /**
   * Provides access to some utility methods for use in the Beanshell scripting panel. Identical to
   * scripter() except in name.
   *
   * @return ScriptController instance.
   */
  ...
  /**
   * Provides access to the Snap/Live display and associated logic. Identical to live() except in
   * name.
   *
   * @return SnapLiveManager instance.
   */
  ...
  /**
   * Provides access to the UserProfile instance for accessing per-user profiles. Identical to
   * profile() except in name.
   *
   * @return UserProfile instance
   */
  ...
  /**
   * Provides access to the PluginManager for accessing plugin instances. Identical to plugins()
   * except in name.
   *
   * @return PluginManager instance.
   */
  ...
  /**
   * Provides access to the PositionListManager for interacting with the Stage Position List.
   * Identical to positions() except in name.
   *
   * @return PositionListManager instance.
   */
  ...
  /**
   * Provides access to the QuickAccessManager for accessing the Quick-Access Panel system.
   * Identical to quickAccess() except in name.
   *
   * @return QuickAccessManager instance.
   */
  ...
  /**
   * Provides access to the ShutterManager for controlling the shutter state. Identical to shutter()
   * except in name.
   *
   * @return ShutterManager instance.
   */
  ...
  /**
   * Provides access to the application API for controlling and updating the GUI. Identical to app()
   * except in name.
   *
   * @return Application instance.
   */
  ...
  /**
   * Provides access to the PropertyManagerAPI. Provides access to the PropertyMap.Builder
   *
