 ...
 *
 * <p>TODO This should have two superinterfaces, one shared with PropertyMap and another shared with
 * PropertyMap.Builder.
 *
...
public interface MutablePropertyMapView {
   ...
   *
   * <p>The returned view is updated when this MutablePropertyMapView changes. Removing keys from
   * the returned set view will remove those keys from the MutablePropertyMapView. Adding keys is
   * not supported.
   *
   ...
   *
   * <p>Intended for use by special library/framework code. See the analogous {@link
   * PropertyMap#getValueTypeForKey} for details.
   *
   * @param key a property key
   * @return the class representing the type of the value stored for {@code key}
