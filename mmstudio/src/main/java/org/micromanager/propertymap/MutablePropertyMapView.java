 ...
 *
 * TODO This should have two superinterfaces, one shared with PropertyMap and
 * another shared with PropertyMap.Builder.
 *
...
public interface MutablePropertyMapView {
    ...
    * <p>
    * Intended for use by special library/framework code.
    * See the analogous
   ...
   <E extends Enum<E>> MutablePropertyMapView putEnumListAsStringList(String key, Iterable<E> values);
}