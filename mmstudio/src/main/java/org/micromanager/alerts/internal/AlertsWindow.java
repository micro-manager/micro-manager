...
public final class AlertsWindow extends JFrame {
  ...
  public AlertsWindow(Studio studio) {
    ...
    shouldShowOnMessage_ =
        studio_.profile().getSettings(AlertsWindow.class).getBoolean(SHOULD_SHOW_WINDOW, true);
    final JCheckBox showWindowCheckBox =
        new JCheckBox("Open this window when messages arrive", shouldShowOnMessage_);
    ...
    showWindowCheckBox.addActionListener(
        new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            studio_
                .profile()
                .getSettings(AlertsWindow.class)
                .putBoolean(SHOULD_SHOW_WINDOW, shouldShowOnMessage_);
          }
        });
