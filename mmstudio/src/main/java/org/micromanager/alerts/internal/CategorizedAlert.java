...
public final class CategorizedAlert extends DefaultAlert {
   ...
   private class CategoryDisplay extends JPanel {
      ...
      /**
       * Set the current text display, pushing any old text display into the
       * history.
       */
   ...
   /**
    * Add a new label to our contents. Create a new DisplayCategory if
    * necessary, otherwise move the existing one to the bottom of the list.
    */
