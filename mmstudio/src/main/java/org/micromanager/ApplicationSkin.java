 ...
 * the majority of situations, you should not need to worry about what skin the GUI is using; it is
 * set by the user and automatically applies to most GUI elements without any special effort on your
 * part. This module allows you to change the skin programmatically, and provides manual access to
 * certain color information for when you have a GUI element that does not automatically respect the
 * current skin. This interface can be accessed via the Application by calling Application.getSkin()
 * or Application.skin().
 */
public interface ApplicationSkin {
  ...
  enum SkinMode {
     ...
     * @return the skinmode associated with the given string (if any) throws
     *     IllegalArgumentException when no matching mode is found
     */
  ...
  /**
   * Sets the background color of the GUI to the selected mode. This will provoke a refresh of the
   * GUI and post a ApplicationSkinEvent to the application-wide event bus.
   *
  ...
  /**
   * Return the current "lighter" background color for highlighted or otherwise differentiated GUI
   * elements.
   *
