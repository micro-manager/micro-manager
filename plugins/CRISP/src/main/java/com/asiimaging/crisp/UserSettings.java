 ...
 *
 * <p>If you need access to everything MutablePropertyMapView can do, use the
...
public class UserSettings {
   ...
   public void load() {
      ...
      final boolean isPollChecked =
            settings.getBoolean(Settings.POLL_CHECKED, Defaults.POLL_CHECKED);
      ...
      if (!json.equals(CRISPSettings.SETTINGS_NOT_FOUND)) {
         final Type listType = new TypeToken<List<CRISPSettings>>() {
         }.getType();
