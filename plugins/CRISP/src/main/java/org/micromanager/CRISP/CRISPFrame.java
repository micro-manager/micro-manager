...
public class CRISPFrame extends JFrame {
  ...
  /**
   * Creates new form CRISPFrame TODO: Add an explanation whenever the D or N state occurs, suggest
   * to increase gain and LED intensity TODO: write help pages that describe use of the CRISP and
   * this plugin
   *
  ...
  /**
   * This method is called from within the constructor to initialize the form. History: This
   * function was first created by the Netbeans GUI creator, then modified to use MigLayout as
   * Layout manager
   */
  ...
  private void initComponents() {
    ...
    curveButton_.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    naSpinner_.setModel(
        new javax.swing.SpinnerNumberModel(
            Float.valueOf(0.65f), Float.valueOf(0.0f), Float.valueOf(1.4f), Float.valueOf(0.05f)));
    ...
    maxLockRangeSpinner_.addChangeListener(
        new javax.swing.event.ChangeListener() {
          @Override
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    resetOffsetButton_.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    pollCheckBox_.addChangeListener(
        new ChangeListener() {
          @Override
  ...
  private void LockButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_LockButton_ActionPerformed
  ...
  private void CalibrateButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_CalibrateButton_ActionPerformed
    try {
      ...
      if (snr < 2.0)
        gui_.logs()
            .showMessage(
                "Signal Noise Ratio is smaller than 2.0.  "
  ...
  private void CurveButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_CurveButton_ActionPerformed
    try {
      core_.enableContinuousFocus(false);
