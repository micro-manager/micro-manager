...
public class Utils {
  ...
  /**
   * Filenames are expected to be formatted as" TIRF-B2-Site_0-7 Where the last number is the
   ...
   */
  public static void extractFileNameInfo(
      String input, String root, String well, Integer site, Integer sequence)
      throws MalFormedFileNameException {
