...
/**
 * Provides access to interpretation of a (bleached) particle track Calculates the average size of a
 * particle, fits recovery of the bleach spot, as well as of the particle itself
 *
 * @author nico
 */
