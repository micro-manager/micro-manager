...
/**
 * Data structure that holds the interpretation of a (bleached) particle track. DataCalculates the
 * average size of a particle, fits recovery of the bleach spot, as well as of the particle itself
 *
...
public class TrackInfo {
  ...
  public static TrackInfo calculateTrackInfo(
      PASData pasData, Map<Integer, Double> controlAvgIntensity) {
