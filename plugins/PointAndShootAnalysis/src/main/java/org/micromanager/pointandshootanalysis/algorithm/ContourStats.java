...
public class ContourStats {
  ...
  /**
   * Test whether a given point is in the source list Has to be used instead of
   * source.contains(Point2D_I32) since one object Point2D_I32 with the same values as another
   * Point2D_I32 is not the same object
   *
