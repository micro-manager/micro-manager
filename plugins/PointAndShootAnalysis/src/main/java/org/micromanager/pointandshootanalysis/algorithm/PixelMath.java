...
/**
 * Collection of functions that could be part of boofcv.alg.misc.PixelMath but aren't
 *
 * @author Nico
 */
public class PixelMath {

  public static <T extends ImageGray<T>> void checkInput(
      Planar<T> input, int startBand, int lastBand) {
   ...
   * @param lastBand Last band to be included in the projection
   */
  public static void minimumBand(
      Planar<GrayU16> input, GrayU16 output, int startBand, int lastBand) {
    checkInput(input, startBand, lastBand);
    final int h = input.getHeight();
    final int w = input.getWidth();
   ...
   */
  public static void minimumBand(
      Planar<GrayS16> input, GrayS16 output, int startBand, int lastBand) {
    checkInput(input, startBand, lastBand);
    final int h = input.getHeight();
    final int w = input.getWidth();
   ...
   */
  public static void minimumBand(
      Planar<GrayS32> input, GrayS32 output, int startBand, int lastBand) {
    checkInput(input, startBand, lastBand);
    final int h = input.getHeight();
    final int w = input.getWidth();
   ...
   */
  public static void minimumBand(
      Planar<GrayS64> input, GrayS64 output, int startBand, int lastBand) {
    checkInput(input, startBand, lastBand);
    final int h = input.getHeight();
    final int w = input.getWidth();
   ...
   */
  public static void minimumBand(
      Planar<GrayF32> input, GrayF32 output, int startBand, int lastBand) {
    checkInput(input, startBand, lastBand);
    final int h = input.getHeight();
    final int w = input.getWidth();
   ...
   */
  public static void minimumBand(
      Planar<GrayF64> input, GrayF64 output, int startBand, int lastBand) {
    checkInput(input, startBand, lastBand);
    final int h = input.getHeight();
    final int w = input.getWidth();
   ...
   * @param lastBand Last band to be included in the projection
   */
  public static void maximumBand(
      Planar<GrayU16> input, GrayU16 output, int startBand, int lastBand) {
    checkInput(input, startBand, lastBand);
    final int h = input.getHeight();
    final int w = input.getWidth();
   ...
   * @param lastBand Last band to be included in the projection
   */
  public static void averageBand(
      Planar<GrayU16> input, GrayU16 output, int startBand, int lastBand) {
    checkInput(input, startBand, lastBand);
    final int h = input.getHeight();
    final int w = input.getWidth();
   ...
   */
  public static void stdDevBand(
      Planar<GrayS8> input, GrayS8 output, GrayS8 avg, int startBand, int lastBand) {
    checkInput(input, startBand, lastBand);
    final int h = input.getHeight();
    final int w = input.getWidth();
    ...
    for (int y = 0; y < h; y++) {
      ...
      for (; indexInput < indexEnd; indexInput++, indexOutput++) {
        ...
        if (valueArray.length % 2 == 0) {
          output.data[indexOutput] =
              (byte)
                  ((valueArray[valueArray.length / 2]
                          & 0xFF + valueArray[valueArray.length / 2 - 1]
                          & 0xFF)
                      / 2);
        } else {
    ...
    for (int y = 0; y < h; y++) {
      ...
      for (; indexInput < indexEnd; indexInput++, indexOutput++) {
        ...
        if (valueArray.length % 2 == 0) {
          output.data[indexOutput] =
              (byte)
                  ((valueArray[valueArray.length / 2] + valueArray[valueArray.length / 2 - 1]) / 2);
        } else {
          output.data[indexOutput] = valueArray[valueArray.length / 2];
        }
      }
      ...
      for (; indexInput < indexEnd; indexInput++, indexOutput++) {
        ...
        if (valueArray.length % 2 == 0) {
          output.data[indexOutput] =
              (byte)
                  ((valueArray[valueArray.length / 2]
                          & 0xFFFF + valueArray[valueArray.length / 2 - 1]
                          & 0xFFFF)
                      / 2);
        } else {
          output.data[indexOutput] = valueArray[valueArray.length / 2];
