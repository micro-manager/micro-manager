 ...
 * ExampleFrame.java
 *
 * <p>This module shows an example of creating a GUI (Graphical User Interface). There are many ways
 * to do this in Java; this particular example uses the MigLayout layout manager, which has
...
public class ExampleFrame extends JFrame {
  ...
  public ExampleFrame(Studio studio) {
    ...
    alertButton.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            // Use the contents of userText_ as the text.
            studio_.alerts().postAlert("Example Alert!", ExampleFrame.class, userText_.getText());
          }
        });
  ...
  /**
   * To be invoked, this method must be public and take a single parameter which is the type of the
   * event we care about.
   *
   * @param event
   */
