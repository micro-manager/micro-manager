...
/**
 * JPanel that handles a specific pressure pump. Consisting of a double-slider,
 * formattedTextbox for numeric pressure input and a textfield displaying the actual
 * pressure.
 */
public class PressureControlSubPanel extends JPanel {
   private final int panelHeight = 430;
   private final int panelWidth = 150;
   private final int nSteps = 10000;
   ...
   private void initialize() {
      ...
      controlSlider = new DoubleJSlider(minValue, maxValue, 0, nSteps);
      ...
      controlSlider.setPreferredSize(new Dimension(panelWidth - 10, 300));
   ...
   /**
    * Updates the displayed measured pressure.
    */
   ...
   /**
    * Sets the pressure of the pressure pump.
    *
    * @param value   Pressure to be set in kPa
    */
