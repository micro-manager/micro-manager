...
public class SelectionPanel extends JPanel {
   ...
   private final ArrayList<String> pressurePumps;
   private final ArrayList<String> pressurePumpsSelected;
   private final JCheckBox[] pressurePumpToggles;
   private final JLabel[] pressurePumpDescriptions;

   private final ArrayList<String> volumePumps;
   private final ArrayList<String> volumePumpsSelected;
