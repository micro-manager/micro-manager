...
public class MultiStateUIPropertyTest {
  ...
  public void testNumberNoState() {
    ...
    MultiStateUIPropertyTestPanel cp =
        new MultiStateUIPropertyTestPanel("MyPanel") {
  ...
  public void testSettingTooManyStateValueNames()
    ...
    final String[] names = {
      "MyVal1", "MyVal2", "GrateValue", "NotAGoddValue", "What about this one?", "Idk"
    };
    boolean b = cp.property.setStateNames(names);
    assertTrue(b);

    String[] names_b = cp.property.getStatesName();
    for (int i = 0; i < cp.property.getNumberOfStates(); i++) assertEquals(names[i], names_b[i]);
  }
  ...
  public void testSettingTooFewStateValueNames()
    ...
    String[] names_b = cp.property.getStatesName();
    for (int i = 0; i < names.length; i++) assertEquals(names[i], names_b[i]);
  ...
  public void testSettingStateValues()
    ...
    for (int i = 0; i < vals.length; i++) assertEquals(vals[i], states_b[i]);
  }
  ...
  @Test
  public void testStateValuesAndNamesIntegerMMProp()
      throws AlreadyAssignedUIPropertyException, IncompatibleMMProperty {
    MultiStateUIPropertyTestPanel cp = new MultiStateUIPropertyTestPanel("MyPanel");
  ...
  @Test
  public void testStateValuesAndNamesFloatMMProp()
      throws AlreadyAssignedUIPropertyException, IncompatibleMMProperty {
    MultiStateUIPropertyTestPanel cp = new MultiStateUIPropertyTestPanel("MyPanel");
  ...
  public void testStatePositions()
    ...
    for (int i = 0; i < vals.length; i++) assertEquals(i, cp.property.getStateIndex(vals[i]));
  }
  ...
  @Test
  public void testSetValuesPriorityWithAmbiguity()
      throws AlreadyAssignedUIPropertyException, IncompatibleMMProperty {
    MultiStateUIPropertyTestPanel cp = new MultiStateUIPropertyTestPanel("MyPanel");
  ...
  @Test
  public void testSetValuesByStatePriorityWithAmbiguity()
      throws AlreadyAssignedUIPropertyException, IncompatibleMMProperty {
    MultiStateUIPropertyTestPanel cp = new MultiStateUIPropertyTestPanel("MyPanel");
