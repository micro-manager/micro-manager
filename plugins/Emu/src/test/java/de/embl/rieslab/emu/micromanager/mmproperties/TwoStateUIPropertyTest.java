...
public class TwoStateUIPropertyTest {
  ...
  public void testSettingWrongOnOffValues()
    ...
    boolean b =
        cp.property.setOffStateValue(offval); // IntegerMMProperty round up doubles to an int
    assertTrue(b);
    assertEquals(offval, cp.property.getOffStateValue());
  ...
  @Test
  public void testIsOnOffValueIntegerMMProperty()
      throws AlreadyAssignedUIPropertyException, IncompatibleMMProperty {
    TwoStateUIPropertyTestPanel cp = new TwoStateUIPropertyTestPanel("MyPanel");
  ...
  @Test
  public void testIsOnOffValueFloatMMProperty()
      throws AlreadyAssignedUIPropertyException, IncompatibleMMProperty {
    TwoStateUIPropertyTestPanel cp = new TwoStateUIPropertyTestPanel("MyPanel");
