...
public class SwingUIListenersTest {
  ...
  public void testJComboboxActionListenerOnString()
    ...
    final ComponentTestPanel cp =
        new ComponentTestPanel("My panel") {
  ...
  public void testJComboboxActionListenerOnIndexWithArray()
      throws AlreadyAssignedUIPropertyException, IncompatibleMMProperty {
    final String prop = "My Prop";
    final String[] combovals = {
      "MyValue1", "MyValue2", "MyValue3"
    }; // values shown to the user (maybe set by a UIParameter)
    final String[] vals = {
      "CoolName1", "CoolName2", "CoolName3"
    }; // friendly names used to trigger the UIProperty
        ...
        new ComponentTestPanel("My panel") {
          ...
          protected void addComponentListeners() {
            SwingUIListeners.addActionListenerToDoubleAction(
                d -> myDoubleValue = d, textfield, min, max);
          }
        };
    final TestableConfigurableMainFrame cmf =
        new TestableConfigurableMainFrame() { // need a ConfigurableMainFrame to call functions in
        ...
        new ComponentTestPanel("My panel") {
          ...
          protected void addComponentListeners() {
            SwingUIListeners.addActionListenerOnIntegerValue(
                this, prop, slider, label, prefix, suffix);
          }
        };
    final TestableConfigurableMainFrame cmf =
        new TestableConfigurableMainFrame() { // need a ConfigurableMainFrame to call functions in
