...
public class ConfigurableMainFrameTest {
  ...
  @Test
  public void testCollectionConfigurablePanels()
      throws UnknownUIParameterException, IncorrectInternalPropertyTypeException,
    ...
    ConfigurableTestFrame cf =
        new ConfigurableTestFrame("MyFrame") {
  ...
  public void testCollectionUIProperties() {
    ...
    final ConfigurableTestPanel cp1 =
        new ConfigurableTestPanel(panels[0]) {
    ...
    final ConfigurableTestPanel cp2 =
        new ConfigurableTestPanel(panels[1]) {
    ...
    final ConfigurableTestPanel cp3 =
        new ConfigurableTestPanel(panels[2]) {
  ...
  public void testCollectionUIParameters() throws UnknownUIParameterException {
    ...
    int nparams =
        params1.length + params2.length + params3.length - 1; // since two UIParameter collide
    ...
    for (ConfigurablePanel cp : panelist) {
      if (cp.getPanelLabel().equals(panels[1])) { // they have the same label anyway
        assertEquals(
            newval,
            cp.getUIParameter(params2[1])
                .getStringValue()); // prop is known with same label as well
      }
    }
  }

  @Test
  public void testCollectionInternalProperties()
  ...
  public void testUpdateAll()
      throws UnknownUIParameterException, IncorrectInternalPropertyTypeException,
          UnknownInternalPropertyException, AlreadyAssignedUIPropertyException,
          UnknownUIPropertyException, IncompatibleMMProperty {
  ...
  public void testPluginSettings() {
    ...
    ConfigurableTestFrame cf =
        new ConfigurableTestFrame("MyFrame", settings) {
          ...
          protected void initComponents() {
            reporter1.set(
                ((IntSetting) this.getCurrentPluginSettings().get(PLUGIN_SETTING)).getValue());
          }
  ...
  public void testNullPluginSettings() {
    ConfigurableTestFrame cf =
        new ConfigurableTestFrame("MyFrame", null) {
