...
public class ConfigurableMainFrameTest {
   ...
   public void testCollectionUIParameters() throws UnknownUIParameterException {
      ...
      // since panels[1] and panels[2] have the same name, then params2[1] and params3[0]
      // will collide
      ...
      // check that all ConfigurableFrame are found
      final ArrayList<ConfigurablePanel> panelist = cf.getConfigurablePanels();
      ...
      for (ConfigurablePanel cp : panelist) {
         if (cp.getPanelLabel().equals(panels[1])) { // they have the same label anyway
            assertEquals(newval, cp.getUIParameter(params2[1])
   ...
   public void testUpdateAll()
      ...
      final ConfigurableTestFrame cf = new ConfigurableTestFrame("MyFrame") {
