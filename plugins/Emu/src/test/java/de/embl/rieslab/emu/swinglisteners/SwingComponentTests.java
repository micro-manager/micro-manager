...
/**
 * These are just a bunch of tests to remember whether changing the state of a Swing JComponent
 * fires the action listeners used in SwingUIListeners. This is important to know in the UIPlugin in
 * order to avoid repeated calls to the MMProperty from
 * ConfigurablePanel.propertyHashChanged(String, String).
 *
