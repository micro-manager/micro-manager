...
public class UIPropertyTest {
  ...
  @Test
  public void testUIPropertyPairing()
  ...
  public void testUIPropertyReadOnly()
    ...
    final IntegerMMProperty mmprop =
        new IntegerMMProperty(null, new Logger(), "", "", true) {
          @Override
    ...
    final IntegerMMProperty mmprop =
        new IntegerMMProperty(null, new Logger(), "", "", false) {
          ...
          public boolean setValue(
              String stringval, UIProperty source) { // bypassing communication with MM core
  ...
  public void testUIPropertyAllowedValues()
    ...
    final IntegerMMProperty mmprop =
        new IntegerMMProperty(null, new Logger(), "", "", str) {
          @Override
          public Integer getValue() { // avoids NullPointerException
            return 0;
          }
  ...
  public void testUIPropertyAlreadyAssigned()
      throws AlreadyAssignedUIPropertyException, IncompatibleMMProperty {
    UIPropertyTestPanel cp = new UIPropertyTestPanel("MyPanel");
