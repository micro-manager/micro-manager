...
public class RescaledUIPropertyTest {
   ...
   public void testIntegerMMProp()
      ...
      final IntegerMMProperty mmprop1 =
            new IntegerMMProperty(null, new Logger(), "", "", max1, min1) {
               @Override
      ...
      final IntegerMMProperty mmprop2 =
            new IntegerMMProperty(null, new Logger(), "", "", max2, min2) {
               @Override
               public boolean setValue(String stringval, UIProperty source) {
      ...
      double slope1 = -4;
      final double slope2 = max2 / 100.;
      final double offset1 = 2;
      final double offset2 = 0;
   ...
   @Test
   public void testIntegerMMPropWithoutLimits()
         throws AlreadyAssignedUIPropertyException, IncompatibleMMProperty {
      RescaledUIPropertyTestPanel cp = new RescaledUIPropertyTestPanel("MyPanel");
      ...
      final int maxval1 = (int) (100 * slope1 + offset1);
      assertTrue(cp.property1.setPropertyValue(String.valueOf(0)));
   ...
   @Test
   public void testFloatMMPropWithoutLimits()
         throws AlreadyAssignedUIPropertyException, IncompatibleMMProperty {
      RescaledUIPropertyTestPanel cp = new RescaledUIPropertyTestPanel("MyPanel");
      ...
      final float maxval1 = (float) (100. * slope1 + offset1);
      assertTrue(cp.property1.setPropertyValue(String.valueOf(0.)));
   ...
   @Test
   public void testNotifyIntegerMMProp()
         throws AlreadyAssignedUIPropertyException, IncompatibleMMProperty, InterruptedException {
      RescaledUIPropertyTestPanel cp = new RescaledUIPropertyTestPanel("MyPanel");
   ...
   @Test
   public void testFloatIntegerMMProp()
         throws AlreadyAssignedUIPropertyException, IncompatibleMMProperty, InterruptedException {
      RescaledUIPropertyTestPanel cp = new RescaledUIPropertyTestPanel("MyPanel");
   ...
   public void testWrongValues() throws AlreadyAssignedUIPropertyException, IncompatibleMMProperty {
      ...
      final IntegerMMProperty mmprop1 =
            new IntegerMMProperty(null, new Logger(), "", "", max, min) {
               @Override
               public Integer getValue() { // avoids NullPointerException
                  return reporter1.get();
               }
   ...
   private class RescaledUIPropertyTestPanel extends ConfigurablePanel {
      ...
      public RescaledUIProperty property1;
      public RescaledUIProperty property2;
