...
public class RescaledUIPropertyTest {
  ...
  public void testIntegerMMPropWithoutLimits()
    ...
    final IntegerMMProperty mmprop1 =
        new IntegerMMProperty(null, new Logger(), "", "", false) {
          @Override
          public boolean setValue(String stringval, UIProperty source) {
            reporter1.set(Integer.valueOf(stringval));
            return true;
  ...
  public void testFloatMMProp() throws AlreadyAssignedUIPropertyException, IncompatibleMMProperty {
    ...
    final FloatMMProperty mmprop1 =
        new FloatMMProperty(null, new Logger(), "", "", max1, min1) {
          public Float val;
    ...
    final FloatMMProperty mmprop2 =
        new FloatMMProperty(null, new Logger(), "", "", max2, min2) {
          public Float val;
  ...
  public void testNotifyIntegerMMProp()
    ...
    final int min = -14;
    final int max = 46;
    final IntegerMMProperty mmprop =
