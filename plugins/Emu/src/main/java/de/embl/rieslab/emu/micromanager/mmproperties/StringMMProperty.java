...
/**
 * Wrapper for a Micro-manager device property with String value. The property can be read-only or
 * not or with a set of allowed values.
 *
...
public class StringMMProperty extends MMProperty<String> {
   ...
   */
  StringMMProperty(
      CMMCore core, Logger logger, MMPropertyType type, String deviceLabel, String propertyLabel) {
