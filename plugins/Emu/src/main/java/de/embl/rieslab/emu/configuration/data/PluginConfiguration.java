...
/**
 * Class representing a plugin configuration. It holds the name of an EMU plugin and maps of the
 * plugin propertie, parameter and setting names and values. The Class is written and read using
 * jackson ObjectMapper by the ConfigurationIO class.
 *
...
public class PluginConfiguration implements Comparable<PluginConfiguration> {
  ...
  public int compareTo(PluginConfiguration OtherUIPlugin) {
    // TODO should also check if they are related to the same plugin otherwise we might have
    // inconsistencies
