...
public class IntegerMMProperty extends MMProperty<Integer> {
    ...
    */
   IntegerMMProperty(CMMCore core, Logger logger, String deviceLabel, String propertyLabel,
                     boolean readOnly) {
   ...
   IntegerMMProperty(CMMCore core, Logger logger, String deviceLabel, String propertyLabel,
      ...
      super(core, logger, MMProperty.MMPropertyType.INTEGER, deviceLabel, propertyLabel, upLimit,
            downLimit);
   }
   ...
   IntegerMMProperty(CMMCore core, Logger logger, String deviceLabel, String propertyLabel,
      ...
      super(core, logger, MMProperty.MMPropertyType.INTEGER, deviceLabel, propertyLabel,
            allowedValues);
   }
