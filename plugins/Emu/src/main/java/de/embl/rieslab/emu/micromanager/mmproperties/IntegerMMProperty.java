...
/**
 * Wrapper for a Micro-manager device property with integer value. The property can be read-only or
...
public class IntegerMMProperty extends MMProperty<Integer> {
  ...
  IntegerMMProperty(
    ...
    super(
        core,
        logger,
        MMProperty.MMPropertyType.INTEGER,
        deviceLabel,
        propertyLabel,
        upLimit,
        downLimit);
  ...
  IntegerMMProperty(
    ...
    super(
        core, logger, MMProperty.MMPropertyType.INTEGER, deviceLabel, propertyLabel, allowedValues);
  }
