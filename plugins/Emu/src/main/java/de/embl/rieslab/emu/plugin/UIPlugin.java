...
/**
 * Interface for an EMU plugin. The plugin main class should implement this interface and the jar
 * should contain META-INF/services/embl.rieslab.emu.plugin.EMUPlugin file containing the package
 * location of the plugin (example: "myui.myplugin").
 *
...
public interface UIPlugin {
  ...
  /**
   * Returns a PropertyMainFrame. If {@code pluginSettings} is empty, then the default settings are
   * used.
   *
