...
public class FloatMMProperty extends MMProperty<Float> {
    ...
    */
   FloatMMProperty(CMMCore core, Logger logger, String deviceLabel, String propertyLabel,
                   boolean readOnly) {
   ...
   FloatMMProperty(CMMCore core, Logger logger, String deviceLabel, String propertyLabel,
      ...
      super(core, logger, MMProperty.MMPropertyType.FLOAT, deviceLabel, propertyLabel, upLimit,
            downLimit);
   }
   ...
   FloatMMProperty(CMMCore core, Logger logger, String deviceLabel, String propertyLabel,
      ...
      super(core, logger, MMProperty.MMPropertyType.FLOAT, deviceLabel, propertyLabel,
            allowedValues);
   }
