...
public class LaserPanel extends ConfigurablePanel {
   ...
   protected void addComponentListeners() {
      ...
      SwingUIListeners.addActionListenerOnIntegerValue(this, getUIPropertyLabel(LASER_PERCENTAGE),
            slider, label, "", "%");
       ...
       */
      try {
         SwingUIListeners.addActionListenerToTwoState(this, getUIPropertyLabel(LASER_OPERATION),
               powerToggleButton);
   ...
   protected void propertyhasChanged(String propertyName, String newvalue) {
      ...
      if (getUIPropertyLabel(LASER_PERCENTAGE).equals(
      ...
      } else if (getUIPropertyLabel(LASER_OPERATION).equals(
         ...
         try {
            ...
            String onValue = ((TwoStateUIProperty) getUIProperty(
                  getUIPropertyLabel(LASER_OPERATION))).getOnStateValue();
   ...
   public String getDescription() {
       ...
       */
      return
            "Laser panels control each a single laser and allow for rapid on/off and power percentage changes. "
                  +
