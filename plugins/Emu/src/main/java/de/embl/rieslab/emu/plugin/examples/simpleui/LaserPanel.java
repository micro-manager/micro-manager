...
public class LaserPanel extends ConfigurablePanel {
   ...
   //////// Properties
   public final String laserPercentage = "power percentage";
   public final String laserOperation = "on/off";
   //////// Parameters
   public final String paramTitle = "Name";
   public final String paramColor = "Color";
   public final String paramUseonoff = "Enable power button";
   ...
   protected void initializeProperties() {
      ...
      String text1 =
            "Property changing the percentage of the laser. Set the slope to max/100 and the "
                  + "offset to 0, where max is the maximum value of the property, for instance if "
                  + "the property is 0-200 mW, then the slope is 2. If the device property is "
                  + "already a percentage, then leave the slope and offset as they are.";
       ...
       */
      addUIProperty(new RescaledUIProperty(this, getUIPropertyLabel(laserPercentage), text1));

      /*
       * A TwoStateUIProperty is appropriate for a on/off property as it takes only two states.
       */
      addUIProperty(new TwoStateUIProperty(this, getUIPropertyLabel(laserOperation), text2));
   }
   ...
   protected void initializeParameters() {
       ...
       */
      addUIParameter(new StringUIParameter(this, paramTitle, "Panel title.", getPanelLabel()));

      // We declare a ColorUIParameter for the title color (with default being black)
      addUIParameter(new ColorUIParameter(this, paramColor, "Panel title color.", Color.black));

      // We declare a BoolUIParameter to enable/disable the on/off button
      addUIParameter(
            new BoolUIParameter(this, paramUseonoff, "Enable power (on/off) button.", true));
   }
   ...
   protected void addComponentListeners() {
      ...
      SwingUIListeners.addActionListenerOnIntegerValue(this, getUIPropertyLabel(laserPercentage),
            slider, label, "", "%");
       ...
       */
      try {
         SwingUIListeners.addActionListenerToTwoState(this, getUIPropertyLabel(laserOperation),
               powerToggleButton);
   ...
   protected void propertyhasChanged(String propertyName, String newvalue) {
      ...
      if (getUIPropertyLabel(laserPercentage).equals(
            propertyName)) { // if the change concerns the laser percentage
      ...
      } else if (getUIPropertyLabel(laserOperation).equals(
            propertyName)) { // if the change pertains to the laser on/off
         ...
         try {
            ...
            String onValue = ((TwoStateUIProperty) getUIProperty(
                  getUIPropertyLabel(laserOperation))).getOnStateValue();
   ...
   protected void parameterhasChanged(String parameterName) {
      ...
      if (paramTitle.equals(parameterName)) {
         try {
      ...
      } else if (paramColor.equals(parameterName)) {
         try {
            // retrieves the color at a Color type
            Color color = getColorUIParameterValue(paramColor);
      ...
      if (paramUseonoff.equals(parameterName)) {
         try {
