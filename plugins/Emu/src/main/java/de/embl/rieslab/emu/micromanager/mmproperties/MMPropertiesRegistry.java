...
public class MMPropertiesRegistry {
  ...
  /**
   * Constructor. Calls a private initialization method to extract the devices and their properties.
   * It ignores "COM" devices.
   *
  ...
  /**
   * Returns the property with hash {@code propertyHash} (see {@link MMProperty} for the definition
   * of the hash).
   *
  ...
  /**
   * Clears all Micro-manager device property listeners (which are of the class UIProperty). Called
   * during reloading of the system by the {@link de.embl.rieslab.emu.controller.SystemController}.
   */
