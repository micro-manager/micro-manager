...
/**
 * UIParameter corresponding to a UIProperty of the UIPlugin. This is useful when other
 * ConfigurablePanels need to access a UIProperty. Since at compilation time it is not known which
 * UIProperty will be used to map the MMProperty of interest, then the user can set it in the
 * configuration wizard. This is an alternative to creating several identical UIProperties from
 * different ConfigurablePanels. In particular when the UIProperty is to be used in a SwingWorker or
 * a another Thread without explicit interactions between the ConfigurablePanel's JComponents and
 * the UIProperty.
 *
 * <p>A PropertyFlag can be given to select the relevant UIProperties from the list of possible
 * values in the configuration wizard.
 *
...
public class UIPropertyParameter extends UIParameter<String> {
   ...
   */
  public UIPropertyParameter(
      ConfigurablePanel owner, String name, String description, PropertyFlag propertyflag) {
