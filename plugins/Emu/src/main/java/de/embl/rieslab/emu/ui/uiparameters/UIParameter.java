...
/**
 * UIParameters are used to let the user specify aspects of the ConfigurablePanels through the
...
public abstract class UIParameter<T> {
  ...
  /**
   * Returns the type of the UIParameter. This method is used to check the compatibility of
   * UIParameters.
   *
