...
public class SystemDialogs {
  ...
  /**
   * This dialog pops up when the {@link de.embl.rieslab.emu.controller.SystemController} does not
   * know which {@link de.embl.rieslab.emu.configuration.data.PluginConfiguration} to instantiate.
   * It lets the user decide from an array of known configuration names.
   *
  ...
  /**
   * Dialog displayed when the {@link de.embl.rieslab.emu.controller.SystemController} does not find
   * any {@link de.embl.rieslab.emu.plugin.UIPlugin}.
   */
  ...
  /**
   * Used by the {@link de.embl.rieslab.emu.controller.SystemController} to signify the user of
   * missing UIParameters or UIProperties in the configuration.
   */
  public static void showConfigurationDidNotPassSanityCheck() {
    String title = "Failed sanity check";

    String message =
        "Some entries in the configuration did not match expectations.\n"
  ...
  public static void showConfigurationCouldNotBeParsed() {
    ...
    String message =
        "The default configuration could not be read, check for JSON errors in the file.\n";
  ...
  /**
   * Displays the list of UIProperties states set to a forbidden value (mismatch with MM property
   * limits).
   *
  ...
  public static void showAboutEMU(Object contextObject) {
    ...
    String message =
        "Easier Micro-manager User interfaces (EMU).<br />"
            + "<i>version "
            + SystemController.EMU_VERSION
            + "</i> <br /><br />"
  ...
  private static JEditorPane getHTMLJEditor(String message) {
    ...
    JEditorPane ep =
        new JEditorPane(
            "text/html", "<html><body style=\"" + style + "\">" + message + "</body></html>");
