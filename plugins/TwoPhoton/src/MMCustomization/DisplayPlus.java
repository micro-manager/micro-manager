...
public class DisplayPlus implements ImageCacheListener  {
   ...
   public DisplayPlus(final ImageCache stitchedCache, AcquisitionEngine eng, JSONObject summaryMD,
           boolean invX, boolean invY, boolean swapXY) {
      eng_ = eng;
      invertX_ = invX;
      invertY_ = invY;
      swapXY_ = swapXY;
...
//         if (swapXY_) {
//            cornerX = pos0y_ - (invertX_ ? -1 : 1) * tileWidth_ / 2 * pixelSize;
//            cornerY = pos0x_ - (invertY_ ? -1 : 1) * tileHeight_ / 2 * pixelSize;
//         } else {
...
//         ReportingUtils.showError("Couldn't create grid");
//         return;
//      }
   }
