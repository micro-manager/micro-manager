...
public class DoubleTaggedImageStorage implements TaggedImageStorage {
   ...
   private boolean makeImarisFile_ = true;
   ...
   public DoubleTaggedImageStorage(JSONObject summaryMetadata, boolean invertX, boolean invertY, boolean swapXandY,
           String savingDir, String imarisDirectory) {
      storage_ = new DynamicStitchingImageStorage(summaryMetadata, invertX, invertY, swapXandY, savingDir);
