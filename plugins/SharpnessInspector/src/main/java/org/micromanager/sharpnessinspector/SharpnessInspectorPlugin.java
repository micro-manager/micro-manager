...
public class SharpnessInspectorPlugin implements InspectorPanelPlugin {
   ...
   public static String README = "This plugin provides a real-time plot of image sharpness. "
           + "Simply click and drag on an image display to select an ROI and the plugin will "
           + " begin evaluating the sharpness of the image within the ROI using the selected "
           + "method. Sharpness is evaluated using the same code that is used by the OughtaFocus "
           + "plugin, for more information about the various evaluation"
