...
public class Properties {
   ...
   public static enum Keys {
      ...
      PLUGIN_Y_DOWNSAMPLE_FACTOR("YDownsampleFactor"),
      PLUGIN_SPACING_DOWNSAMPLE_FACTOR("SpacingDownsampleFactor"),
      PLUGIN_SLICE_THICKNESS_FACTOR("SliceThicknessFactor"),
