...
public class AcquisitionModes {
   ...
   public JComboBox getAcqModeComboBox() {
      JComboBox jcb = new JComboBox();
      ActionListener l = new AcqModeComboBoxListener(jcb);
      jcb.addActionListener(l);
      return jcb;
   }
   
   private class AcqModeComboBoxListener implements ActionListener,
      DevicesListenerInterface {
      
      private final JComboBox jcb_;
      
      public AcqModeComboBoxListener(JComboBox jcb) {
         jcb_ = jcb;
      ...
      private void updateSelections() {
         ...
         List<Keys> validAcqModeKeys = getValidAcqModeKeys();
         Keys origItem = null;
         for (Keys k : validAcqModeKeys) {
       ...
       * @return
       */
      private List<Keys> getValidAcqModeKeys() {
