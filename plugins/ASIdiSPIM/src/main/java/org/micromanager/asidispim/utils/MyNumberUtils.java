...
public class MyNumberUtils {
  ...
  /**
   * Does "equality" test on floats using commons-math3 library and epsilon of 100*maxUlps (before
   * r14315 used locally-defined epsilon of 1e-12, then in changed to 10*maxUlps, then to
   * 100*maxUlps in r15867
   *
   * @param f1
   * @param f2
   * @return
  ...
  /**
   * Tests whether a float is outside the range set by two others. Don't need to know which of the
   * two range-specifying numbers is minimum and which is maximum.
   *
   * @param num
   * @param end1
   * @param end2
