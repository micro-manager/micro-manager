...
public class GaussianWithOffsetCurveFitter extends AbstractCurveFitter {
   ...
   * org.apache.commons.math3.analysis.function.Gaussian.Parametric} based on the specified observed
   * points.
   */
  public static class ParameterGuesser {
     ...
     * @param startIdx Index within points from which to start the search for interpolation bounds
     *     points.
     * @param idxStep Index step for searching interpolation bounds points.
     * @param y Y value for which X should be determined.
     * @return the value of X for the specified Y.
     * @throws ZeroException if {@code idxStep} is 0.
     * @throws OutOfRangeException if specified {@code y} is not within the range of the specified
     *     {@code points}.
     */
    ...
    /**
     * Gets the two bounding interpolation points from the specified points suitable for determining
     * X at the specified Y.
     *
     * @param points Points to use for interpolation.
