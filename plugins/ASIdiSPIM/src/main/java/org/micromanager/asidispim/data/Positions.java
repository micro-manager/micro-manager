...
public class Positions {
  ...
  /**
   * returns cached position of XY stage or Micro-Mirror, or null if device hasn't been defined
   *
   * @param devKey
   * @return
   */
  ...
  /**
   * returns cached position of linear stage, or null if device hasn't been defined
   *
   * @param devKey
   * @return
   */
  ...
  /**
   * Returns the cached position of the specified stage, or 0 if the stage wasn't found or if the
  ...
  /**
   * Returns cached position in string form, or the empty string if there is an error. If dir ==
   * Joystick.Directions.NONE then assumes 1D stage
   *
   * @param devKey
   * @param dir
   * @return
  ...
  /**
   * Sets the position of specified stage to the specified value using appropriate core calls. This
   * variant doesn't have X/Y specifier, so should not be used with galvo or XY stage.
   *
  ...
  public boolean setPosition(
      Devices.Keys devKey, Directions dir, double pos, boolean ignoreErrors) {
    try {
