...
/**
 * Implementation of the ASidiSPIMInterface To avoid depending on the internals of this class and
 * restrict yourself to the ASIdiSPIMInterface, always cast the instance of this class to
 * ASIdiSPIMInterface e.g.:
 *
 ...
 *
 * <p>Another approach is to use Java RMI with the name "ASIdiSPIM_API". e.g.:
 *
 * <p>public class AsiRmiClientStub { public final static String rmiName = "ASIdiSPIM_API"; private
 * AsiRmiClientStub() {} public static void main(String[] args) { String host = (args.length &lt; 1)
 * ? null : args[0]; { Registry registry; try { registry = LocateRegistry.getRegistry(host);
 * ASIdiSPIMInterface stub = (ASIdiSPIMInterface) registry.lookup(rmiName); stub.runAcquisition();
 * // or other API methods in ASIdiSPIMInterface } catch (Exception e) { e.printStackTrace(); } } }
 * }
 *
 * @author nico
 * @author Jon
...
public class ASIdiSPIMImplementation implements ASIdiSPIMInterface {
  ...
  @Override
  public void setVolumeFirstSide(Devices.Sides firstSide)
      throws ASIdiSPIMException, RemoteException {
  ...
  @Override
  public double getSideImagingCenter(org.micromanager.asidispim.data.Devices.Sides side)
      throws ASIdiSPIMException, RemoteException {
    return getSetupPanel(side).getImagingCenter();
  }

  @Override
  public void setSideImagingCenter(
      org.micromanager.asidispim.data.Devices.Sides side, double center)
      throws ASIdiSPIMException, RemoteException {
    getSetupPanel(side).setImagingCenter(center);
  }

  @Override
  public double getSideSlicePosition(org.micromanager.asidispim.data.Devices.Sides side)
      throws ASIdiSPIMException, RemoteException {
    // @deprecated out of laziness, can add if needed
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public void setSideSlicePosition(
      org.micromanager.asidispim.data.Devices.Sides side, double position)
      throws ASIdiSPIMException, RemoteException {
    // @deprecated out of laziness, can add if needed
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public double getSideImagingPiezoPosition(org.micromanager.asidispim.data.Devices.Sides side)
      throws ASIdiSPIMException, RemoteException {
    // @deprecated out of laziness, can add if needed
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public void setSideImagingPiezoPosition(Sides side, double position)
      throws ASIdiSPIMException, RemoteException {
    // @deprecated out of laziness, can add if needed
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public double getSideIlluminationPiezoPosition(Sides side)
      throws ASIdiSPIMException, RemoteException {
    // @deprecated out of laziness, can add if needed
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public void setSideIlluminationPiezoPosition(Sides side, double position)
      throws ASIdiSPIMException, RemoteException {
    // @deprecated out of laziness, can add if needed
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public void setSideSheetWidth(Sides side, double width)
      throws ASIdiSPIMException, RemoteException {
    // @deprecated out of laziness, can add if needed
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public void setSideSheetOffset(Sides side, double width)
      throws ASIdiSPIMException, RemoteException {
    // @deprecated out of laziness, can add if needed
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public void setSideCalibrationSlope(Sides side, double slope)
      throws ASIdiSPIMException, RemoteException {
    // @deprecated out of laziness, can add if needed
    throw new UnsupportedOperationException();
  }
  ...
  @Override
  public void setSideCalibrationOffset(Sides side, double offset)
      throws ASIdiSPIMException, RemoteException {
