...
/** @author pengo */
public class AutoLaseDialog extends javax.swing.JDialog
  ...
  public void densityChanged(double density) {
    ...
    if (maxDensity < density) setMaxDensity(density);
  ...
  private void initComponents() {
    ...
    jtfThreshold.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jbImageMeanThreshold.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jtfMinGoodDensity.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jtfMaxGoodDensity.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jbLaserStartVal.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButton_logFile.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jcbDensityProfile.addItemListener(
        new java.awt.event.ItemListener() {
          public void itemStateChanged(java.awt.event.ItemEvent evt) {
  ...
  private void jtfThresholdActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jtfThresholdActionPerformed
    try {
  ...
  private void jbPreBleachActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jbPreBleachActionPerformed
  ...
  private void jsThresholdStateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_jsThresholdStateChanged
  ...
  private void jlMaxDensityMouseClicked(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_jlMaxDensityMouseClicked
    setMaxDensity(2 * curDensity);
  } // GEN-LAST:event_jlMaxDensityMouseClicked

  private void jcbDensityMapItemStateChanged(
      java.awt.event.ItemEvent evt) { // GEN-FIRST:event_jcbDensityMapItemStateChanged
  ...
  private void jtfMaxGoodDensityActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jtfMaxGoodDensityActionPerformed
    try {
  ...
  private void jtfMinGoodDensityActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jtfMinGoodDensityActionPerformed
    try {
  ...
  private void jbImageMeanThresholdActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jbImageMeanThresholdActionPerformed
  ...
  private void jbOptionsActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jbOptionsActionPerformed
  ...
  private void jtAutoLaseActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jtAutoLaseActionPerformed
    if (jtAutoLase.isSelected()) autoLase.startLaserControl();
    else autoLase.pauseLaserControl();
  } // GEN-LAST:event_jtAutoLaseActionPerformed

  private void jbLaserStartValActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jbLaserStartValActionPerformed
    autoLase.setLaserToStartPower();
  } // GEN-LAST:event_jbLaserStartValActionPerformed

  private void jToggleButton2ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jToggleButton2ActionPerformed
    if (jToggleButton2.isSelected()) {
      ...
      if (ret == JFileChooser.APPROVE_OPTION) {
        try {
          ...
          autoLase.log(
              "Unable to set camera to read from " + jfc.getSelectedFile().getAbsolutePath());
  ...
  private void jButton_logFileActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButton_logFileActionPerformed
  ...
  private void jcbDensityProfileItemStateChanged(
      java.awt.event.ItemEvent evt) { // GEN-FIRST:event_jcbDensityProfileItemStateChanged
