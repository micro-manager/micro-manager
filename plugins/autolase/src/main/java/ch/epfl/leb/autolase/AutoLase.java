...
public enum AutoLase {
   ...
   public static final String LOG_NAME = "AutoLase";
   ...
   void startLogFile() {
      ...
      densityLogger.setLaserMinStep(config.minStep);
      densityLogger.setLaserMinValue(config.minValue);
      densityLogger.setLaserMinValue(config.maxValue);
