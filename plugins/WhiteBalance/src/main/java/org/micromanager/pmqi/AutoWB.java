...
public class AutoWB implements MenuPlugin {
   ...
   private Studio gui_;
   private WhiteBalanceUI wbForm_;
   ...
   public void onPluginSelected() {
      try {
         wbForm_ = new WhiteBalanceUI(gui_);
         gui_.events().registerForEvents(wbForm_);
      } catch (Exception e) {
         Logger.getLogger(WhiteBalanceUI.class.getName()).log(Level.SEVERE, null, e);
   ...
   public String getHelpText() {
      return "Automatic White Balance scaling calculator for PVCAM compatible Photometrics "
