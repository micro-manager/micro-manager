...
public class WhiteBalance_UI extends javax.swing.JFrame {
  ...
  private void CheckIsColorCamera() {
    ...
    try {
      ...
      // JOptionPane.showMessageDialog(this, "Failed to detect camera color type", "Error",
  ...
  private void GetCFAPattern() {
    ...
    try {
      ...
      JOptionPane.showMessageDialog(
          this, "Failed to retrieve sensor mask pattern", "Error", JOptionPane.ERROR_MESSAGE);
    }
  ...
  private void GetBitDepth() {
    ...
    try {
      ...
      Logger.getLogger(WhiteBalance_UI.class.getName()).log(Level.SEVERE, null, ex);
      JOptionPane.showMessageDialog(
          this, "Failed to retrieve camera bit depth", "Error", JOptionPane.ERROR_MESSAGE);
    }
  ...
  private void initComponents() {
    ...
    cbxCFAPattern.setModel(
        new javax.swing.DefaultComboBoxModel(new String[] {"RGGB", "BGGR", "GRBG", "GBRG"}));
    cbxCFAPattern.setSelectedIndex(2);
    cbxCFAPattern.setEnabled(false);
    cbxCFAPattern.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private double FindExposureForWB() {
    ...
    try {
      ...
      if (meanAt1ms > (maxADUval - maxADUval / 7.0)) {
        ...
        lblMean.setText(
            String.valueOf(new BigDecimal(meanAt1ms).setScale(1, BigDecimal.ROUND_HALF_EVEN)));
      ...
      if ((meanAt100ms < ADU_BIAS_16BIT && CameraBitDepth == DEPTH16BIT)
        ...
        lblMean.setText(
            String.valueOf(new BigDecimal(meanAt100ms).setScale(1, BigDecimal.ROUND_HALF_EVEN)));
        lblMean.paintImmediately(lblMean.getVisibleRect());
        JOptionPane.showMessageDialog(
            this,
      ...
      while (iterations < WB_EXP_ITERATIONS_MAX && exposure < MAX_EXPOSURE) {
        ...
        lblWBExposure.setText(
            String.valueOf(new BigDecimal(exposure).setScale(0, RoundingMode.HALF_EVEN)) + " ms");
        ...
        lblMean.setText(
            String.valueOf(
                new BigDecimal(CapturedImageShort.getStatistics().mean)
      ...
      lblMean.paintImmediately(lblMean.getVisibleRect());
      JOptionPane.showMessageDialog(
          this, "Acquisition error occurred", "White Balance Failure", JOptionPane.ERROR_MESSAGE);
      return exposure;
    }
    ...
    if (iterations >= WB_EXP_ITERATIONS_MAX && exposure >= MAX_EXPOSURE) {
      ...
      JOptionPane.showMessageDialog(
          this,
          "Exceeded number of allowed iterations, image too dark.",
          "White Balance Failure",
          JOptionPane.ERROR_MESSAGE);
      return exposure;
      ...
      JOptionPane.showMessageDialog(
          this,
          "Exceeded number of allowed iterations, image too bright.",
          "White Balance Failure",
          JOptionPane.ERROR_MESSAGE);
      return exposure;
  ...
  private void SnapImage(double exposure) throws Exception {
    try {
      ...
      CapturedImageShort =
          new ShortProcessor(
              (int) core_.getImageWidth(), (int) core_.getImageHeight(), (short[]) newImage, null);
    } catch (Exception ex) {
      Logger.getLogger(WhiteBalance_UI.class.getName()).log(Level.SEVERE, null, ex);
  ...
  private void GetScales() {
    ...
    if (RedScale > 20.0) {
      JOptionPane.showMessageDialog(
          this,
          "Red scale greater than 20.0, limiting to 20.",
          "Warning",
          JOptionPane.WARNING_MESSAGE);
      Logger.getLogger(WhiteBalance_UI.class.getName())
    ...
    if (BlueScale > 20.0) {
      JOptionPane.showMessageDialog(
          this,
          "Blue scale greater than 20.0, limiting to 20.",
          "Warning",
          JOptionPane.WARNING_MESSAGE);
      Logger.getLogger(WhiteBalance_UI.class.getName())
    ...
    if (GreenScale > 20.0) {
      JOptionPane.showMessageDialog(
          this,
          "Green scale greater than 20.0, limiting to 20.",
          "Warning",
          JOptionPane.WARNING_MESSAGE);
      Logger.getLogger(WhiteBalance_UI.class.getName())
  ...
  private void btnRunWBActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btnRunWBActionPerformed
    ...
    try {
      ...
      JOptionPane.showMessageDialog(
          this,
          "Could not set White Balance scales as device properties.",
          "Error",
          JOptionPane.ERROR_MESSAGE);
    }
    btnRunWB.setText("Run WB");
  ...
  private void cbxBitDepthActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_cbxBitDepthActionPerformed
  ...
  private void cbxCFAPatternActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_cbxCFAPatternActionPerformed
