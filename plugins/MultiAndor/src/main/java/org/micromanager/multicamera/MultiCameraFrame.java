...
public class MultiCameraFrame extends JFrame {
  ...
  private void initComponents() {
    ...
    EMGainTextField.addFocusListener(
        new java.awt.event.FocusAdapter() {
          public void focusLost(java.awt.event.FocusEvent evt) {
            EMGainTextFieldFocusLost(evt);
          }
        });
    EMGainTextField.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
            EMGainTextFieldActionPerformed(evt);
          }
        });
    EMGainTextField.addKeyListener(
    ...
    modeComboBox.setModel(
        new javax.swing.DefaultComboBoxModel(new String[] {"EM", "Conventional"}));
    modeComboBox.addItemListener(
    ...
    speedComboBox.setModel(
        new javax.swing.DefaultComboBoxModel(new String[] {"1MHz", "3MHz", "5MHz", "10MHz"}));
    speedComboBox.addItemListener(
        new java.awt.event.ItemListener() {
          public void itemStateChanged(java.awt.event.ItemEvent evt) {
    ...
    frameTransferComboBox.setModel(
        new javax.swing.DefaultComboBoxModel(new String[] {"On", "Off"}));
    frameTransferComboBox.addItemListener(
        new java.awt.event.ItemListener() {
          public void itemStateChanged(java.awt.event.ItemEvent evt) {
    ...
    cameraSelectComboBox.setModel(
        new javax.swing.DefaultComboBoxModel(new String[] {"1", "2", "4", "8"}));
    cameraSelectComboBox.addItemListener(
        new java.awt.event.ItemListener() {
          public void itemStateChanged(java.awt.event.ItemEvent evt) {
    ...
    triggerComboBox.addItemListener(
        new java.awt.event.ItemListener() {
          public void itemStateChanged(java.awt.event.ItemEvent evt) {
  ...
  private void EMGainSliderMouseReleased(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_EMGainSliderMouseReleased
    setEMGain();
    gui_.app().refreshGUI();
  } // GEN-LAST:event_EMGainSliderMouseReleased

  private void tempButtonActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_tempButtonActionPerformed
    gui_.live().setSuspended(true);
    updateTemp();
    gui_.live().setSuspended(false);
  ...
  private void speedComboBoxItemStateChanged(
      java.awt.event.ItemEvent evt) { // GEN-FIRST:event_speedComboBoxItemStateChanged
    if (!(evt.getStateChange() == ItemEvent.SELECTED)) {
      return;
    }
  ...
  private void frameTransferComboBoxItemStateChanged(
      java.awt.event.ItemEvent evt) { // GEN-FIRST:event_frameTransferComboBoxItemStateChanged
    if (!(evt.getStateChange() == ItemEvent.SELECTED)) {
      return;
    }
  ...
  private void triggerComboBoxItemStateChanged(
      java.awt.event.ItemEvent evt) { // GEN-FIRST:event_triggerComboBoxItemStateChanged
    if (!(evt.getStateChange() == ItemEvent.SELECTED)) {
      return;
    }
  ...
  private void cameraSelectComboBoxItemStateChanged(
      java.awt.event.ItemEvent evt) { // GEN-FIRST:event_cameraSelectComboBoxItemStateChanged
  ...
  private void modeComboBoxActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_modeComboBoxActionPerformed
  } // GEN-LAST:event_modeComboBoxActionPerformed

  private void EMGainTextFieldKeyReleased(
      java.awt.event.KeyEvent evt) { // GEN-FIRST:event_EMGainTextFieldKeyReleased
  } // GEN-LAST:event_EMGainTextFieldKeyReleased

  private void EMGainTextFieldFocusLost(
      java.awt.event.FocusEvent evt) { // GEN-FIRST:event_EMGainTextFieldFocusLost
    handleEMGainTextFieldEvent();
  ...
  public void onPropertyChanged(PropertyChangedEvent event) {
    ...
    try {
      if (device.equals("Core")
          && property.equals("Camera")
