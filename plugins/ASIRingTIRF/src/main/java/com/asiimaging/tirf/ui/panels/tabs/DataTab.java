...
public class DataTab extends Panel {
    ...
    private void createUserInterface() {
        ...
        spnScriptDelay = Spinner.createIntegerSpinner(model.getScriptDelay(), 0, Integer.MAX_VALUE, 100);
    ...
    private String getSaveModeText(final Datastore.SaveMode saveMode) {
        return (saveMode == Datastore.SaveMode.SINGLEPLANE_TIFF_SERIES) ? "Single Plane TIFF" : "Multi-Page TIFF";
    }
