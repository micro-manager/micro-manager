...
public final class Icons {
   ...
   private static final URL CANCEL_PATH =
         Studio.class.getResource("/org/micromanager/icons/cancel.png");
   private static final URL CAMERA_PATH =
         Studio.class.getResource("/org/micromanager/icons/camera.png");
   private static final URL CAMERA_GO_PATH =
         Studio.class.getResource("/org/micromanager/icons/camera_go.png");
   private static final URL ARROW_UP_PATH =
         Studio.class.getResource("/org/micromanager/icons/arrow_up.png");
   private static final URL ARROW_DOWN_PATH =
         Studio.class.getResource("/org/micromanager/icons/arrow_down.png");
   private static final URL ARROW_RIGHT_PATH =
         Studio.class.getResource("/org/micromanager/icons/arrow_right.png");
   ...
   public static final ImageIcon ARROW_DOWN =
         new ImageIcon(Objects.requireNonNull(ARROW_DOWN_PATH));
   public static final ImageIcon ARROW_RIGHT =
         new ImageIcon(Objects.requireNonNull(ARROW_RIGHT_PATH));
