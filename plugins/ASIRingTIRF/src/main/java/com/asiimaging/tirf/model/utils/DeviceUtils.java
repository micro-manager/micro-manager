...
public class DeviceUtils {
    ...
    public static void printDeviceProperties(final CMMCore core, final String name) throws Exception {
    ...
    public static void printDeviceProperties(final CMMCore core, final String[] deviceNames) throws Exception {
