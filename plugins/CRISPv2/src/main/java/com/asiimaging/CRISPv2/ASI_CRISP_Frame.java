...
public class ASI_CRISP_Frame extends javax.swing.JFrame {
      ...
      try {
        if (core_.hasProperty(af, "Description")) {
          if (core_.getProperty(af, "Description").equals("ASI CRISP Autofocus adapter")
              || core_
                  .getProperty(af, "Description")
                  .startsWith("ASI CRISP AutoFocus")) { // this line is for Tiger
            found = true;
            CRISP_ = af;
            jLabel6.setText(af);
  ...
  private void initComponents() {
    ...
    GainSpinner_.setModel(
        new javax.swing.SpinnerNumberModel(
            Integer.valueOf(10), null, Integer.valueOf(100), Integer.valueOf(1)));
    GainSpinner_.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    NrAvgsSpinner_.setModel(
        new javax.swing.SpinnerNumberModel(
            Integer.valueOf(1), null, Integer.valueOf(10), Integer.valueOf(1)));
    NrAvgsSpinner_.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    NASpinner_.setModel(
        new javax.swing.SpinnerNumberModel(
            Float.valueOf(0.65f), null, Float.valueOf(1.4f), Float.valueOf(0.05f)));
    NASpinner_.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    btn_lock.addMouseListener(
        new java.awt.event.MouseAdapter() {
          public void mouseClicked(java.awt.event.MouseEvent evt) {
            btn_lockMouseClicked(evt);
          }
        });
    btn_lock.addActionListener(
  ...
  private void LEDSpinner_StateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_LEDSpinner_StateChanged
  ...
  private void GainSpinner_StateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_GainSpinner_StateChanged
  ...
  private void NrAvgsSpinner_StateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_NrAvgsSpinner_StateChanged
  ...
  private void NASpinner_StateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_NASpinner_StateChanged
  ...
  private void btn_idleMouseClicked(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_btn_idleMouseClicked
    try {
  ...
  private void btn_logcalMouseClicked(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_btn_logcalMouseClicked
    try {
  ...
  private void btn_bitherMouseClicked(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_btn_bitherMouseClicked
  ...
  private void btn_setgainMouseClicked(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_btn_setgainMouseClicked
    try {
  ...
  private void btn_lockMouseClicked(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_btn_lockMouseClicked
    try {
  ...
  private void btn_unlockMouseClicked(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_btn_unlockMouseClicked
    try {
  ...
  private void cb_pollingStateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_cb_pollingStateChanged
  ...
  private void btn_lockActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btn_lockActionPerformed
    // TODO add your handling code here:
  } // GEN-LAST:event_btn_lockActionPerformed

  private void btn_offsetMouseClicked(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_btn_offsetMouseClicked
    try {
  ...
  private void btn_saveMouseClicked(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_btn_saveMouseClicked
    try {
