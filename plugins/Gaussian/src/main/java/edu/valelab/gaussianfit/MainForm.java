...
public class MainForm extends javax.swing.JFrame implements ij.ImageListener{
   ...
   ImagePlus ip_ = null;
    ...
    public MainForm(Studio studio) {
       ...
       super.setBounds(prefs_.getInt(FRAMEXPOS, 100), prefs_.getInt(FRAMEYPOS, 100), 270, 625);
   ...
   private void initComponents() {
      ...
      getContentPane().add(jSeparator4, "span 3, grow, wrap");
      
      
      jLabel11.setText("Find Maxima Settings...");
      getContentPane().add(jLabel11, "span 3, wrap");
      ...
      getContentPane().add(showOverlay_, "gapleft 20px, split 2");
      ...
      preFilterComboBox_.setMinimumSize(textFieldDim);
      ...
      getContentPane().add(jSeparator6, "span 3, grow, wrap");
...
/*-----------  Fit Parameters  -----------*/
      ...
      getContentPane().add(jLabel14, "gapleft 20px");
      ...
      fitMethodComboBox1.setMinimumSize(textFieldDim);      
      getContentPane().add(fitMethodComboBox1, "wrap");
      ...
      getContentPane().add(jSeparator1, "span 3, grow, wrap");
      ...
      getContentPane().add(jSeparator5, "span 3, grow, wrap");
