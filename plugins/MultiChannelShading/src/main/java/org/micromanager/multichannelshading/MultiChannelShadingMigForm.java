...
public class MultiChannelShadingMigForm extends JDialog implements ProcessorConfigurator {
  ...
  public MultiChannelShadingMigForm(PropertyMap settings, Studio studio) {
    studio_ = studio;
    settings_ = settings;
    profileSettings_ = studio_.profile().getSettings(MultiChannelShadingMigForm.class);
    ...
    groupComboBox_.setModel(new javax.swing.DefaultComboBoxModel(channelGroups));
    groupName_ = settings_.getString(CHANNELGROUP, profileSettings_.getString(CHANNELGROUP, ""));
    groupComboBox_.setSelectedItem(groupName_);
    groupComboBox_.addActionListener(
    ...
    useOpenCLCheckBox.addActionListener(
        new ActionListener() {
          @Override
    ...
    helpButton.addActionListener(
        new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            new Thread(
                    org.micromanager.internal.utils.GUIUtils.makeURLRunnable(
                        "https://micro-manager.org/wiki/Flat-Field_Correction"))
                .start();
          }
        });
    ...
    darkFieldTextField.setText(
        settings_.getString(DARKFIELDFILENAME, profileSettings_.getString(DARKFIELDFILENAME, "")));
    darkFieldTextField.setHorizontalAlignment(JTextField.RIGHT);
    darkFieldTextField.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    darkFieldTextField.addFocusListener(
        new FocusListener() {
          @Override
    ...
    darkFieldTextField.setText(processBackgroundImage(darkFieldTextField.getText()));
    ...
    darkFieldButton.addActionListener(
        new java.awt.event.ActionListener() {
          @Override
          public void actionPerformed(java.awt.event.ActionEvent evt) {
            File f =
                FileDialogs.openFile(
                    ...
                    new FileDialogs.FileType(
                        "MMAcq", "Dark image", backgroundFileName_, true, IMAGESUFFIXES));
            if (f != null) {
    ...
    shadingTableModel_.setChannelGroup(groupName_);
    final ShadingTable shadingTable = new ShadingTable(studio_, shadingTableModel_, this);
    ...
    removeButton.setIcon(
        new ImageIcon(getClass().getResource("/org/micromanager/icons/minus.png")));
  ...
  /**
   * Processes background image Return filename if successful, empty string otherwise
   *
   * @param fileName
   * @return fileName
   */
