...
public class pgFocusFrame extends JFrame {
    ...
    public LightPanel(CMMCore core) {
      ...
      JFreeChart lightChart =
          ChartFactory.createXYLineChart(
              "", "Pixel", "Light", lightProfileSet, PlotOrientation.VERTICAL, false, false, false);
  ...
  void initRealTimePanel(pgFocusPanel pgFocusPlot_) {
    ...
    tglbtnLockButton.addActionListener(
  ...
  void initSettingsPanel(JPanel settingsPanel_) {
    ...
    chckbxAutoexpose.addActionListener(
        new ActionListener() {
    ...
    tfOnExposure.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent arg0) {
    ...
    chbUpdateRealTime.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent arg0) {
    ...
    tfOnWaitAfterMessage.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent arg0) {
    ...
    chbUpdateLight.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent arg0) {
    ...
    tfOnWaitAfterLight.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent arg0) {
    ...
    tfOnWaitAfterLock.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent arg0) {
    ...
    textInput_Gain.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent arg0) {
    ...
    textOnOffset.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent arg0) {
    ...
    textOnnMPerVolt.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent arg0) {
  ...
  void initCalibratePanel(CalibratePanel calibratePlot) {
    ...
    btnCalibrateButton.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
