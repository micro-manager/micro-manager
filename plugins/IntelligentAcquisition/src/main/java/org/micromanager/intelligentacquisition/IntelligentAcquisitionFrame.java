...
public class IntelligentAcquisitionFrame extends javax.swing.JFrame {
  ...
  public IntelligentAcquisitionFrame(Studio gui) {
    ...
    frameXPos_ = gui_.profile().getSettings(cl_).getInteger(FRAMEXPOS, frameXPos_);
    frameYPos_ = gui_.profile().getSettings(cl_).getInteger(FRAMEYPOS, frameYPos_);
    acqFileNameA_ = gui_.profile().getSettings(cl_).getString(ACQFILENAMEA, acqFileNameA_);
    acqFileNameB_ = gui_.profile().getSettings(cl_).getString(ACQFILENAMEB, acqFileNameB_);
    scriptFileName_ = gui_.profile().getSettings(cl_).getString(SCRIPTFILENAME, scriptFileName_);
    explorationX_ = gui_.profile().getSettings(cl_).getInteger(EXPFIELDSX, explorationX_);
    explorationY_ = gui_.profile().getSettings(cl_).getInteger(EXPFIELDSY, explorationY_);
    roiWidthX_ = gui_.profile().getSettings(cl_).getLong(ROIWIDTHX, roiWidthX_);
    roiWidthY_ = gui_.profile().getSettings(cl_).getLong(ROIWIDTHY, roiWidthY_);
  ...
  private void initComponents() {
    ...
    acqSettingsButton1_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    acqSettingsButton2_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    scriptButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    fullROIButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    halfROIButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    expAreaFieldY_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    expAreaFieldX_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void onWindowClosing(java.awt.event.WindowEvent evt) { // GEN-FIRST:event_onWindowClosing
    ...
    try {
      gui_.profile()
          .getSettings(cl_)
          .putInteger(EXPFIELDSX, NumberUtils.displayStringToInt(expAreaFieldX_.getText()));
    } catch (ParseException ex) {
    }
    try {
      gui_.profile()
          .getSettings(cl_)
          .putInteger(EXPFIELDSY, NumberUtils.displayStringToInt(expAreaFieldY_.getText()));
    } catch (ParseException ex) {
    }
    gui_.profile().getSettings(cl_).putString(SCRIPTFILENAME, scriptTextField_.getText());
    gui_.profile().getSettings(cl_).putString(ACQFILENAMEA, acqTextField1_.getText());
    gui_.profile().getSettings(cl_).putString(ACQFILENAMEB, acqTextField2_.getText());
  ...
  private void acqSettingsButton1_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_acqSettingsButton1_ActionPerformed
    File f =
        FileDialogs.openFile(
            this,
            "Exploration acquisition settings",
            new FileType(
                "MMAcq", "Micro-Manager acquisition settings", acqFileNameA_, true, ACQSUFFIXES));
    if (f != null) {
  ...
  private void acqSettingsButton2_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_acqSettingsButton2_ActionPerformed
    File f =
        FileDialogs.openFile(
            this,
            "Imaging acquisition settings",
            new FileType(
                "MMAcq", "Micro-Manager acquisition settings", acqFileNameB_, true, ACQSUFFIXES));
    if (f != null) {
  ...
  private void scriptButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_scriptButton_ActionPerformed
    File f =
        FileDialogs.openFile(
            this,
            "Analysis script",
            new FileType(
                "Script",
                "Image analysis script (ImageJ macro or " + "Beanshell script",
                scriptFileName_,
                true,
                SCRIPTSUFFIXES));
    if (f != null) {
  ...
  private void roiFieldX_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_roiFieldX_ActionPerformed
    try {
  ...
  private void roiFieldY_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_roiFieldY_ActionPerformed
    try {
  ...
  private void expAreaFieldY_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_expAreaFieldY_ActionPerformed
    try {
  ...
  private void expAreaFieldX_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_expAreaFieldX_ActionPerformed
    try {
  ...
  private void fullROIButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_fullROIButton_ActionPerformed
    roiWidthX_ = core_.getImageWidth();
    roiWidthY_ = core_.getImageHeight();
    updateROI();
  } // GEN-LAST:event_fullROIButton_ActionPerformed

  private void halfROIButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_halfROIButton_ActionPerformed
  ...
  private void goButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_goButton_ActionPerformed
    ...
    Thread executeGo =
        new Thread() {
          ...
          public void run() {
            ...
            try {
              af = gui_.compat().getCameraTransform(core_.getCurrentPixelSizeConfig());
            } catch (Exception ex) {
            ...
            try {
              ...
              gui_.logs()
                  .showError(
                      "Unable to load Imaging Acquisition Settings. "
            ...
            while (!stop_.get()) {
              ...
              if (res.getCounter() > 0) {
                try {
                  ...
                  core_.setRelativeXYPosition(xyStage_, newStagePos.getX(), newStagePos.getY());
                  core_.setROI(
                      (int) (core_.getImageWidth() / 2 - roiWidthX_ / 2),
                      (int) (core_.getImageHeight() / 2 - roiWidthY_ / 2),
                      (int) roiWidthX_,
                      (int) roiWidthY_);

                  gui_.logs()
                      .showMessage("Imaging interesting cell at position: " + xPos + ", " + yPos);

                  gui_.acquisitions().loadAcquisition(acqFileNameB_);
                  Datastore tmpStore = gui_.acquisitions().runAcquisition();
                  gui_.displays().closeDisplaysFor(tmpStore);
                  core_.setRelativeXYPosition(
                      xyStage_, -xPos * pixelWidthMicron_, -yPos * pixelWidthMicron_);
                  core_.clearROI();
              ...
              if (imageIndex >= (explorationX_ * explorationY_)) stop_.set(true);
            }
          }
        };
  ...
  private void testButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_testButton_ActionPerformed
    Thread executeTest =
        new Thread() {
          ...
          public void run() {
            ...
            if (siPlus != null && dw == null) {
              ...
              for (int p = 1; p <= nrPositions && !stop_.get(); p++) {
                try {
                  ...
                  ij.IJ.runMacroFile(scriptFileName_);
                  ResultsTable res = ij.measure.ResultsTable.getResultsTable();
                  // get results out, stick them in new window that has listeners coupling to image
                  // window
                  if (res.getCounter() > 0) {
            ...
            // add listeners to our ResultsTable that let user click on row and go to cell that was
            // found
            TextPanel tp;
            TextWindow win;
  ...
  private void helpButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_helpButton_ActionPerformed
    Helper h = new Helper();
    h.start();
