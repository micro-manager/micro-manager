 ...
 * @author henrypinkard
 */
class DisplayWindowControls extends javax.swing.JPanel implements SurfaceGridListener {
   ...
   MagellanChannelGroupSettings channels_;

   /**
    * Creates new form DisplayWindowControls
    */
   public DisplayWindowControls(MagellanDisplayController disp, MagellanChannelGroupSettings channels) {
