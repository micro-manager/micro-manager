...
//    * @return
//    */
//   private void createAndRenderOverlay(DataViewCoords viewCoords) throws InterruptedException {
//
...
//    * @return
//    */
//   public Overlay createEasyPartsOfOverlay(DataViewCoords viewCoords) {
//      try {
...
//         }
//         if (mode == DataViewCoords.EXPLORE) {
//            addExploreToOverlay(overlay);
//            return overlay;
//         } else if (mode == DataViewCoords.NONE) {
//            return overlay;
//         } else if (mode == DataViewCoords.SURFACE_AND_GRID) {
...
//    */
//   private Overlay createBackgroundOverlay(DataViewCoords viewCoords) {
...
//   }
//
//   private void addInterpPoints(SurfaceInterpolator newSurface, Overlay overlay, DataViewCoords viewCoords) {
//      if (newSurface == null) {
//         return;
//      }
...
//   }
//
//   private void addConvexHull(SurfaceInterpolator surface, Overlay overlay, DataViewCoords viewCoords) {
//      //draw convex hull
...
//   }
//
//   private void addStagePositions(SurfaceInterpolator surface, Overlay overlay, DataViewCoords viewCoords) {
...
//           int displayPixPerInterpTile, DataViewCoords viewCoords) throws InterruptedException {
...
//   }
//
//   private Overlay addGridToOverlay(Overlay overlay, MultiPosGrid grid, DataViewCoords viewCoords) {
...
//   }
//
//   private void drawSurfaceInterpScaleBar(Overlay overlay, DataViewCoords viewCoords) {
