...
public class GUI extends javax.swing.JFrame {
  ...
  private void moreInitialization() {
    ...
    userGuideLink_.addMouseListener(
        new MouseAdapter() {
          @Override
            ...
            new Thread(
                    new Runnable() {
                      ...
                      public void run() {
                        try {
                          ij.plugin.BrowserLauncher.openURL(
                              "http://www.nature.com/nmeth/journal/v13/n10/full/nmeth.3991.html");
                        } catch (IOException ex) {
    ...
    bugReportLink_.addMouseListener(
        new MouseAdapter() {
          @Override
          public void mousePressed(MouseEvent e) {
            new Thread(
                    new Runnable() {
                      ...
                      public void run() {
                        try {
                          ij.plugin.BrowserLauncher.openURL(
                              "https://github.com/micro-manager/pycro-manager/issues");
                        } catch (IOException ex) {
                          Log.log("couldn't open citation link");
                        }
                      }
            ...
            new ListSelectionListener() {
              ...
              public void valueChanged(ListSelectionEvent e) {
                ...
                if (multiAcqSelectedIndex_ == multipleAcqTable_.getModel().getRowCount()) {
                  multipleAcqTable_
                      .getSelectionModel()
                      .setSelectionInterval(multiAcqSelectedIndex_ - 1, multiAcqSelectedIndex_ - 1);
                }
  ...
  private void refreshBoldedText() {
    if (acqTabbedPane_.getTabCount() == 3) { // Make sure inititilization is done
      ...
      l3.setFont(
          acqTabbedPane_.getComponent(0).getFont().deriveFont(true ? Font.BOLD : Font.PLAIN));
      acqTabbedPane_.setTabComponentAt(0, l3);
      JLabel l4 = new JLabel("Channels");
      boolean useChannels =
          multiAcqManager_.getAcquisitionSettings(multiAcqSelectedIndex_).getChannelGroup() != null
              && !multiAcqManager_
                  .getAcquisitionSettings(multiAcqSelectedIndex_)
                  .getChannelGroup()
                  .equals("");
      ...
      l4.setFont(
          acqTabbedPane_
              .getComponent(1)
              .getFont()
              .deriveFont(useChannels ? Font.BOLD : Font.PLAIN));
      ...
      l2.setFont(
          acqTabbedPane_
              .getComponent(2)
              .getFont()
              .deriveFont(timePointsCheckBox_.isSelected() ? Font.BOLD : Font.PLAIN));
    ...
    if (exploreAcqTabbedPane_.getTabCount() == 2) {
      ...
      l.setFont(
          exploreAcqTabbedPane_
              .getComponent(0)
              .getFont()
              .deriveFont(exploreAcqTabbedPane_.getSelectedIndex() == 0 ? Font.BOLD : Font.PLAIN));
      ...
      l1.setFont(
          exploreAcqTabbedPane_
              .getComponent(1)
              .getFont()
              .deriveFont(exploreAcqTabbedPane_.getSelectedIndex() == 1 ? Font.BOLD : Font.PLAIN));
  ...
  public void storeCurrentAcqSettings() {
    ...
    if (button2D_.isSelected()) { // 2D pane
      ...
      if (cuboidVolumeButton_.isSelected()) {
        ...
        settings.distanceBelowFixedSurface_ =
            ((Number) distanceBelowFixedSurfaceSpinner_.getValue()).doubleValue();
        settings.distanceAboveFixedSurface_ =
            ((Number) distanceAboveFixedSurfaceSpinner_.getValue()).doubleValue();
        settings.fixedSurface_ =
            manager_.getSurface(fixedDistanceSurfaceComboBox_.getSelectedIndex());
      }
    } else {
  ...
  public void refreshAcqControlsFromSettings() {
    ...
    } else if (settings.spaceMode_
        == MagellanGUIAcquisitionSettings.VOLUME_BETWEEN_SURFACES_Z_STACK) {
      volumeBetweenSurfacesButton_.setSelected(true);
      volumeBetweenSurfacesButton_ActionPerformed(null);
    } else if (settings.spaceMode_
        == MagellanGUIAcquisitionSettings.SURFACE_FIXED_DISTANCE_Z_STACK) {
    ...
    ((SimpleChannelTableModel) channelsTable_.getModel())
        .setChannels((ChannelGroupSettings) settings.channels_);
    ((SimpleChannelTableModel) channelsTable_.getModel()).fireTableDataChanged();
  ...
  private void initComponents() {
    ...
    exploreAcqTabbedPane_.addChangeListener(
    ...
    exploreZStepSpinner_.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    newExploreWindowButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    deleteAllRegionsButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    javax.swing.GroupLayout surfaceAndGridsPanel_Layout =
        new javax.swing.GroupLayout(surfaceAndGridsPanel_);
    surfaceAndGridsPanel_.setLayout(surfaceAndGridsPanel_Layout);
    surfaceAndGridsPanel_Layout.setHorizontalGroup(
        surfaceAndGridsPanel_Layout
        ...
        surfaceAndGridsPanel_Layout
            ...
            .addGroup(
                surfaceAndGridsPanel_Layout
                    ...
                    .addGap(20, 20, 20)
                    .addComponent(
                        jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 286, Short.MAX_VALUE)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addGroup(
                        surfaceAndGridsPanel_Layout
                                                ...
                                                explorePanelLayout
                                                    ...
                                                    .addPreferredGap(
                                                        javax.swing.LayoutStyle.ComponentPlacement
                                                            .RELATED)
                                                    .addComponent(
                                                        exploreZStepSpinner_,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        77,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                    .addGap(291, 291, 291)
                                                    .addComponent(
                                                        newExploreWindowButton_,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        103,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                            .addGroup(
    ...
    collectionPlaneCombo_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    noCollectionPlaneButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    labelDiagram2dSimple_.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/org/micromanager/magellan/2dsimple.png"))); // NOI18N
    labelDiagram2dSimple_.setBorder(
        javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 4));

    labelDiagram2DSurface_.setIcon(
        new javax.swing.ImageIcon(
    ...
    javax.swing.GroupLayout panel2dControlsSpecific_Layout =
        new javax.swing.GroupLayout(panel2dControlsSpecific_);
    panel2dControlsSpecific_.setLayout(panel2dControlsSpecific_Layout);
    panel2dControlsSpecific_Layout.setHorizontalGroup(
        panel2dControlsSpecific_Layout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(
                panel2dControlsSpecific_Layout
                    .createSequentialGroup()
    ...
    zStartSpinner_.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    zEndSpinner_.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    setCurrentZStartButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    setCurrentZEndButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    labelDiagram3dSimple_.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/org/micromanager/magellan/3dsimple.png"))); // NOI18N
    labelDiagram3dSimple_.setBorder(
        new javax.swing.border.LineBorder(new java.awt.Color(0, 128, 0), 4, true));
    ...
    topSurfaceCombo_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    bottomSurfaceCombo_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    umAboveTopSurfaceSpinner_.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    umBelowBottomSurfaceSpinner_.setModel(
        new javax.swing.SpinnerNumberModel(0.0d, 0.0d, null, 1.0d));
    ...
    labelDiagram3d2Surface_.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/org/micromanager/magellan/3d2surface.png"))); // NOI18N
    labelDiagram3d2Surface_.setBorder(
        new javax.swing.border.LineBorder(new java.awt.Color(0, 128, 0), 4, true));

    javax.swing.GroupLayout volumeBetweenZPanel_Layout =
        new javax.swing.GroupLayout(volumeBetweenZPanel_);
    volumeBetweenZPanel_.setLayout(volumeBetweenZPanel_Layout);
    volumeBetweenZPanel_Layout.setHorizontalGroup(
        volumeBetweenZPanel_Layout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(
                volumeBetweenZPanel_Layout
                    .createSequentialGroup()
    ...
    distanceBelowFixedSurfaceSpinner_.setModel(
        new javax.swing.SpinnerNumberModel(0.0d, 0.0d, null, 0.001d));
    ...
    distanceAboveFixedSurfaceSpinner_.setModel(
        new javax.swing.SpinnerNumberModel(0.0d, 0.0d, null, 0.001d));
    ...
    labelDiagram3dSurface_.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/org/micromanager/magellan/3dsurface.png"))); // NOI18N
    labelDiagram3dSurface_.setBorder(
        new javax.swing.border.LineBorder(new java.awt.Color(0, 128, 0), 4, true));

    javax.swing.GroupLayout fixedDistanceZPanel_Layout =
        new javax.swing.GroupLayout(fixedDistanceZPanel_);
    fixedDistanceZPanel_.setLayout(fixedDistanceZPanel_Layout);
    fixedDistanceZPanel_Layout.setHorizontalGroup(
        fixedDistanceZPanel_Layout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(
                fixedDistanceZPanel_Layout
                    .createSequentialGroup()
                    ...
                    .addGroup(
                        fixedDistanceZPanel_Layout
                                                ...
                                                fixedDistanceZPanel_Layout
                                                    ...
                                                    .addPreferredGap(
                                                        javax.swing.LayoutStyle.ComponentPlacement
                                                            .UNRELATED)
                                                    .addComponent(
                                                        distanceAboveFixedSurfaceSpinner_,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        84,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                            .addGroup(
                                                fixedDistanceZPanel_Layout
                                                    ...
                                                    .addPreferredGap(
                                                        javax.swing.LayoutStyle.ComponentPlacement
                                                            .UNRELATED)
                                                    .addComponent(
                                                        distanceBelowFixedSurfaceSpinner_,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        81,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addPreferredGap(
                            ...
                            .addComponent(
                                fixedDistanceSurfaceComboBox_,
                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                203,
                                javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        labelDiagram3dSurface_,
                        javax.swing.GroupLayout.PREFERRED_SIZE,
                        270,
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, 0)));
    ...
    zStepSpinner_.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    acqOrderCombo_.setModel(
        new javax.swing.DefaultComboBoxModel(new String[] {"Channel, Z", "Z, Channel"}));
    acqOrderCombo_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    withinDistanceFromSurfacesButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    volumeBetweenSurfacesButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    cuboidVolumeButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    javax.swing.GroupLayout panel3DControlsSpecific_Layout =
        new javax.swing.GroupLayout(panel3DControlsSpecific_);
    panel3DControlsSpecific_.setLayout(panel3DControlsSpecific_Layout);
    panel3DControlsSpecific_Layout.setHorizontalGroup(
        panel3DControlsSpecific_Layout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(
                panel3DControlsSpecific_Layout
                    .createSequentialGroup()
                    ...
                    .addGroup(
                        panel3DControlsSpecific_Layout
                            ...
                            .addComponent(
                                withinDistanceFromSurfacesButton_,
                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(
    ...
    xyFootprintComboBox_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    ChannelGroupCombo_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    syncExposuresButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    ChannelsTab_Layout.setHorizontalGroup(
        ChannelsTab_Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(
                ChannelsTab_Layout.createSequentialGroup()
    ...
    ChannelsTab_Layout.setVerticalGroup(
        ChannelsTab_Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(
                ...
                ChannelsTab_Layout.createSequentialGroup()
                    .addGroup(
                        ChannelsTab_Layout.createParallelGroup(
                                javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel3)
                            .addComponent(
                                ChannelGroupCombo_,
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE)));
    ...
    timeIntevalUnitCombo_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    numTimePointsSpinner_.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    timeIntervalSpinner_.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
                            ...
                            .addGroup(
                                timePointsPanel_Layout
                                    ...
                                    .addPreferredGap(
                                        javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(
                                        numTimePointsSpinner_,
                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                        87,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        timeIntevalUnitCombo_,
                        javax.swing.GroupLayout.PREFERRED_SIZE,
                        78,
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
    ...
    timePointsCheckBox_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    runAcqButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    moveAcqUpButton_.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/org/micromanager/magellan/arrow_up.png"))); // NOI18N
    moveAcqUpButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    moveAcqDownButton_.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/org/micromanager/magellan/arrow_down.png"))); // NOI18N
    moveAcqDownButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    openDatasetButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    exploreBrowseButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    tileOverlapSpinner_.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
  ...
  private void runAcqButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_runAcqButton_ActionPerformed
  ...
  private void newExploreWindowButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_newExploreWindowButton_ActionPerformed
    ...
    MagellanAcquisitionsManager.getInstance()
        .createExploreAcquisition(zStep, overlap, dir, name, cGroup)
        .start();
  } // GEN-LAST:event_newExploreWindowButton_ActionPerformed

  private void exploreZStepSpinner_StateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_exploreZStepSpinner_StateChanged
  } // GEN-LAST:event_exploreZStepSpinner_StateChanged

  private void exploreBrowseButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_exploreBrowseButton_ActionPerformed
    String root = "";
  ...
  private void exploreSavingNameTextField_ActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_exploreSavingNameTextField_ActionPerformed
  } // GEN-LAST:event_exploreSavingNameTextField_ActionPerformed

  private void openDatasetButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_openDatasetButton_ActionPerformed
  ...
  private void moveAcqDownButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_moveAcqDownButton_ActionPerformed
    int move = multiAcqManager_.moveDown(multipleAcqTable_.getSelectedRow());
    multipleAcqTable_
        .getSelectionModel()
        .setSelectionInterval(multiAcqSelectedIndex_ + move, multiAcqSelectedIndex_ + move);
    multipleAcqTable_.repaint();
  } // GEN-LAST:event_moveAcqDownButton_ActionPerformed

  private void moveAcqUpButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_moveAcqUpButton_ActionPerformed
  ...
  private void ChannelGroupCombo_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_ChannelGroupCombo_ActionPerformed
    // update the current channels object displayed in the GUI
    multiAcqManager_
        .getAcquisitionSettings(multiAcqSelectedIndex_)
        .setChannelGroup((String) ChannelGroupCombo_.getSelectedItem());
    multiAcqManager_
        .getAcquisitionSettings(multiAcqSelectedIndex_)
        .channels_
        .updateChannelGroup((String) ChannelGroupCombo_.getSelectedItem());
    acquisitionSettingsChanged();
  } // GEN-LAST:event_ChannelGroupCombo_ActionPerformed

  private void acqOrderCombo_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_acqOrderCombo_ActionPerformed
    acquisitionSettingsChanged();
  } // GEN-LAST:event_acqOrderCombo_ActionPerformed

  private void zStepSpinner_StateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_zStepSpinner_StateChanged
    acquisitionSettingsChanged();
  } // GEN-LAST:event_zStepSpinner_StateChanged

  private void collectionPlaneCombo_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_collectionPlaneCombo_ActionPerformed
    acquisitionSettingsChanged();
  } // GEN-LAST:event_collectionPlaneCombo_ActionPerformed

  private void xyFootprintComboBox_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_xyFootprintComboBox_ActionPerformed
    acquisitionSettingsChanged();
  } // GEN-LAST:event_xyFootprintComboBox_ActionPerformed

  private void fixedDistanceSurfaceComboBox_ActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_fixedDistanceSurfaceComboBox_ActionPerformed
    acquisitionSettingsChanged();
  } // GEN-LAST:event_fixedDistanceSurfaceComboBox_ActionPerformed

  private void distanceAboveFixedSurfaceSpinner_StateChanged(
      javax.swing.event.ChangeEvent
          evt) { // GEN-FIRST:event_distanceAboveFixedSurfaceSpinner_StateChanged
    acquisitionSettingsChanged();
  } // GEN-LAST:event_distanceAboveFixedSurfaceSpinner_StateChanged

  private void distanceBelowFixedSurfaceSpinner_StateChanged(
      javax.swing.event.ChangeEvent
          evt) { // GEN-FIRST:event_distanceBelowFixedSurfaceSpinner_StateChanged
    acquisitionSettingsChanged();
  } // GEN-LAST:event_distanceBelowFixedSurfaceSpinner_StateChanged

  private void umBelowBottomSurfaceSpinner_StateChanged(
      javax.swing.event.ChangeEvent
          evt) { // GEN-FIRST:event_umBelowBottomSurfaceSpinner_StateChanged
    acquisitionSettingsChanged();
  } // GEN-LAST:event_umBelowBottomSurfaceSpinner_StateChanged

  private void umAboveTopSurfaceSpinner_StateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_umAboveTopSurfaceSpinner_StateChanged
    acquisitionSettingsChanged();
  } // GEN-LAST:event_umAboveTopSurfaceSpinner_StateChanged

  private void bottomSurfaceCombo_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_bottomSurfaceCombo_ActionPerformed
    acquisitionSettingsChanged();
  } // GEN-LAST:event_bottomSurfaceCombo_ActionPerformed

  private void topSurfaceCombo_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_topSurfaceCombo_ActionPerformed
    acquisitionSettingsChanged();
  } // GEN-LAST:event_topSurfaceCombo_ActionPerformed

  private void zEndSpinner_StateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_zEndSpinner_StateChanged
    acquisitionSettingsChanged();
  } // GEN-LAST:event_zEndSpinner_StateChanged

  private void zStartSpinner_StateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_zStartSpinner_StateChanged
    acquisitionSettingsChanged();
  } // GEN-LAST:event_zStartSpinner_StateChanged

  private void timePointsCheckBox_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_timePointsCheckBox_ActionPerformed
    for (Component c : timePointsPanel_.getComponents()) {
      c.setEnabled(timePointsCheckBox_.isSelected());
    }
    acquisitionSettingsChanged();
  ...
  private void timeIntervalSpinner_StateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_timeIntervalSpinner_StateChanged
    acquisitionSettingsChanged();
  } // GEN-LAST:event_timeIntervalSpinner_StateChanged

  private void numTimePointsSpinner_StateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_numTimePointsSpinner_StateChanged
    acquisitionSettingsChanged();
  } // GEN-LAST:event_numTimePointsSpinner_StateChanged

  private void timeIntevalUnitCombo_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_timeIntevalUnitCombo_ActionPerformed
    acquisitionSettingsChanged();
  } // GEN-LAST:event_timeIntevalUnitCombo_ActionPerformed

  private void deleteAllRegionsButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_deleteAllRegionsButton_ActionPerformed
    manager_.deleteAll();
  } // GEN-LAST:event_deleteAllRegionsButton_ActionPerformed

  private void deleteSelectedRegionButton_ActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_deleteSelectedRegionButton_ActionPerformed
  ...
  private void setCurrentZStartButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_setCurrentZStartButton_ActionPerformed
    MagellanGUIAcquisitionSettings settings =
        multiAcqManager_.getAcquisitionSettings(multiAcqSelectedIndex_);
    try {
  ...
  private void setCurrentZEndButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_setCurrentZEndButton_ActionPerformed
    MagellanGUIAcquisitionSettings settings =
        multiAcqManager_.getAcquisitionSettings(multiAcqSelectedIndex_);
    try {
  ...
  private void noCollectionPlaneButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_noCollectionPlaneButton_ActionPerformed
    acquisitionSettingsChanged();
  } // GEN-LAST:event_noCollectionPlaneButton_ActionPerformed

  private void useCollectionPlaneButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_useCollectionPlaneButton_ActionPerformed
    acquisitionSettingsChanged();
  } // GEN-LAST:event_useCollectionPlaneButton_ActionPerformed

  private void button3D_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_button3D_ActionPerformed
  ...
  private void button2D_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_button2D_ActionPerformed
    CardLayout card1 = (CardLayout) controls2DOr3D_.getLayout();
    card1.show(controls2DOr3D_, "2D");
    acquisitionSettingsChanged();
  } // GEN-LAST:event_button2D_ActionPerformed

  private void cuboidVolumeButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_cuboidVolumeButton_ActionPerformed
  ...
  private void volumeBetweenSurfacesButton_ActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_volumeBetweenSurfacesButton_ActionPerformed
    CardLayout card1 = (CardLayout) acq3DSubtypePanel_.getLayout();
    card1.show(acq3DSubtypePanel_, "volumeBetween");
    acquisitionSettingsChanged();
  } // GEN-LAST:event_volumeBetweenSurfacesButton_ActionPerformed

  private void withinDistanceFromSurfacesButton_ActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_withinDistanceFromSurfacesButton_ActionPerformed
    CardLayout card1 = (CardLayout) acq3DSubtypePanel_.getLayout();
    card1.show(acq3DSubtypePanel_, "fixedDistance");
    acquisitionSettingsChanged();
  } // GEN-LAST:event_withinDistanceFromSurfacesButton_ActionPerformed

  private void exploreAcqTabbedPane_StateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_exploreAcqTabbedPane_StateChanged
    refreshBoldedText();
    ...
    multiAcqManager_
        ...
        .setUseOnAll(
            !multiAcqManager_
                .getAcquisitionSettings(multiAcqSelectedIndex_)
                .channels_
                .getChannelListSetting(0)
                .use_);
    ((SimpleChannelTableModel) channelsTable_.getModel()).fireTableDataChanged();
  } // GEN-LAST:event_jButton1ActionPerformed

  private void syncExposuresButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_syncExposuresButton_ActionPerformed
    multiAcqManager_
        .getAcquisitionSettings(multiAcqSelectedIndex_)
        .channels_
  ...
  private void jButton3ActionPerformed(
    ...
    for (int index = 0;
        index
            < SurfaceGridManager.getInstance().getNumberOfSurfaces()
                + SurfaceGridManager.getInstance().getNumberOfGrids();
        index++) {
      SurfaceGridManager.getInstance().getSurfaceOrGrid(index).exportToMicroManager();
    }
  } // GEN-LAST:event_jButton3ActionPerformed

  private void addAcqButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_addAcqButton_ActionPerformed
    multiAcqManager_.addNew();
    acquisitionSettingsChanged();
  } // GEN-LAST:event_addAcqButton_ActionPerformed

  private void removeAcqButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_removeAcqButton_ActionPerformed
    ...
    if (multiAcqSelectedIndex_ == multiAcqManager_.getNumberOfAcquisitions()) {
      ...
      multipleAcqTable_
          .getSelectionModel()
          .setSelectionInterval(multiAcqSelectedIndex_, multiAcqSelectedIndex_);
    }
    acquisitionSettingsChanged();
  } // GEN-LAST:event_removeAcqButton_ActionPerformed

  private void tileOverlapSpinner_StateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_tileOverlapSpinner_StateChanged
