...
public class SurfaceGridTableModel extends AbstractTableModel implements SurfaceGridListener {
  ...
  public SurfaceGridTableModel() {
    ...
    // I suppose it never needs to be removed because this table is persisten as longa as magellan
    // is open
  }
  ...
  public Object getValueAt(int rowIndex, int columnIndex) {
    //         private final String[] COLUMNS = {"Type", "Name", "XY padding (um)", "Z Device", "#
    // Positions",
