...
/** @author henrypinkard */
public class SurfaceGridPanel extends javax.swing.JPanel
    implements SurfaceGridListener, ControlsPanelInterface {
  ...
  public SurfaceGridPanel(MagellanDataManager manager, MagellanViewer disp) {
    ...
    surfaceTableListSelectionListener_ =
  ...
  private void updateSurfaceGridSelection() {
    ...
    if (selectedSurfaceGridIndex_ == surfaceGridTable_.getModel().getRowCount()) {
      surfaceGridTable_
          .getSelectionModel()
          .setSelectionInterval(selectedSurfaceGridIndex_ - 1, selectedSurfaceGridIndex_ - 1);
    }
  ...
  public ArrayList<XYFootprint> getSurfacesAndGridsForDisplay() {
    ...
    for (int i = 0;
      ...
      try {
        ...
        // this comes up when making a bunch of surfaces then making a grid, unclear why vut it
        // seems to be debnign
      }
    }
    return list;
  ...
  private void initComponents() {
    ...
    newSurfaceButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    gridRowsSpinner_1.addChangeListener(
    ...
    gridColsSpinner_1.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    javax.swing.GroupLayout gridControlPanel_1Layout =
        new javax.swing.GroupLayout(gridControlPanel_1);
    gridControlPanel_1.setLayout(gridControlPanel_1Layout);
    gridControlPanel_1Layout.setHorizontalGroup(
        gridControlPanel_1Layout
    ...
    showStagePositionsCheckBox_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    showInterpCheckBox_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    javax.swing.GroupLayout surfaceControlPanel_Layout =
                ...
                layout
                    ...
                    .addGroup(
                        ...
                        layout
                            ...
                            .addComponent(
                                surfaceGridSpecificControlsPanel_1,
                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                397,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(19, 19, 19))));
        ...
        layout
            ...
            .addGroup(
                layout
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 256, Short.MAX_VALUE))
            .addGroup(
                layout
                    .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(
  ...
  private void newGridButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_newGridButton_ActionPerformed
    try {
      Point2D.Double coord = manager_.getStageCoordinateOfViewCenter();
      MultiPosGrid r =
          ((DisplayWindowSurfaceGridTableModel) surfaceGridTable_.getModel())
              .newGrid(
                  (Integer) gridRowsSpinner_1.getValue(),
                  (Integer) gridColsSpinner_1.getValue(),
                  coord);
      selectedSurfaceGridIndex_ = SurfaceGridManager.getInstance().getIndex(r);
      surfaceGridTable_
          .getSelectionModel()
          .setSelectionInterval(selectedSurfaceGridIndex_, selectedSurfaceGridIndex_);
  ...
  private void newSurfaceButton_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_newSurfaceButton_ActionPerformed
    SurfaceInterpolator s =
        ((DisplayWindowSurfaceGridTableModel) surfaceGridTable_.getModel()).addNewSurface();
  ...
  private void gridRowsSpinner_1StateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_gridRowsSpinner_1StateChanged
    if (getCurrentSurfaceOrGrid() != null && getCurrentSurfaceOrGrid() instanceof MultiPosGrid) {
      ((MultiPosGrid) getCurrentSurfaceOrGrid())
          .updateParams(
              (Integer) gridRowsSpinner_1.getValue(), (Integer) gridColsSpinner_1.getValue());
    }
    display_.redrawOverlay();
  } // GEN-LAST:event_gridRowsSpinner_1StateChanged

  private void gridColsSpinner_1StateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_gridColsSpinner_1StateChanged
    if (getCurrentSurfaceOrGrid() != null && getCurrentSurfaceOrGrid() instanceof MultiPosGrid) {
      ((MultiPosGrid) getCurrentSurfaceOrGrid())
          .updateParams(
              (Integer) gridRowsSpinner_1.getValue(), (Integer) gridColsSpinner_1.getValue());
  ...
  private void showStagePositionsCheckBox_ActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_showStagePositionsCheckBox_ActionPerformed
    manager_.setSurfaceDisplaySettings(
        showInterpCheckBox_.isSelected(), showStagePositionsCheckBox_.isSelected());
    display_.redrawOverlay();
  } // GEN-LAST:event_showStagePositionsCheckBox_ActionPerformed

  private void showInterpCheckBox_ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_showInterpCheckBox_ActionPerformed
    manager_.setSurfaceDisplaySettings(
        showInterpCheckBox_.isSelected(), showStagePositionsCheckBox_.isSelected());
    display_.redrawOverlay();
