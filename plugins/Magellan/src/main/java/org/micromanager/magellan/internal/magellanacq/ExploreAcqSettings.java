...
public class ExploreAcqSettings extends MagellanGenericAcquisitionSettings {
  ...
  public ExploreAcqSettings(
      String dir, String name, String cGroup, double zStep, double tileOverlap) {
    super(
        dir,
        name,
        cGroup,
        cGroup.equals("") ? null : new ChannelGroupSettings(cGroup),
        zStep,
        tileOverlap,
        false);
  ...
  public static String getNameFromPrefs() {
    return GlobalSettings.getInstance()
        .getStringInPrefs(EXPLORE_NAME_PREF, "Untitled Explore Acquisition");
  }
