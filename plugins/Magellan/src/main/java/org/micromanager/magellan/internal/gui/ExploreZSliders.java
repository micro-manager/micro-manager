...
class ExploreZSliders extends JPanel {
  ...
  public void updateExploreZControls(int currentZ) {
    ...
    ((ColorableScrollbarUI) zTopScrollbar_.getUI())
        .setHighlightedIndices(currentZ, minZExplored_, maxZExplored_);
    ((ColorableScrollbarUI) zBottomScrollbar_.getUI())
        .setHighlightedIndices(currentZ, minZExplored_, maxZExplored_);
  ...
  private void initComponents() {
    ...
    zTopTextField_.addActionListener(
        new ActionListener() {
          @Override
    ...
    zBottomTextField_.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent ae) {
    ...
    zTopScrollbar_.addAdjustmentListener(
    ...
    zBottomScrollbar_.addAdjustmentListener(
        new AdjustmentListener() {
          @Override
          public void adjustmentValueChanged(AdjustmentEvent ae) {
