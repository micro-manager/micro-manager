...
class DisplayWindow implements WindowListener {
   ...
   private void buildInitialUI() {
      ...
      subImageControls_ = new SubImageControls(display_, display_.getZStep(), display_.isActiveExploreAcquisiton());
      ...
      DisplayWindowControls sideControls = new DisplayWindowControls(display_,
