...
//
//   public SubImageControls(MagellanDisplayController disp, double zStep, boolean explore) {
...
//                  JFrame window = (JFrame) SwingUtilities.getWindowAncestor(SubImageControls.this);
