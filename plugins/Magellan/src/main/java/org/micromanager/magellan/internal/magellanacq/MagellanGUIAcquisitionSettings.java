...
public class MagellanGUIAcquisitionSettings extends MagellanGenericAcquisitionSettings
  ...
  public volatile double zStart_,
      zEnd_,
      distanceBelowFixedSurface_,
      distanceAboveFixedSurface_,
      distanceAboveTopSurface_,
      distanceBelowBottomSurface_;
  ...
  public MagellanGUIAcquisitionSettings() {
    ...
    MutablePropertyMapView prefs =
        Magellan.getStudio().profile().getSettings(MagellanGUIAcquisitionSettings.class);
    if (GUI.getInstance() != null
        && GUI.getInstance().getSavingDir() != null) { // To avoid error on init
  ...
  public void setSurface(String withinDistanceSurfaceName) {
    SurfaceInterpolator s =
        SurfaceGridManager.getInstance().getSurfaceNamed(withinDistanceSurfaceName);
    if (s == null) {
