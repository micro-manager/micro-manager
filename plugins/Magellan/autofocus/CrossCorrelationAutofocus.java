...
public class CrossCorrelationAutofocus {
   ...
   public static void main(String[] args) {
      ...
      String imgPath1  = "/Users/henrypinkard/Desktop/xCorrSample.tif";
      String imgPath2  = "/Users/henrypinkard/Desktop/xCorrSampleHigher.tif";
      
      ImagePlus ipLow = IJ.openImage(imgPath1);
      ImagePlus ipHigh = IJ.openImage(imgPath1);
      new ImageConverter(ipLow).convertToGray32();
      new ImageConverter(ipHigh).convertToGray32();
      ImageStack xCorrStack = FHTImage3D.crossCorrelation(ipLow.getStack(), ipHigh.getStack());
   
      ImagePlus ip = new ImagePlus("XCorr", xCorrStack);
      ip.show();
