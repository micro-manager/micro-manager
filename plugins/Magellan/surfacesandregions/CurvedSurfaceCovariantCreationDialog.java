...
public class CurvedSurfaceCovariantCreationDialog extends javax.swing.JFrame {
   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Base Power (0-1): ");
        ...
        powerSpinner_.setModel(new javax.swing.SpinnerNumberModel(0.05d, 1.0E-5d, 1.0d, 0.01d));
   ...
   public static void main(String args[]) {
      ...
      try {
         ...
         java.util.logging.Logger.getLogger(CurvedSurfaceCovariantCreationDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
      ...
      java.awt.EventQueue.invokeLater(new Runnable() {
         ...
         public void run() {
            new CurvedSurfaceCovariantCreationDialog().setVisible(true);
         }
      });
   }
