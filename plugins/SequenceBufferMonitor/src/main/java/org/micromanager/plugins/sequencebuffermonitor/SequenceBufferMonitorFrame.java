...
class SequenceBufferMonitorFrame extends JFrame {
  ...
  SequenceBufferMonitorFrame(org.micromanager.Studio app) {
    ...
    JTextField intervalField = new JTextField(Integer.toString(updateIntervalMs_), 4);
    ...
    setLayout(new net.miginfocom.swing.MigLayout("insets dialog", "[grow, fill]", "[]related[]"));
    add(usageBar_, "wrap");
