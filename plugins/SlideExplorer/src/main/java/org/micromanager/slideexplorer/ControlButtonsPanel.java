...
public class ControlButtonsPanel extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    navigatorButton.setToolTipText(
        "In Navigate mode, you can move the stage by double-clicking on the slide map.");
    ...
    navigatorButton.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    explorerButton.setToolTipText(
        "In Explore mode, the slide map will be acquired as you zoom and pan.");
    ...
    jComboBox1.setModel(
        new javax.swing.DefaultComboBoxModel(
            new String[] {"Hand", "Points", "Rectangle", "Polygon", "Freehand"}));
    jComboBox1.setToolTipText(
        "Choose the Hand tool for Panning and the other tools for drawing ROIs to create 5D Mosaics.");
    ...
    clearROIsButton.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void navigatorButtonActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_navigatorButtonActionPerformed
    if (!navigatorButton.isSelected()) {
      display_.pauseSlideExplorer();
    }
  } // GEN-LAST:event_navigatorButtonActionPerformed

  private void explorerButtonActionPerformed(
  ...
  private void fullScreenButtonActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_fullScreenButtonActionPerformed
  ...
  private void mosaicButtonActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_mosaicButtonActionPerformed
  ...
  private void snapButtonActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_snapButtonActionPerformed
    display_.snap();
  ...
  private void jComboBox1ActionPerformed(
    ...
    if (cmd.equals("Hand")) IJ.setTool(Toolbar.HAND);
    if (cmd.equals("Rectangle")) IJ.setTool(Toolbar.RECTANGLE);
    if (cmd.equals("Points")) IJ.setTool(Toolbar.POINT);
    if (cmd.equals("Polygon")) IJ.setTool(Toolbar.POLYGON);
    if (cmd.equals("Freehand")) IJ.setTool(Toolbar.FREEROI);
  } // GEN-LAST:event_jComboBox1ActionPerformed

  private void clearROIsButtonActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_clearROIsButtonActionPerformed
    display_.clearRois();
