...
public class Controller {
   ...
   private ImageProcessor trimImage(ImageProcessor img, Point mapPosition,
      ...
      Rectangle croppingRoi = new Rectangle(trimx / 2 + dx, trimy / 2 + dy, tileDimensions.width,
   ...
   public synchronized void specifyMapRelativeToStage(Point2D.Double mapOriginOnStage, double angle,
                                                      double pixelSize) {
   ...
   /**
    * @param pixelSize the pixelSize_ to set
    */
