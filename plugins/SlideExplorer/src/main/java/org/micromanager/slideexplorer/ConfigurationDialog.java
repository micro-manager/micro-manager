...
public class ConfigurationDialog extends javax.swing.JFrame {
        ...
        layout
            ...
            .addGroup(
                layout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 14, Short.MAX_VALUE)
  ...
  private void closeButtonActionPerformed1(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_closeButtonActionPerformed1
    dispose();
  ...
  private void formWindowGainedFocus(
      java.awt.event.WindowEvent evt) { // GEN-FIRST:event_formWindowGainedFocus
    loadValues();
  ...
  private class OffsetTableModel extends AbstractTableModel {
    ...
    String columnNames_[] = {
      "Resolution setting", "x-offset, \u03BCm", "y-offset, \u03BCm", "z-offset, \u03BCm"
    };
