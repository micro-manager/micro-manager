...
public class StageControlFrame extends javax.swing.JFrame {
   ...
   private void initComponents() {
      ...
      jButton20.setFont(new java.awt.Font("Arial", 0, 10)); // NOI18N
      jButton20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/micromanager/stagecontrol/icons/camera.png"))); // NOI18N
      jButton20.setText("Snap");
      jButton20.setIconTextGap(6);
      jButton20.setMaximumSize(new java.awt.Dimension(40, 20));
      jButton20.setMinimumSize(new java.awt.Dimension(0, 0));
      jButton20.setPreferredSize(new java.awt.Dimension(40, 20));
      ...
      layout.setHorizontalGroup(
         ...
         .add(layout.createSequentialGroup()
            .addContainerGap()
            .add(jButton20, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 71, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
            .add(2, 2, 2)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try {
          gui_.setRelativeXYStagePosition(-smallMovement_, 0.0);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       try {
          gui_.setRelativeXYStagePosition(-largeMovement_, 0.0);
       } catch(MMScriptException e) {
          gui_.logError(e);
       }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       try {
          gui_.setRelativeXYStagePosition(-mediumMovement_, 0.0);
       } catch(MMScriptException e) {
          gui_.logError(e);
       }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
       try {
          gui_.setRelativeXYStagePosition(0.0, -smallMovement_);
       } catch(MMScriptException e) {
          gui_.logError(e);
       }
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
       try {
          gui_.setRelativeXYStagePosition(0.0, -largeMovement_);
       } catch(MMScriptException e) {
          gui_.logError(e);
       }
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
       try {
          gui_.setRelativeXYStagePosition(0.0, -mediumMovement_);
       } catch(MMScriptException e) {
          gui_.logError(e);
       }
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
       try {
          gui_.setRelativeStagePosition(mediumMovementZ_);
       } catch(MMScriptException e) {
          gui_.logError(e);
       }
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
       try {
          gui_.setRelativeStagePosition(smallMovementZ_);
       } catch(MMScriptException e) {
          gui_.logError(e);
       }
