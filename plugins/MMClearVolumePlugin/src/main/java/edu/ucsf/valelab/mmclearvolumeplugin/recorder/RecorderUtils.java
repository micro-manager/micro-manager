...
public class RecorderUtils {
  public static BufferedImage makeBufferedImage(
      final int pWidth, final int pHeight, final ByteBuffer pByteBuffer) {
    try {
      ...
      BufferedImage lBufferedImage =
          new BufferedImage(pWidth, pHeight, BufferedImage.TYPE_INT_ARGB);

      lBufferedImage.setRGB(0, 0, pWidth, pHeight, lPixelInts, 0, pWidth);
