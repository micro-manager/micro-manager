...
int main(int /* argc */, char** /*argv[]*/)
{
   try {
     ...
     //LoadDemoDevices(core);
	  //core.loadSystemConfiguration("/projects/MicroManage/bin/MMConfig_uberzeiss.cfg");
	  //core.loadSystemConfiguration("/projects/MicroManage/bin/MMConfig_PVCAM.cfg");
	  core.loadSystemConfiguration("MMConfig_demo.cfg");  
	  //core.loadSystemConfiguration("/projects/MicroManage/bin/MMConfig_uberzeiss.cfg");
	  //core.loadSystemConfiguration("/projects/MicroManage/bin/MMConfig_PCO.cfg");
