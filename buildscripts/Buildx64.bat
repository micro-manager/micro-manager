...
echo trying to delete \Projects\micromanager\Install_x64\Output\MMSetupx64_%mmversion%_%YYYYMMDD%.exe
...
rem\Projects\micromanager\Install_x64\Output\MMSetupx64_%mmversion%_%YYYYMMDD%.exe  /silent
