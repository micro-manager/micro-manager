...
// CVS:           $Id: PIZStage_DLL.h,v 1.14, 2018-09-26 11:11:16Z, Steffen Rau$
//
...
public:
  ...
  int GetLimits(double& min, double& max);
   ...
   int OnAxisServoControl(MM::PropertyBase* pProp, MM::ActionType eAct);
   int OnEnableAxis(MM::PropertyBase* pProp, MM::ActionType eAct);
   int OnAlternativeHomingCommand(MM::PropertyBase* pProp, MM::ActionType eAct);
...
private:
   ...
   bool servoControl_;
   bool axisEnabled_;
   std::string alternativeHomingCommand_;
