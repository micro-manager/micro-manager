...
freeimage:
Patch FreeImage 3.15.0 lower with libfreeimage_raw_halfsize.patch to add support for raw images without color interpolation. Later versions of FreeImage already have the patch applied.
