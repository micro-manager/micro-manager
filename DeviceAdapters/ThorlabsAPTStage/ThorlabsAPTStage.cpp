...
MODULE_API void InitializeModuleData()
{
	...
	// Have to set aptInitialized back to false to force reinitialization in Initialize()
	// method or MM2.0 will seg fault as soon as we try to access the device. Why??
