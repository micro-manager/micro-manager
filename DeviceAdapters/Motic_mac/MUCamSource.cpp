...
//int MUCamSource::PrepareSequenceAcqusition()
//{
//    if (IsCapturing())
...
// */
//int MUCamSource::StartSequenceAcquisition(double interval) {
//    
 ...
 */
int MUCamSource::ThreadRun (void)
{
    SnapImage();
...
//MSequenceThread::MSequenceThread(MUCamSource* pCam)
//:intervalMs_(100.0),
//numImages_(0),
//imageCounter_(0),
//stop_(true),
...
//{};
//
//MSequenceThread::~MSequenceThread() {};
//
//void MSequenceThread::Stop() {
//    stop_=true;
//}
//
//void MSequenceThread::Start(long numImages, double intervalMs)
//{
...
//}
//
//bool MSequenceThread::IsStopped(){
//    return stop_;
//}
//
//int MSequenceThread::svc(void) throw()
//{
//    int ret=DEVICE_ERR;
//    return ret;
//}
