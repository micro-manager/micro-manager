...
#ifndef _COHERENTCUBE_H_
#define _COHERENTCUBE_H_
...
//	double powerReadback_;
   ...
   CoherentCube& operator=(CoherentCube& /*rhs*/) {assert(false); return *this;}
};


#endif // _COHERENTCUBE_H_