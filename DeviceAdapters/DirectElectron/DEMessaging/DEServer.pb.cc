...
#endif  // _MSC_VER
const ::std::string DEPacket::_default_camera_name_;
#ifndef _MSC_VER
...
void DEPacket::SharedCtor() {
  ...
  data_header_ = NULL;
  camera_name_ = const_cast< ::std::string*>(&_default_camera_name_);
...
const ::std::string SingleCommand::_default_command_name_;
#ifndef _MSC_VER
...
void SingleCommand::SharedCtor() {
  _cached_size_ = 0;
  command_id_ = 0u;
  command_name_ = const_cast< ::std::string*>(&_default_command_name_);
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
#endif  // _MSC_VER
const ::std::string AnyParameter::_default_name_;
const ::std::string AnyParameter::_default_p_string_;
const ::std::string AnyParameter::_default_p_bytes_;
#ifndef _MSC_VER
...
void AnyParameter::SharedCtor() {
  ...
  p_int_ = 0;
  p_bool_ = false;
  p_string_ = const_cast< ::std::string*>(&_default_p_string_);
  p_float_ = 0;
  p_bytes_ = const_cast< ::std::string*>(&_default_p_bytes_);
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
const ::std::string SingleAcknowledge::_default_command_name_;
const ::std::string SingleAcknowledge::_default_error_message_;
#ifndef _MSC_VER
...
const ::std::string DataHeader::_default_identifier_;
#ifndef _MSC_VER
