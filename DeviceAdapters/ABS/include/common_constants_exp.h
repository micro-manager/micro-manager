...
#define FUNC_RESOLUTION             0x0000000000000000ULL  //!< resolution caps (#S_RESOLUTION_CAPS, #S_RESOLUTION_PARAMS)

#define FUNC_PIXELTYPE              0x0000000000000001ULL  //!< pixel type caps (#S_PIXELTYPE_CAPS, #S_PIXELTYPE_PARAMS)
#define FUNC_PREGAIN                0x0000000000000002ULL  //!< pre gain #S_GAIN_CAPS
#define FUNC_GAIN                   0x0000000000000004ULL  //!< gain, brightness #S_GAIN_CAPS
#define FUNC_EXPOSURE               0x0000000000000008ULL  //!< exposure #S_EXPOSURE_CAPS

#define FUNC_AUTOEXPOSURE           0x0000000000000010ULL  //!< auto exposure #S_AUTOEXPOSURE_CAPS
#define FUNC_WHITE_BALANCE          0x0000000000000020ULL  //!< manual white balance #S_WHITE_BALANCE_PARAMS
#define FUNC_SHADING_CORRECTION     0x0000000000000040ULL  //!< shading correction
#define FUNC_BITSHIFT               0x0000000000000080ULL  //!< bit shift mode for bpp modes greater 8bpp S_BITSHIFT_PARAMS

#define FUNC_GAMMA                  0x0000000000000100ULL  //!< gamma / value for pixel interpration #S_GAMMA_PARAMS
#define FUNC_LUT                    0x0000000000000200ULL  //!< look up table (LUT)
#define FUNC_BLACKLEVEL             0x0000000000000400ULL  //!< black level compensation
#define FUNC_TIMESYNC               0x0000000000000800ULL  //!< time synchronization (#S_TIMESYNC_CAPS, #S_TIMESYNC_PARAMS)

#define FUNC_BADPIXEL_CORRECTION    0x0000000000002000ULL  //!< bad pixel correction
#define FUNC_FLIP                   0x0000000000004000ULL  //!< image flip (#S_FLIP_CAPS, #S_FLIP_PARAMS)
#define FUNC_CLOCK                  0x0000000000008000ULL  //!< sensor pixel clock

#define FUNC_TEMPERATURE            0x0000000000010000ULL  //!< sensor temperature
#define FUNC_IO_PORTS               0x0000000000020000ULL  //!< digital I/O ports (#S_IO_PORT_CAPS, #S_IO_PORT_PARAMS)

#define FUNC_MEMORY                 0x0000000000080000ULL  //!< camera memory (eeprom/flash) access

#define FUNC_RESERVED               0x0001200020141000ULL  //!< reserved for further use 

#define FUNC_LOCK_UPDATE            0x0000000000200000ULL  //!< lock sensor settings update
#define FUNC_COLOR_CORRECTION       0x0000000000400000ULL  //!< color correction S_COLOR_CORRECTION_PARAMS
#define FUNC_TIMESTAMP_OVERLAY      0x0000000000800000ULL  //!< time stamp overlay  (#S_TIMESTAMP_OVERLAY_CAPS, S_TIMESTAMP_OVERLAY_PARAMS)

#define FUNC_HUE_SATURATION         0x0000000001000000ULL  //!< hue / saturation S_HUE_SATURATION_PARAMS
#define FUNC_BRIGHTNESS_CONTRAST    0x0000000002000000ULL  //!< brightness / contrast S_BRIGHTNESS_CONTRAST_PARAMS
#define FUNC_FRAMERATE              0x0000000004000000ULL  //!< framerate control see #S_FRAMERATE_PARAMS

#define FUNC_JPEG                   0x0000000010000000ULL  //!< jpeg quqlity control S_JPEG_CAPS
#define FUNC_TRIGGER_OPTIONS        0x0000000040000000ULL  //!< trigger options control see #S_TRIGGER_OPTION_PARAMS
#define FUNC_64BIT_FUNCID           0x0000000080000000ULL  //!< set if 64bit FunctionID's are supported

#define FUNC_RTC                    0x0000000100000000ULL  //!< to get / set the RTC - values

//! \cond DOXYGEN_INCLUDE_VDL
// VDL => "Video Data Logger"
#define FUNC_VDL_STATUS             0x0000000200000000ULL  //!< to get the current VDL status
#define FUNC_VDL_SETTINGS           0x0000000400000000ULL  //!< to get/set the VDL settings
#define FUNC_VDL_TRIGGER            0x0000000800000000ULL  //!< to trigger the VDL by software
#define FUNC_VDL_DIR                0x0000001000000000ULL  //!< to read directory informations
#define FUNC_VDL_FILE               0x0000002000000000ULL  //!< to read image files
//! \endcond DOXYGEN_INCLUDE_VDL

#define FUNC_EDGE_ENHANCE           0x0000004000000000ULL  //!< egde enhancement
#define FUNC_MULTISHOT_CFG          0x0000008000000000ULL  //!< multishot configuration

#define FUNC_MULTI_ROI              0x0000010000000000ULL  //!< multi roi configuration

#define FUNC_MODE_EVENT_CFG         0x0000020000000000ULL  //!< configuration for capture mode #MODE_EVENT and MODE_EVENT_SYNC
#define FUNC_MODE_TIME_CFG          0x0000040000000000ULL  //!< configuration for capture mode #MODE_TIME

#define FUNC_LUT_POST               0x0000080000000000ULL  //!< post LUT processing
#define FUNC_COOLING                0x0000100000000000ULL  //!< image sensor cooling
#define FUNC_COLOR_MAPPING          0x0000400000000000ULL  //!< image color mapping
#define FUNC_BACKLIGHT_COMPENSATION 0x0000800000000000ULL  //!< back light compensation

#define FUNC_ROTATE_REMAP           0x0002000000000000ULL  //!< rotate remap
#define FUNC_SEAMS_CORRECTION       0x0004000000000000ULL  //!< scenes corrections, compansate differences between images sensor quadrants
//!@}
...
#define DSP_CYPRESS_FX3  0x07      //!< Cypress FX3
...
#define CPLD_LCXO2_1200HC   0x04      //!< Lattice MachXO2 1200HC
...
#define TARGET_TYPE_TEMPSENSOR  0x0A000000      //!< target is a temperature sensor
...
#define TARGET_AD7415     (TARGET_TYPE_TEMPSENSOR | TARGET_ID_0 | TEMP_SENS_TYPE_AD7415)  //!< temperature sensor AD7415 as target
...
#define USB_CYPRESS_FX3    0x05       //!< Cypress FX3
...
#define CPID_UK31XXX       0x09       //!< platform UK31xxx
...
//! \brief software asynchrony triggered mode \n
...
#define  TRANSFER_OPTION_STATIC_IMAGE_DETECTION   0x2000  //!< use static image detection at continuous mode
...
#define STDRES_HDTV_720_SBS   0x2000  //!< HDTV  720  640 x 720 for stereo camera 3D side by side format
#define STDRES_HDTV_720_SBSFV 0x4000  //!< HDTV  720 1280 x 1440 for stereo camera 3D side by side format 
...
#define TEMP_SENS_TYPE_UNKNOWN    0x0000    //!< unknown
...
#define EVENTID_IMAGE_AVAILABLE     0x07    //!< Image Ready to get via CamUSB_GetImage (not supported)
...
////////////////////////////////////////////////////////////////////////////
//! \name Constants: Cooling and Fan modes
//!  used by #FUNC_COOLING see #S_COOLING_PARAMS::bCoolingMode and
//!  #S_COOLING_PARAMS::bFanMode
//!  TEC -> thermoelectric cooler
//!@{

#define CM_TEC_OFF        0x00      //!< TEC: off
#define CM_TEC_AUTOMATIC  0x01      //!< TEC: automatic mode on
#define CM_TEC_MANUAL     0x02      //!< TEC: manual mode on

#define CM_FAN_OFF        0x00      //!<Fan: off
#define CM_FAN_AUTOMATIC  0x01      //!<Fan: automatic
#define CM_FAN_MANUAL     0x02      //!<Fan: manual
...
//! normal trigger, no special options
#define  TRIG_OPTION_NONE             0x00000000
...
#define STR_TransferOption              "TransferOption"
// resolution
...
#define STR_COOLING_FAN_MODE            "COOLING_FAN_MODE"
#define STR_COOLING_FAN_THRESH_TEMP     "COOLING_FAN_THRESH_TEMP"
#define STR_COOLING_FAN_LEVEL           "COOLING_FAN_LEVEL"
...
#define STR_ROTREM_Mode                 "ROTREM_Mode"
#define STR_ROTREM_Flag                 "ROTREM_Flag"
#define STR_ROTREM_Interpolation        "ROTREM_Interpolation"
#define STR_ROTREM_DataSize             "ROTREM_DataSize"
#define STR_ROTREM_Angle                "ROTREM_Angle"
#define STR_ROTREM_OriginX              "ROTREM_OriginX"
#define STR_ROTREM_OriginY              "ROTREM_OriginY"
#define STR_ROTREM_OffsetX              "ROTREM_OffsetX"
#define STR_ROTREM_OffsetY              "ROTREM_OffsetY"
#define STR_ROTREM_SizeX                "ROTREM_SizeX"
#define STR_ROTREM_SizeY                "ROTREM_SizeY"

// color mapping configuration
#define STR_COMA_FileName               "COMA_FileName"

// centroid
#define STR_CENTROID_SpotSizeX          "CENTROID_SpotSizeX"
#define STR_CENTROID_SpotSizeY          "CENTROID_SpotSizeY"
#define STR_CENTROID_SpotOffsetX        "CENTROID_SpotOffsetX"
#define STR_CENTROID_SpotOffsetY        "CENTROID_SpotOffsetY"
#define STR_CENTROID_SpotGapX           "CENTROID_SpotGapX"
#define STR_CENTROID_SpotGapY           "CENTROID_SpotGapY"
#define STR_CENTROID_SpotCountX         "CENTROID_SpotCountX"
#define STR_CENTROID_SpotCountY         "CENTROID_SpotCountY"
#define STR_CENTROID_PixelOffset        "CENTROID_PixelOffset"
#define STR_CENTROID_HistMode           "CENTROID_HistMode"
#define STR_CENTROID_HistState          "CENTROID_HistState"
#define STR_CENTROID_HistUnderflowLevel "CENTROID_HistUnderflowLevel"
#define STR_CENTROID_HistOverflowLevel  "CENTROID_HistOverflowLevel"
#define STR_CENTROID_HistXYPercent      "CENTROID_HistXYPercent"

#define STR_ENTZERRUNGS_MTX_Enabled  "CorrectionMtxEnabled"
#define STR_ENTZERRUNGS_MTX_FileName "CorrectionMtxPath"
...
#define STATUS_ERROR_REF_CLOCK      0x00000400  //!< error setting reference clock
#define STATUS_ERROR_I2C            0x00000800  //!< I2C init error 
#define STATUS_ERROR_IO_EXPANDER    0x00001000  //!< IO expander error
#define STATUS_ERROR_POWER_ADC      0x00002000  //!< power ADC error
#define STATUS_ERROR_EEPROM         0x00004000  //!< EEPROM error

#define STATUS_MASK_ALL_ERROR       0x00007FFF  //!< mask for all errors
...
#define STATIC_IMAGE_DETECTION_TIMEOUT      750
...
#define retVERSIONINVALID           0x00000004    //!< Version not supported
...
#define retTEMPSENSOR               0x0000000F    //!< temperature sensor error
...
#define retSPI                      0x00000017    //!< SPI error
#define retUART                     0x00000018    //!< UART error
#define retCLOCKGEN                 0x00000018    //!< clock gen error
#define retREFCLOCK                 0x00000019    //!< reference clock error
#define retI2C                      0x0000001A    //!< I2C init error
#define retIOEXT                    0x0000001B    //!< IO extender init error
...
#define retPCIe                     0x00000024    //!< PCIe interface error
...
#define retFLASH_ERASE              0x00000064    //!< flash erase verify error
#define retFLASH_PROGRAM            0x00000065    //!< flash program verify error
...
#define retFANMODE_CHANGED          0x000000EB    //!< warning: Fan mode was changed
...
#define retSerialID                 0x000003FC    //!<  serial id error
#define retTemperature              0x000003FD    //!< temperature error
#define retHardwareRevision         0x000003FE    //!< hardware revision not supported
#define retAssemblyVariant          0x000003FF    //!< assembly variant not supported

#define retDEVNOPEN                 0x00000400    //!< device not open
...
#define retDEVOPEN                  0x00000407    //!< device still open
#define retACCESS                   0x00000408    //!< insufficient permissions
...
#define retDEVNOTINIT               0x0000040E    //!< device is not yet initialized
#define retDEVNS                    0x0000040F    //!< device is not supported

#define retBUSY                     0x00000412    //!< peripheral device already running
...
#define retFORMAT_OPC               0x00000425    //!< Error in Host-Protocol (wrong opc response)
#define retFORMAT_CHK               0x00000426    //!< Error in Host-Protocol (invalid checksum)
#define retFORMAT_SIZE              0x00000427    //!< Error in Host-Protocol (size)
#define retFORMAT_ID                0x00000428    //!< Error in Host-Protocol (invalid ID)
#define retFORMAT_CMD_TIMEOUT       0x00000429    //!< Error in Host-Protocol (command receive timeout by device)
