...
typedef struct
{
  ...
  u16   wTargetTempStep;      //!< possible temperature step size (e.g. 10 corresponds 1.0캜 and 5 => 0.5캜 and -124 = -12.4캜)
  ...
  i16   wFanThreshTempMin;    //!< minimum supported threshold temperature in 0.1캜, e.g. 10 => 1.0캜 (only for #CM_FAN_AUTOMATIC)
  i16   wFanThreshTempMax;    //!< maximum supported threshold temperature in 0.1캜 (only for #CM_FAN_AUTOMATIC)
  i16   wFanThreshTempStep;   //!< minimum supported threshold temperature in 0.1캜(only for #CM_FAN_AUTOMATIC)
...
typedef struct
{
  ...
  u08   bReserved1[3];        //!< reserved
  i16   wTargetTemp;          //!< in 1/10 캜 (10 => 1.0캜) only used with cooling mode #CM_TEC_AUTOMATIC
  ...
  i16   wFanThreshTemp;       //!< current threshold temperature in 0.1캜 (only used with fan mode #CM_FAN_AUTOMATIC)
