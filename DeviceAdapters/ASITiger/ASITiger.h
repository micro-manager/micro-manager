...
const char* const g_PresetCode5 = "5 - BNC5 selected by cell 10";
const char* const g_PresetCode6 = "6 - BNC6 selected by cell 10";
const char* const g_PresetCode7 = "7 - BNC7 selected by cell 10";
const char* const g_PresetCode8 = "8 - BNC8 selected by cell 10";
const char* const g_PresetCode9 = "9 - BNC5-8 all off";
const char* const g_PresetCode10 = "10 - cell 8 low";
const char* const g_PresetCode11 = "11 - cell 8 high";
const char* const g_PresetCode12 = "12 - cell 10 = (TTL1 OR cell 1 OR cell 8)";
const char* const g_PresetCode13 = "13 - BNC4 source = (TTL3 AND cell 10)";
