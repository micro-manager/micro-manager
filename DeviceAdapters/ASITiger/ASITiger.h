...
const char* const g_MinMotorSpeedPropertyName = "MotorSpeedMinimum(mm/s)";
...
const char* const g_MinMotorSpeedXPropertyName = "MotorSpeedMinimumX(mm/s)";
const char* const g_MinMotorSpeedYPropertyName = "MotorSpeedMinimumY(mm/s)";
