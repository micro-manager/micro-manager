 ...
 */
class ExportMouseListener implements TiledDataViewerCanvasMouseListenerInterface {

   private static final int MIN_DRAG_PIXELS = 5;

   volatile Point mouseDragStartPoint_;
   volatile Point currentMouseLocation_;
   private final TiledDataViewerAPI viewer_;
   ...
   ExportMouseListener(TiledDataViewerAPI viewer,
                       Runnable onRelease,
