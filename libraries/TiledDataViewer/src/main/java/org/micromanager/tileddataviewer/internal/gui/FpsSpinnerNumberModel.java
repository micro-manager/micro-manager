...
/**
 * Spinner model for playback rates, stepping by 1 below 10 fps and by 5 above.
 *
 * <p>This mirrors the model used by the main Micro-Manager viewer so the
 * playback control behaves identically.  It is duplicated here rather than
 * imported so that this library does not reference mmstudio display internals.
 */
