...
public class DataViewCoords {
   ...
   DataViewCoords(DataSource cache, double xView, double yView, int channel,
...
//      sourceDataFullResHeight_ / (double) displayImageHeight_
   ...
   public DataViewCoords copy() {
      DataViewCoords view = new DataViewCoords(cache_, xView_, yView_, cIndex_, zIndex_, tIndex_,
