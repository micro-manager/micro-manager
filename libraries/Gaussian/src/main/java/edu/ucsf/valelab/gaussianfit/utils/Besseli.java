 ...
 * http://stackoverflow.com/questions/8797722/modified-bessel-functions-of-order-n License unclear.
 * Remove when an alternative is available
 *
 * @author Michael
 */
    ...
    if (ax < 3.75) { // polynomial fit
      ...
      answer =
          0.39894228
              + y
                  * (-0.3988024e-1
                      + y * (-0.362018e-2 + y * (0.163801e-2 + y * (-0.1031555e-1 + y * answer))));
      answer *= (EXP.value(ax) / Math.sqrt(ax));
    }
    return answer;
  }
