...
public class CoordinateMapper {
   ...
   public static class ControlPoint {
       ...
       * around scrPoint Then fits a polynomial to minimize the error between points in the two
       * channels
       *
    ...
    *
    * @param pointPairs - a Map of points measured in the two coordinates systems
    *                   (srcPt-&gt;destPt)
    * @return
    */
    ...
    * from the testPoint It uses the resulting set of control points to generate an affine
    * transform
    *
