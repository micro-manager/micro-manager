...
public class MosaicSequencingFrame extends JFrame {
  ...
  private final Vector<String> headerNames =
      new Vector<String>(
          Arrays.asList(
              new String[] {
                "Time Slot", "Roi Indices", "On Duration (ms)", "Off Duration (ms)", "Loop count"
              }));
  ...
  final Map<String, String> triggerProperties_ =
  ...
  public static ArrayList<String> getMosaicDevices(CMMCore core) {
    ...
    for (final String slmDevice : slmDevices) {
      try {
        if (core.getDeviceLibrary(slmDevice).contentEquals("Mosaic3")) mosaicDevices.add(slmDevice);
      } catch (Exception ex) {
  ...
  private void mirrorRoiManager() {
    final ListModel roiListModel =
        ((JList)
                ((JScrollPane) RoiManager.getInstance().getComponent(0))
                    .getViewport()
                    .getComponent(0))
            .getModel();
    updateRoiTable(roiListModel);
    roiListModel.addListDataListener(
  ...
  private void keepTimeSlotIndicesUpToDate(final DefaultTableModel sequenceTableModel) {
    sequenceTableModel.addTableModelListener(
  ...
  private int addRow(
      DefaultTableModel sequenceTableModel,
      String roiIndicesString,
      int onDurationMs,
      int offDurationMs,
      int loopCount) {
  ...
  private void generateNewSequence() {
    ...
    if (sequenceType.contentEquals("Simultaneous")) {
      addRow(
          sequenceTableModel_,
          "1-" + String.valueOf(roiCount).trim(),
          onDurationMs,
          offDurationMs,
          loopCount);
    }
    if (sequenceType.contentEquals("Sequential")) {
      for (int i = 0; i < frapROIs.size(); ++i) {
        ...
        addRow(sequenceTableModel_, integerList(rois), onDurationMs, offDurationMs, loopCount);
      }
    }
  ...
  private SequenceEvent sequenceRowToSequenceEvent(
      int rowIndex, List<Polygon> availableRoiPolygons) {
    final ArrayList<Integer> roiIndexList =
        frameStringToRoiIndexList(sequenceTableModel_.getValueAt(rowIndex, 1).toString());
    ...
    sequenceEvent.framePixels =
        mosaicDevice_.roisToPixels(
            mosaicWidth_, mosaicHeight_, selectedRoiPolygons, selectedRoiIntensities);
  ...
  private ArrayList<SequenceEvent> getSequenceEvents() {
    ...
    List<Polygon> availableRoiPolygons = Utils.FloatToNormalPolygon(availableFloatRoiPolygons);
  ...
  private String sequenceEventsToString(final ArrayList<SequenceEvent> events) {
    ...
    for (SequenceEvent event : events) {
      eventString +=
          i + " " + event.onDurationMs + " " + event.offDurationMs + " " + event.loopCount + ";";
      ++i;
    }
    return eventString;
  }
  ...
  // or saved.
  private final FileDialogs.FileType fileType =
      new FileDialogs.FileType(
          "Mosaic", "Mosaic Sequence Description", "MosaicSequence.txt", true, "txt");
  ...
  private void load() {
    File theFile =
        FileDialogs.openFile(null, "Please choose a Mosaic sequence file to load.", fileType);
    try {
  ...
  public MosaicSequencingFrame(
      Studio gui, CMMCore core, ProjectorControlForm projectorControlForm, SLM mosaicDevice) {
    initComponents();
    gui_ = gui;
    core_ = core;
  ...
  private void initComponents() {
                                ...
                                jPanel1Layout
                                    ...
                                    .addGroup(
                                        jPanel1Layout
                                            ...
                                            .addComponent(
                                                offDurationTextField_,
                                                javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(
                                                onDurationTextField_,
                                                javax.swing.GroupLayout.Alignment.LEADING,
                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                57,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    sequenceTable_.setModel(
        new javax.swing.table.DefaultTableModel(
            new Object[][] {},
            new String[] {"Time Slot", "ROIs", "On Duration (ms)", "Off Duration (ms)", "Loops"}) {
          Class[] types =
              new Class[] {
    ...
    addTimeSlotButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    detachFromAcquisitionButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    uploadButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    sequenceTriggerComboBox.setModel(
        new javax.swing.DefaultComboBoxModel(
            new String[] {
              "Sequence Start", "External Start", "External Advance", "External Frame Bulb"
            }));
    sequenceTriggerComboBox.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    attachToAcquisitionButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    generateROIGridButton_.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    roiListTable_.setModel(
        new javax.swing.table.DefaultTableModel(
            ...
            new String[] {"Roi #", "Name", "Mode", "Intensity"}) {
  ...
  private void detachFromAcquisitionButton_ActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_detachFromAcquisitionButton_ActionPerformed
