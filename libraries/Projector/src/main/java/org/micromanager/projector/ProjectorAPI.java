...
public class ProjectorAPI {
  ...
  public void transformAndSetMask(
      Mapping mapping,
    ...
    ProjectorActions.transformAndSetMask(
        mapping, dev, inputImage, width, height, cameraROI, cameraBinning);
  }
  ...
  public List<FloatPolygon> transformROIs(
